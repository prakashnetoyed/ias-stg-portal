...
function UserMembershipComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "div", 8)(2, "h5");
    \u0275\u0275text(3, "Membership");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 9)(5, "button", 10);
    \u0275\u0275text(6, "Download Receipt");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(7, "div", 11)(8, "div", 12)(9, "h4");
    \u0275\u0275text(10, "Annual Membership");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "span", 13);
    \u0275\u0275text(12, "Active");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(13, "hr");
    \u0275\u0275elementStart(14, "div", 14)(15, "div", 15)(16, "div", 16)(17, "p");
    \u0275\u0275text(18, " Member Since: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "span", 17);
    \u0275\u0275text(20, "10 July 2025");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 16)(22, "p");
    \u0275\u0275text(23, " Valid Till: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "span", 17);
    \u0275\u0275text(25, "9 July 2026");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(26, "div", 18)(27, "div", 16)(28, "p");
    \u0275\u0275text(29, " Fee Paid : ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "span", 17);
    \u0275\u0275text(31, "Rs.1000");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(32, "div", 16)(33, "p");
    \u0275\u0275text(34, " Membership ID: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "span", 17);
    \u0275\u0275text(36, "1IAS-ANL-2024-1234000");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementContainerEnd();
  }
}
function UserMembershipComponent_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementContainerStart(0, 7);
    \u0275\u0275elementStart(1, "div", 19)(2, "h5");
    \u0275\u0275text(3, "Choose Membership");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 20)(5, "div", 21)(6, "div", 22)(7, "div", 23)(8, "h5", 24);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(9, "svg", 25)(10, "mask", 26);
    \u0275\u0275element(11, "rect", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "g", 28);
    \u0275\u0275element(13, "path", 29);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("click", function UserMembershipComponent_ng_container_1_Template_button_click_26_listener() {
      ...
      return \u0275\u0275resetView(ctx_r1.paymentbtn("lifetime"));
    });
    \u0275\u0275text(27, "Pay Now");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(28, "div", 21)(29, "div", 22)(30, "div", 23)(31, "h5", 24);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(32, "svg", 33)(33, "mask", 34);
    \u0275\u0275element(34, "rect", 35);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "g", 36);
    \u0275\u0275element(36, "path", 37);
    \u0275\u0275elementEnd();
    \u0275\u0275element(37, "path", 38);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function UserMembershipComponent_ng_container_1_Template_button_click_50_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.paymentbtn("tenure"));
    });
    \u0275\u0275text(51, "Pay Now");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(52, "div", 21)(53, "div", 22)(54, "div", 23)(55, "h5", 24);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(56, "svg", 25)(57, "mask", 39);
    \u0275\u0275element(58, "rect", 40);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(59, "g", 41);
    ...
    \u0275\u0275listener("click", function UserMembershipComponent_ng_container_1_Template_button_click_73_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.paymentbtn("annual"));
    });
    \u0275\u0275text(74, "Pay Now");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementContainerEnd();
...
var UserMembershipComponent = class _UserMembershipComponent {
  ...
  ngOnInit() {
    this.userService.getUser().subscribe((res) => {
      ...
      this.hasSubscription = res && res.hasSubscription ? res.hasSubscription : false;
...
//# sourceMappingURL=chunk-ZKGLYLIL.mjs.map
