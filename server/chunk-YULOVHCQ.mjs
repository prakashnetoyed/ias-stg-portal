...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "membership",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-L5GSI34Q.mjs").then((m) => m.CombinedMemberPageComponent)
      },
      {
  ...
  },
  {
    ...
    canActivate: [authGuard],
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-XGOX3XAG.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-RGE5W43T.mjs").then((m) => m.DashboardComponent)
      },
      {
        path: "profile",
      ...
      {
        path: "mom",
        loadComponent: () => import("./chunk-4UV6ULQM.mjs").then((m) => m.MoMComponent)
      },
      {
        path: "feedbacks",
      ...
      {
        path: "approved-user",
        loadComponent: () => import("./chunk-LK6ED6G2.mjs").then((m) => m.ApprovedUserComponent)
      },
      {
        path: "pending-approval-user",
        loadComponent: () => import("./chunk-QVO4MFBI.mjs").then((m) => m.NotApprovedUserComponent)
      },
      {
        path: "rejected-user",
        loadComponent: () => import("./chunk-6LSHCXYS.mjs").then((m) => m.RejectedUsersComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-PUP45SAS.mjs").then((m) => m.UserDashboardComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-V3CF27WV.mjs").then((m) => m.UserHomeComponent)
      },
      {
        path: "user-profile",
      ...
      {
        path: "user-events",
        loadComponent: () => import("./chunk-A7XVY56G.mjs").then((m) => m.UserEventsComponent)
      },
      {
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-YULOVHCQ.mjs.map
