...
function UserHomeComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, UserHomeComponent_div_7_ng_container_3_Template, 2, 1, "ng-container", 70)(4, UserHomeComponent_div_7_ng_template_4_Template, 1, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "h1", 71);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, UserHomeComponent_div_7_div_8_Template, 2, 0, "div", 72);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function UserHomeComponent_div_21_div_6_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, UserHomeComponent_div_21_div_6_ng_container_1_img_1_Template, 1, 1, "img", 90)(2, UserHomeComponent_div_21_div_6_ng_container_1_video_2_Template, 1, 1, "video", 91);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function UserHomeComponent_div_21_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, UserHomeComponent_div_21_div_6_ng_container_1_Template, 3, 2, "ng-container", 89);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function UserHomeComponent_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 75)(1, "div", 76)(2, "div")(3, "small", 61);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "timeAgo");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(6, UserHomeComponent_div_21_div_6_Template, 2, 1, "div", 77);
    \u0275\u0275elementStart(7, "p", 75);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275element(9, "hr", 78);
    \u0275\u0275elementStart(10, "div", 79)(11, "div", 80)(12, "div", 81);
...
function UserHomeComponent_div_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 106)(1, "h1");
    \u0275\u0275text(2, "Membership Expiring in ");
    \u0275\u0275elementStart(3, "span", 39);
    \u0275\u0275text(4, "7 months");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(5, "hr");
    \u0275\u0275elementStart(6, "div", 107)(7, "div", 108)(8, "div", 109);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(9, "svg", 110);
    \u0275\u0275element(10, "path", 111);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275text(14, " Annual ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(15, "div", 112)(16, "div", 109);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(17, "svg", 101)(18, "mask", 113);
    \u0275\u0275element(19, "rect", 103);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "g", 114);
    \u0275\u0275element(21, "path", 115);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275text(25, " Rs 1,000 ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(26, "div", 108)(27, "div", 109);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(28, "svg", 101)(29, "mask", 116);
    \u0275\u0275element(30, "rect", 103);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "g", 117);
    \u0275\u0275element(32, "path", 118);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(33, "p")(34, "span");
    \u0275\u0275text(35, "Member Since:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(36, " 10 July 2025 ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(37, "div", 112)(38, "div", 109);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(39, "svg", 101)(40, "mask", 119);
    \u0275\u0275element(41, "rect", 103);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "g", 120);
    \u0275\u0275element(43, "path", 121);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(44, "p")(45, "span");
    \u0275\u0275text(46, "Valid Till:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(47, " 9 July 2026 ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(48, "div", 122)(49, "button", 123);
    \u0275\u0275text(50, "Remind Later");
    \u0275\u0275elementEnd()()();
  }
}
function UserHomeComponent_ng_container_39_div_1_img_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("src", post_r9 == null ? null : post_r9.createdBy == null ? null : post_r9.createdBy.doptOfficer == null ? null : post_r9.createdBy.doptOfficer.profilePic, \u0275\u0275sanitizeUrl);
  }
}
function UserHomeComponent_ng_container_39_div_1_div_9_ng_container_1_img_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const file_r10 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275property("src", ctx_r1.s3Url + file_r10, \u0275\u0275sanitizeUrl)("src", ctx_r1.s3Url + file_r10, \u0275\u0275sanitizeUrl);
  }
}
function UserHomeComponent_ng_container_39_div_1_div_9_ng_container_1_video_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const file_r10 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275property("src", ctx_r1.s3Url + file_r10, \u0275\u0275sanitizeUrl);
  }
}
function UserHomeComponent_ng_container_39_div_1_div_9_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, UserHomeComponent_ng_container_39_div_1_div_9_ng_container_1_img_1_Template, 1, 2, "img", 90)(2, UserHomeComponent_ng_container_39_div_1_div_9_ng_container_1_video_2_Template, 1, 1, "video", 91);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const file_r10 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", file_r10.endsWith(".jpg") || file_r10.endsWith(".jpeg") || file_r10.endsWith(".png"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", file_r10.endsWith(".mp4"));
  }
}
function UserHomeComponent_ng_container_39_div_1_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 131);
    \u0275\u0275template(1, UserHomeComponent_ng_container_39_div_1_div_9_ng_container_1_Template, 3, 2, "ng-container", 89);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const post_r9 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", post_r9.mediaFile);
  }
}
function UserHomeComponent_ng_container_39_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 125)(1, "div", 76);
    \u0275\u0275template(2, UserHomeComponent_ng_container_39_div_1_img_2_Template, 1, 1, "img", 126);
    \u0275\u0275elementStart(3, "div")(4, "h6", 127);
    \u0275\u0275text(5);
    \u0275\u0275elementStart(6, "small", 61);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "timeAgo");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(9, UserHomeComponent_ng_container_39_div_1_div_9_Template, 2, 1, "div", 128);
    \u0275\u0275elementStart(10, "p", 129);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275element(12, "hr", 78);
    \u0275\u0275elementStart(13, "div", 79)(14, "div", 80)(15, "div", 81);
    \u0275\u0275listener("click", function UserHomeComponent_ng_container_39_div_1_Template_div_click_15_listener() {
      const post_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.toggleLike(post_r9));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(16, "svg", 82);
    \u0275\u0275element(17, "path", 83);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", post_r9 == null ? null : post_r9.createdBy == null ? null : post_r9.createdBy.doptOfficer == null ? null : post_r9.createdBy.doptOfficer.profilePic);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", (post_r9 == null ? null : post_r9.createdBy == null ? null : post_r9.createdBy.doptOfficer == null ? null : post_r9.createdBy.doptOfficer.englishName) || "Unknown User", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(8, 10, post_r9.createdAt));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", (post_r9.mediaFile == null ? null : post_r9.mediaFile.length) > 0);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(post_r9.caption);
    \u0275\u0275advance(4);
    \u0275\u0275classProp("liked", post_r9 == null ? null : post_r9.isLiked)("animate", post_r9 == null ? null : post_r9.animate);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", post_r9 == null ? null : post_r9.likes, " Likes ");
  }
}
function UserHomeComponent_ng_container_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, UserHomeComponent_ng_container_39_div_1_Template, 23, 12, "div", 124);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserHomeComponent_div_92_ng_container_1_img_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 138);
  }
  if (rf & 2) {
...
function UserHomeComponent_div_92_ng_container_1_video_3_Template(rf, ctx) {
  if (rf & 1) {
...
function UserHomeComponent_div_92_ng_container_1_div_4_Template(rf, ctx) {
  if (rf & 1) {
...
function UserHomeComponent_div_92_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 134);
    \u0275\u0275template(2, UserHomeComponent_div_92_ng_container_1_img_2_Template, 1, 1, "img", 135)(3, UserHomeComponent_div_92_ng_container_1_video_3_Template, 1, 1, "video", 136)(4, UserHomeComponent_div_92_ng_container_1_div_4_Template, 3, 1, "div", 29);
    \u0275\u0275elementStart(5, "button", 137);
    \u0275\u0275listener("click", function UserHomeComponent_div_92_ng_container_1_Template_button_click_5_listener() {
...
function UserHomeComponent_div_92_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 133);
    \u0275\u0275template(1, UserHomeComponent_div_92_ng_container_1_Template, 7, 3, "ng-container", 89);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserHomeComponent_div_93_Template(rf, ctx) {
  if (rf & 1) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserHomeComponent, selectors: [["app-user-home"]], viewQuery: function UserHomeComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275template(7, UserHomeComponent_div_7_Template, 9, 4, "div", 8);
        ...
        \u0275\u0275elementEnd()()()();
        \u0275\u0275template(21, UserHomeComponent_div_21_Template, 21, 10, "div", 19)(22, UserHomeComponent_div_22_Template, 3, 0, "div", 19);
        \u0275\u0275elementEnd();
        \u0275\u0275namespaceHTML();
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(30, UserHomeComponent_div_30_Template, 51, 0, "div", 24);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(31, "div", 25)(32, "div", 26)(33, "div", 12)(34, "h1");
        \u0275\u0275text(35, "Community Highlights");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(36, "h4", 27);
        \u0275\u0275text(37, "View All Posts");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(38, "div", 28);
        \u0275\u0275template(39, UserHomeComponent_ng_container_39_Template, 2, 1, "ng-container", 29)(40, UserHomeComponent_div_40_Template, 3, 0, "div", 19);
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(41, "div", 30, 0)(43, "div", 31)(44, "h5", 32);
        \u0275\u0275text(45, "Add Post");
        \u0275\u0275elementEnd();
        \u0275\u0275element(46, "button", 33);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(47, "div", 34)(48, "form", 35);
        \u0275\u0275listener("ngSubmit", function UserHomeComponent_Template_form_ngSubmit_48_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onSubmit());
        });
        \u0275\u0275elementStart(49, "div", 36)(50, "div", 37)(51, "label", 38);
        \u0275\u0275text(52, "Caption");
        \u0275\u0275elementStart(53, "span", 39);
        \u0275\u0275text(54, "*");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(55, "input", 40);
        \u0275\u0275template(56, UserHomeComponent_small_56_Template, 2, 0, "small", 41);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(57, "div", 37)(58, "label", 38);
        \u0275\u0275text(59, "Description");
        \u0275\u0275elementEnd();
        \u0275\u0275element(60, "textarea", 42);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(61, "div", 37)(62, "label", 38);
        \u0275\u0275text(63, "Post Tag");
        \u0275\u0275elementStart(64, "span", 39);
        \u0275\u0275text(65, "*");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(66, "select", 43)(67, "option", 44);
        \u0275\u0275text(68, "Select tag");
        \u0275\u0275elementEnd();
        \u0275\u0275template(69, UserHomeComponent_option_69_Template, 2, 2, "option", 45);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(70, "div", 46)(71, "label", 47)(72, "div", 48);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(73, "svg", 49);
        \u0275\u0275element(74, "circle", 50);
        \u0275\u0275elementStart(75, "mask", 51);
        \u0275\u0275element(76, "rect", 52);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(77, "g", 53);
        \u0275\u0275element(78, "path", 54);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(79, "defs")(80, "linearGradient", 55);
        \u0275\u0275element(81, "stop", 56)(82, "stop", 57);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(83, "linearGradient", 58);
        \u0275\u0275element(84, "stop", 56)(85, "stop", 57);
        \u0275\u0275elementEnd()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(86, "div", 59)(87, "p", 60);
        \u0275\u0275text(88, "Click to upload or drag & drop");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(89, "small", 61);
        \u0275\u0275text(90, "Max size: 256MB each");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(91, "input", 62);
        \u0275\u0275listener("change", function UserHomeComponent_Template_input_change_91_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onFileSelected($event));
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275template(92, UserHomeComponent_div_92_Template, 2, 1, "div", 63)(93, UserHomeComponent_div_93_Template, 5, 0, "div", 64);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(94, "div", 65)(95, "button", 66);
        \u0275\u0275text(96, "Back");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(97, "button", 67);
        \u0275\u0275text(98, "Submit");
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
...
//# sourceMappingURL=chunk-M6T62HHL.mjs.map
