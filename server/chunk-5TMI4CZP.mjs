...
import {
  TimeAgoPipe
} from "./chunk-Y532XGUM.mjs";
import {
  UserService
} from "./chunk-T5MH57DV.mjs";
import {
  RouterLink
...
function UserHomeComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, UserHomeComponent_div_7_ng_container_3_Template, 2, 1, "ng-container", 89)(4, UserHomeComponent_div_7_ng_template_4_Template, 1, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "h1", 90);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 91);
    \u0275\u0275text(9, " Activated Membership ");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function UserHomeComponent_div_21_div_6_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, UserHomeComponent_div_21_div_6_ng_container_1_img_1_Template, 1, 1, "img", 107)(2, UserHomeComponent_div_21_div_6_ng_container_1_video_2_Template, 1, 1, "video", 108);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function UserHomeComponent_div_21_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, UserHomeComponent_div_21_div_6_ng_container_1_Template, 3, 2, "ng-container", 106);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function UserHomeComponent_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 93)(1, "div", 94)(2, "div")(3, "small", 80);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "timeAgo");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(6, UserHomeComponent_div_21_div_6_Template, 2, 1, "div", 95);
    \u0275\u0275elementStart(7, "p", 93);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275element(9, "hr", 96);
    \u0275\u0275elementStart(10, "div", 97)(11, "div", 98)(12, "div", 99);
    \u0275\u0275listener("click", function UserHomeComponent_div_21_Template_div_click_12_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleLike());
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(13, "svg", 100);
    \u0275\u0275element(14, "path", 101);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(16, "div", 102);
    \u0275\u0275listener("click", function UserHomeComponent_div_21_Template_div_click_16_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", (ctx_r1.userposts == null ? null : ctx_r1.userposts.mediaFile.length) > 0);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.userposts == null ? null : ctx_r1.userposts.caption);
    \u0275\u0275advance(4);
    \u0275\u0275classProp("liked", ctx_r1.liked)("animate", ctx_r1.animate);
    \u0275\u0275advance(3);
...
function UserHomeComponent_div_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 93)(1, "p", 93);
...
function UserHomeComponent_div_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(7, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 115)(9, "h6", 116);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "p", 117);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(12, "svg", 32)(13, "mask", 118);
    \u0275\u0275element(14, "rect", 34);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "g", 119);
    \u0275\u0275element(16, "path", 120);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", i_r7 % 2 === 0 ? "bg-purple" : "bg-teal");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(4, 5, event_r6.date, "MMM"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(7, 8, event_r6.date, "dd"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(event_r6.title);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", event_r6.location, " ");
  }
}
function UserHomeComponent_div_91_div_9_ng_container_1_img_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 109);
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("src", ctx_r1.s3Url + file_r9, \u0275\u0275sanitizeUrl)("src", ctx_r1.s3Url + file_r9, \u0275\u0275sanitizeUrl);
  }
}
function UserHomeComponent_div_91_div_9_ng_container_1_video_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "video", 110);
  }
  if (rf & 2) {
    const file_r9 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275property("src", ctx_r1.s3Url + file_r9, \u0275\u0275sanitizeUrl);
  }
}
function UserHomeComponent_div_91_div_9_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, UserHomeComponent_div_91_div_9_ng_container_1_img_1_Template, 1, 2, "img", 107)(2, UserHomeComponent_div_91_div_9_ng_container_1_video_2_Template, 1, 1, "video", 108);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const file_r9 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", file_r9.endsWith(".jpg") || file_r9.endsWith(".jpeg") || file_r9.endsWith(".png"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", file_r9.endsWith(".mp4"));
  }
}
function UserHomeComponent_div_91_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 126);
    \u0275\u0275template(1, UserHomeComponent_div_91_div_9_ng_container_1_Template, 3, 2, "ng-container", 106);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function UserHomeComponent_div_91_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 121)(1, "div", 94);
    \u0275\u0275element(2, "img", 122);
    \u0275\u0275elementStart(3, "div")(4, "h6", 123);
    \u0275\u0275text(5);
    \u0275\u0275elementStart(6, "small", 80);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "timeAgo");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(9, UserHomeComponent_div_91_div_9_Template, 2, 1, "div", 124);
    \u0275\u0275elementStart(10, "p", 125);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275element(12, "hr", 96);
    \u0275\u0275elementStart(13, "div", 97)(14, "div", 98)(15, "div", 99);
    \u0275\u0275listener("click", function UserHomeComponent_div_91_Template_div_click_15_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleLike());
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(16, "svg", 100);
    ...
    \u0275\u0275listener("click", function UserHomeComponent_div_91_Template_div_click_19_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.copyPostLink(ctx_r1.userposts.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(20, "svg", 103);
    \u0275\u0275element(21, "path", 104);
    \u0275\u0275elementEnd();
    \u0275\u0275text(22, "Copy Link ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("src", post_r10.createdBy.doptOfficer.profilePic, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", post_r10.createdBy.doptOfficer.englishName, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(8, 10, post_r10.createdAt));
    \u0275\u0275advance(2);
...
function UserHomeComponent_small_107_Template(rf, ctx) {
  if (rf & 1) {
...
function UserHomeComponent_option_120_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", tag_r11.id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", tag_r11.name, " ");
  }
}
function UserHomeComponent_div_143_ng_container_1_img_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 134);
  }
  if (rf & 2) {
    const preview_r13 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("src", preview_r13, \u0275\u0275sanitizeUrl);
  }
}
function UserHomeComponent_div_143_ng_container_1_video_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "video", 135);
  }
  if (rf & 2) {
    const preview_r13 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("src", preview_r13, \u0275\u0275sanitizeUrl);
...
function UserHomeComponent_div_143_ng_container_1_div_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Progress: ", ctx_r1.uploadProgress[i_r14], "%");
  }
}
function UserHomeComponent_div_143_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 129);
    \u0275\u0275template(2, UserHomeComponent_div_143_ng_container_1_img_2_Template, 1, 1, "img", 130)(3, UserHomeComponent_div_143_ng_container_1_video_3_Template, 1, 1, "video", 131)(4, UserHomeComponent_div_143_ng_container_1_div_4_Template, 3, 1, "div", 132);
    \u0275\u0275elementStart(5, "button", 133);
    \u0275\u0275listener("click", function UserHomeComponent_div_143_ng_container_1_Template_button_click_5_listener() {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.selectedFiles[i_r14].type.startsWith("image/"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.selectedFiles[i_r14].type.startsWith("video/"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.uploadProgress[i_r14] >= 0);
  }
}
function UserHomeComponent_div_143_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 128);
    \u0275\u0275template(1, UserHomeComponent_div_143_ng_container_1_Template, 7, 3, "ng-container", 106);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserHomeComponent_div_144_Template(rf, ctx) {
  if (rf & 1) {
...
var UserHomeComponent = class _UserHomeComponent {
  ...
  constructor(userService, http, fb) {
    ...
    this.postForm = this.fb.group({
      ...
      description: [""],
      postTagId: [0, Validators.required],
      mediaFile: [[]]
    });
  }
  loadEvents() {
    ...
    this.http.get(`${environment.apiUrl}/events?&limit=2`, { headers }).subscribe({
      next: (res) => {
        console.log(res);
  ...
  communityposts() {
    ...
    this.http.get(`${environment.apiUrl}/communities?populate=createdBy&limit=50`, { headers }).subscribe({
      next: (res) => {
        console.log(res);
  ...
  communityuseridposts(id) {
    ...
    console.log("id", id);
    this.http.get(`${environment.apiUrl}/communities?populate=postTag&populate=createdBy&createdBy=${id}&limit=1`, { headers }).subscribe({
      next: (res) => {
        console.log(res);
  ...
  onFileSelected(event) {
    ...
    Array.from(files).forEach((file) => {
      if (file.size > 128 * 1024 * 1024) {
        alert(`"${file.name}" exceeds 32MB. Skipping.`);
        return;
      }
  ...
  removeFile(index) {
    ...
    this.postForm.patchValue({ mediaFile: this.selectedFiles.map((f) => f.name) });
  }
  uploadFile(file) {
    if (!file)
      return;
    ...
    this.http.post(`${environment.apiUrl}/upload`, formData, { headers }).subscribe({
      next: (result) => {
        ...
        if (result.success && result.data?.url) {
          const currentUrls = this.postForm.value.mediaFile || [];
          this.mediaupload = false;
          console.log("uploaded", currentUrls);
          currentUrls.push(result.data.url);
          this.postForm.patchValue({ mediaFile: currentUrls });
        }
      },
      error: (err) => {
  ...
  static {
    this.\u0275fac = function UserHomeComponent_Factory(t) {
      return new (t || _UserHomeComponent)(\u0275\u0275directiveInject(UserService), \u0275\u0275directiveInject(HttpClient), \u0275\u0275directiveInject(FormBuilder));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserHomeComponent, selectors: [["app-user-home"]], viewQuery: function UserHomeComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275template(7, UserHomeComponent_div_7_Template, 10, 3, "div", 8);
        \u0275\u0275elementStart(8, "div", 9)(9, "div", 10)(10, "div", 11)(11, "div", 12)(12, "h1");
        \u0275\u0275text(13, "Recent Posts");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(14, "button", 13);
        \u0275\u0275text(15, "Add Post ");
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(16, "svg", 14)(17, "mask", 15);
        \u0275\u0275element(18, "rect", 16);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(19, "g", 17);
        \u0275\u0275element(20, "path", 18);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275template(21, UserHomeComponent_div_21_Template, 20, 10, "div", 19)(22, UserHomeComponent_div_22_Template, 3, 0, "div", 19);
        \u0275\u0275elementEnd();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(23, "div", 20)(24, "div", 21)(25, "h1");
        \u0275\u0275text(26, "Upcoming Events");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(27, "h4", 22);
        \u0275\u0275text(28, "View All Events");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(29, UserHomeComponent_div_29_Template, 18, 11, "div", 23);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(30, "div", 24)(31, "h1");
        \u0275\u0275text(32, "Membership Expiring in ");
        \u0275\u0275elementStart(33, "span", 25);
        \u0275\u0275text(34, "7 months");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(35, "hr");
        \u0275\u0275elementStart(36, "div", 26)(37, "div", 27)(38, "div", 28);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(39, "svg", 29);
        \u0275\u0275element(40, "path", 30);
        \u0275\u0275elementEnd();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(41, "p")(42, "span");
        \u0275\u0275text(43, "Membership Type:");
        \u0275\u0275elementEnd();
        \u0275\u0275text(44, " Annual ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(45, "div", 31)(46, "div", 28);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(47, "svg", 32)(48, "mask", 33);
        \u0275\u0275element(49, "rect", 34);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(50, "g", 35);
        \u0275\u0275element(51, "path", 36);
        \u0275\u0275elementEnd()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(52, "p")(53, "span");
        \u0275\u0275text(54, "Fee Paid:");
        \u0275\u0275elementEnd();
        \u0275\u0275text(55, " Rs 1,000 ");
        \u0275\u0275elementEnd()()();
        ...
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(58, "svg", 32)(59, "mask", 37);
        \u0275\u0275element(60, "rect", 34);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(61, "g", 38);
        \u0275\u0275element(62, "path", 39);
        \u0275\u0275elementEnd()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(63, "p")(64, "span");
        \u0275\u0275text(65, "Member Since:");
        \u0275\u0275elementEnd();
        \u0275\u0275text(66, " 10 July 2025 ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(67, "div", 31)(68, "div", 28);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(69, "svg", 32)(70, "mask", 40);
        \u0275\u0275element(71, "rect", 34);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(72, "g", 41);
        \u0275\u0275element(73, "path", 42);
        \u0275\u0275elementEnd()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(74, "p")(75, "span");
        \u0275\u0275text(76, "Valid Till:");
        \u0275\u0275elementEnd();
        \u0275\u0275text(77, " 9 July 2026 ");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(78, "div", 43)(79, "button", 44);
        \u0275\u0275text(80, "Renew Membership");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(81, "button", 45);
        \u0275\u0275text(82, "Remind Later");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(83, "div", 46)(84, "div", 47)(85, "div", 12)(86, "h1");
        \u0275\u0275text(87, "Community Highlights");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(88, "h4");
        \u0275\u0275text(89, "View All Posts");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(90, "div", 48);
        \u0275\u0275template(91, UserHomeComponent_div_91_Template, 23, 12, "div", 49);
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(92, "div", 50, 0)(94, "div", 51)(95, "h5", 52);
        \u0275\u0275text(96, "Add Post");
        \u0275\u0275elementEnd();
        \u0275\u0275element(97, "button", 53);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(98, "div", 54)(99, "form", 55);
        \u0275\u0275listener("ngSubmit", function UserHomeComponent_Template_form_ngSubmit_99_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onSubmit());
        });
        \u0275\u0275elementStart(100, "div", 56)(101, "div", 57)(102, "label", 58);
        \u0275\u0275text(103, "Caption");
        \u0275\u0275elementStart(104, "span", 25);
        \u0275\u0275text(105, "*");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(106, "input", 59);
        \u0275\u0275template(107, UserHomeComponent_small_107_Template, 2, 0, "small", 60);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(108, "div", 57)(109, "label", 58);
        \u0275\u0275text(110, "Description");
        \u0275\u0275elementEnd();
        \u0275\u0275element(111, "textarea", 61);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(112, "div", 57)(113, "label", 58);
        \u0275\u0275text(114, "Post Tag");
        \u0275\u0275elementStart(115, "span", 25);
        \u0275\u0275text(116, "*");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(117, "select", 62)(118, "option", 63);
        \u0275\u0275text(119, "Select tag");
        \u0275\u0275elementEnd();
        \u0275\u0275template(120, UserHomeComponent_option_120_Template, 2, 2, "option", 64);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(121, "div", 65)(122, "label", 66)(123, "div", 67);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(124, "svg", 68);
        \u0275\u0275element(125, "circle", 69);
        \u0275\u0275elementStart(126, "mask", 70);
        \u0275\u0275element(127, "rect", 71);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(128, "g", 72);
        \u0275\u0275element(129, "path", 73);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(130, "defs")(131, "linearGradient", 74);
        \u0275\u0275element(132, "stop", 75)(133, "stop", 76);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(134, "linearGradient", 77);
        \u0275\u0275element(135, "stop", 75)(136, "stop", 76);
        \u0275\u0275elementEnd()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(137, "div", 78)(138, "p", 79);
        \u0275\u0275text(139, "Click to upload or drag & drop");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(140, "small", 80);
        \u0275\u0275text(141, "Max size: 32MB each");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(142, "input", 81);
        \u0275\u0275listener("change", function UserHomeComponent_Template_input_change_142_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onFileSelected($event));
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275template(143, UserHomeComponent_div_143_Template, 2, 1, "div", 82)(144, UserHomeComponent_div_144_Template, 5, 0, "div", 83);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(145, "div", 84)(146, "button", 85);
        \u0275\u0275text(147, "Back");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(148, "button", 86);
        \u0275\u0275text(149, "Submit");
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        ...
        \u0275\u0275advance(8);
        \u0275\u0275property("ngIf", (tmp_9_0 = ctx.postForm.get("caption")) == null ? null : tmp_9_0.errors == null ? null : tmp_9_0.errors["maxlength"]);
        \u0275\u0275advance(13);
        ...
        \u0275\u0275advance(4);
        \u0275\u0275property("disabled", ctx.postForm.invalid || ctx.mediaupload);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserHomeComponent, { className: "UserHomeComponent", filePath: "src/app/user-portal/pages/user-home/user-home.component.ts", lineNumber: 19 });
})();
export {
  UserHomeComponent
};
//# sourceMappingURL=chunk-5TMI4CZP.mjs.map
