...
var routes = [
    ...
    children: [
      {
        ...
        loadComponent: () => import("./chunk-TQHQ6GJC.mjs").then((m) => m.IasHomepageComponent)
      },
      {
        path: "about-us",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "all-members",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-VS2NUXCH.mjs").then((m) => m.AllMembersComponent)
      },
      {
        path: "news-blogs",
        // component:IasHomepageComponent,
  ...
  },
  {
    ...
    canActivate: [authGuard],
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-IGU6IPB7.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
      ...
      {
        path: "profile",
        loadComponent: () => import("./chunk-7BPADHY6.mjs").then((m) => m.ProfileInfoComponent)
      },
      {
        path: "publications",
        loadComponent: () => import("./chunk-DGTTOSF2.mjs").then((m) => m.PublicationsComponent)
      },
      {
        path: "blogs",
      ...
      {
        path: "news",
        loadComponent: () => import("./chunk-UZGVLTC3.mjs").then((m) => m.NewsComponent)
      },
      {
        path: "mom",
        loadComponent: () => import("./chunk-DU6AMCZO.mjs").then((m) => m.MoMComponent)
      },
      {
        path: "feedbacks",
        loadComponent: () => import("./chunk-4FEUG7NW.mjs").then((m) => m.FeedbacksComponent)
      },
      {
        path: "my-transaction",
        loadComponent: () => import("./chunk-PWHR6OQS.mjs").then((m) => m.MyTransactionComponent)
      },
      {
        path: "approved-user",
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-RMKLBE7U.mjs").then((m) => m.UserDashboardComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-WMAJJ3SJ.mjs").then((m) => m.UserHomeComponent)
      },
      {
        path: "user-profile",
      ...
      {
        path: "user-events",
        loadComponent: () => import("./chunk-RWZZS5BE.mjs").then((m) => m.UserEventsComponent)
      },
      {
        path: "user-membership",
        loadComponent: () => import("./chunk-W5Q3JLHZ.mjs").then((m) => m.UserMembershipComponent)
      },
      {
        path: "user-members",
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-P6V2E3OF.mjs").then((m) => m.MyTransactionsComponent)
      },
      {
        path: "payment-status",
        loadComponent: () => import("./chunk-XVEYSLMM.mjs").then((m) => m.PaymentStatusComponent)
      }
    ]
  },
  {
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-2GUYOG2R.mjs.map
