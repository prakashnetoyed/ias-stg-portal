...
function IasCommunityComponent_ng_container_32_div_1_div_8_ng_container_1_img_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("src", "https://iascaportal.s3.ap-south-1.amazonaws.com/" + file_r5, \u0275\u0275sanitizeUrl);
  }
}
function IasCommunityComponent_ng_container_32_div_1_div_8_ng_container_1_video_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "video", 49);
  }
  if (rf & 2) {
    const file_r5 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("src", "https://iascaportal.s3.ap-south-1.amazonaws.com/" + file_r5, \u0275\u0275sanitizeUrl);
...
function IasCommunityComponent_ng_container_32_div_1_div_8_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, IasCommunityComponent_ng_container_32_div_1_div_8_ng_container_1_img_1_Template, 1, 1, "img", 46)(2, IasCommunityComponent_ng_container_32_div_1_div_8_ng_container_1_video_2_Template, 1, 1, "video", 47);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function IasCommunityComponent_ng_container_32_div_1_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, IasCommunityComponent_ng_container_32_div_1_div_8_ng_container_1_Template, 3, 2, "ng-container", 45);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const post_r6 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", post_r6.mediaFile);
  }
}
function IasCommunityComponent_ng_container_32_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function IasCommunityComponent_ng_container_32_div_1_Template_div_click_17_listener() {
      ...
      return \u0275\u0275resetView(ctx_r2.toggleLike());
    });
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275listener("click", function IasCommunityComponent_ng_container_32_div_1_Template_div_click_21_listener() {
      const post_r6 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.copyPostLink(post_r6.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(22, "svg", 41);
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275property("src", post_r6.createdBy.doptOfficer.profilePic, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(post_r6.createdBy.doptOfficer.englishName);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 11, post_r6.createdAt));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", post_r6.mediaFile.length > 0);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(post_r6.caption);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(post_r6.description);
    \u0275\u0275advance(4);
    \u0275\u0275classProp("liked", ctx_r2.liked)("animate", ctx_r2.animate);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", post_r6.likes, " Likes ");
  }
}
function IasCommunityComponent_ng_container_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, IasCommunityComponent_ng_container_32_div_1_Template, 26, 13, "div", 28);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var IasCommunityComponent = class _IasCommunityComponent {
  ...
  communityposts() {
    this.http.get(`${environment.apiUrl}/communities?populate=createdBy`).subscribe({
      next: (res) => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(IasCommunityComponent, { className: "IasCommunityComponent", filePath: "src/app/website/pages/ias-community/ias-community.component.ts", lineNumber: 15 });
})();
export {
  IasCommunityComponent
};
//# sourceMappingURL=chunk-YQYPOXZ2.mjs.map
