...
function IasHeaderComponent_ng_container_38_div_1_ng_container_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("src", ctx_r1.userRole === "admin" ? ctx_r1.user == null ? null : ctx_r1.user.profilePic : ctx_r1.user == null ? null : ctx_r1.user.doptOfficer == null ? null : ctx_r1.user.doptOfficer.profilePic, \u0275\u0275sanitizeUrl);
  }
}
...
function IasHeaderComponent_ng_container_38_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r1.userRole === "admin" ? ctx_r1.user == null ? null : ctx_r1.user.profilePic : ctx_r1.user == null ? null : ctx_r1.user.doptOfficer == null ? null : ctx_r1.user.doptOfficer.profilePic)("ngIfElse", initials_r3);
    \u0275\u0275advance(4);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _IasFooterComponent, selectors: [["app-ias-footer"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 67, vars: 4, consts: [[1, "footer"], [1, "container"], [1, "footer-top"], [1, "footer-logo"], [1, "sbvhs", "d-flex", "align-items-center", "gap-2"], ["src", "../../../assets/logo/ias-small-logo.png", "alt", "IAS Association Logo"], [1, "org-name", "m-0", "p-0"], [1, "last-updated"], [1, "footer-links"], [3, "routerLink"], [2, "cursor", "pointer", 3, "routerLink"], [1, "footer-contact"], [1, "social-icons"], ["href", "https://x.com/iasassociation", "target", "_blank"], [1, "fab", "fa-x-twitter"], ["href", "https://www.facebook.com/IASassociation/", "target", "_blank"], [1, "fab", "fa-facebook-f"], [1, "contact-info"], [1, "d-flex", "gap-2"], ["xmlns", "http://www.w3.org/2000/svg", "width", "17", "height", "18", "viewBox", "0 0 17 18", "fill", "none"], ["id", "mask0_52081_3854", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "17", "height", "18", 2, "mask-type", "alpha"], ["width", "17", "height", "18", "fill", "#D9D9D9"], ["mask", "url(#mask0_52081_3854)"], ["d", "M8.50742 9C8.92164 9 9.27624 8.85313 9.57121 8.55938C9.86618 8.26563 10.0137 7.9125 10.0137 7.5C10.0137 7.0875 9.86618 6.73438 9.57121 6.44063C9.27624 6.14687 8.92164 6 8.50742 6C8.0932 6 7.73861 6.14687 7.44363 6.44063C7.14866 6.73438 7.00117 7.0875 7.00117 7.5C7.00117 7.9125 7.14866 8.26563 7.44363 8.55938C7.73861 8.85313 8.0932 9 8.50742 9ZM8.50742 14.5125C10.0388 13.1125 11.1747 11.8406 11.9153 10.6969C12.6559 9.55312 13.0262 8.5375 13.0262 7.65C13.0262 6.2875 12.59 5.17188 11.7176 4.30312C10.8452 3.43438 9.77518 3 8.50742 3C7.23966 3 6.1696 3.43438 5.29723 4.30312C4.42486 5.17188 3.98867 6.2875 3.98867 7.65C3.98867 8.5375 4.35896 9.55312 5.09953 10.6969C5.8401 11.8406 6.97607 13.1125 8.50742 14.5125ZM8.50742 16.5C6.48654 14.7875 4.97715 13.1969 3.97926 11.7281C2.98137 10.2594 2.48242 8.9 2.48242 7.65C2.48242 5.775 3.08806 4.28125 4.29934 3.16875C5.51061 2.05625 6.91331 1.5 8.50742 1.5C10.1015 1.5 11.5042 2.05625 12.7155 3.16875C13.9268 4.28125 14.5324 5.775 14.5324 7.65C14.5324 8.9 14.0335 10.2594 13.0356 11.7281C12.0377 13.1969 10.5283 14.7875 8.50742 16.5Z", "fill", "#1C1B1F"], ["xmlns", "http://www.w3.org/2000/svg", "width", "18", "height", "18", "viewBox", "0 0 18 18", "fill", "none"], ["id", "mask0_52081_3844", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "18", "height", "18", 2, "mask-type", "alpha"], ["width", "18", "height", "18", "fill", "#D9D9D9"], ["mask", "url(#mask0_52081_3844)"], ["d", "M8.25 12.75H9.75V8.25H8.25V12.75ZM9 6.75C9.2125 6.75 9.39063 6.67812 9.53438 6.53438C9.67813 6.39062 9.75 6.2125 9.75 6C9.75 5.7875 9.67813 5.60938 9.53438 5.46562C9.39063 5.32187 9.2125 5.25 9 5.25C8.7875 5.25 8.60938 5.32187 8.46563 5.46562C8.32188 5.60938 8.25 5.7875 8.25 6C8.25 6.2125 8.32188 6.39062 8.46563 6.53438C8.60938 6.67812 8.7875 6.75 9 6.75ZM9 16.5C7.9625 16.5 6.9875 16.3031 6.075 15.9094C5.1625 15.5156 4.36875 14.9813 3.69375 14.3063C3.01875 13.6313 2.48438 12.8375 2.09063 11.925C1.69687 11.0125 1.5 10.0375 1.5 9C1.5 7.9625 1.69687 6.9875 2.09063 6.075C2.48438 5.1625 3.01875 4.36875 3.69375 3.69375C4.36875 3.01875 5.1625 2.48438 6.075 2.09063C6.9875 1.69687 7.9625 1.5 9 1.5C10.0375 1.5 11.0125 1.69687 11.925 2.09063C12.8375 2.48438 13.6313 3.01875 14.3063 3.69375C14.9813 4.36875 15.5156 5.1625 15.9094 6.075C16.3031 6.9875 16.5 7.9625 16.5 9C16.5 10.0375 16.3031 11.0125 15.9094 11.925C15.5156 12.8375 14.9813 13.6313 14.3063 14.3063C13.6313 14.9813 12.8375 15.5156 11.925 15.9094C11.0125 16.3031 10.0375 16.5 9 16.5ZM9 15C10.675 15 12.0938 14.4187 13.2563 13.2563C14.4187 12.0938 15 10.675 15 9C15 7.325 14.4187 5.90625 13.2563 4.74375C12.0938 3.58125 10.675 3 9 3C7.325 3 5.90625 3.58125 4.74375 4.74375C3.58125 5.90625 3 7.325 3 9C3 10.675 3.58125 12.0938 4.74375 13.2563C5.90625 14.4187 7.325 15 9 15Z", "fill", "#1C1B1F"], [1, "text-muted"], [1, "mt-2", "needlink"], ["href", "tel:+919876543210", 1, "d-block", "text-primary"], ["href", "mailto:iascahelpdesk@gmail.com", 1, "d-block", "text-primary"], [1, "footer-bottom"], [1, "container", "d-flex", "align-items-center", "justify-content-between"], [1, "m-0"], [1, "footer-policies"], ["routerLink", "Refund-Cancellation-Policy"], ["routerLink", "Terms-Conditions"], ["routerLink", "Privacy-Policy"]], template: function IasFooterComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(11, "Last updated: 22-09-2025");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275text(55, "[iascahelpdesk@gmail.com]");
        \u0275\u0275elementEnd()()()()()()()();
...
var AccessibilityHeaderComponent = class _AccessibilityHeaderComponent {
  ...
  sendMail() {
    window.location.href = "mailto:iascahelpdesk@gmail.com?subject=Help%20Desk%20Support&body=Hello,%0D%0A%0D%0AI am contacting the Help Desk for assistance.%0D%0A%0D%0ARegards,";
  }
  scrollToContent() {
...
function IasSignupComponent_div_10_div_7_small_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small");
    \u0275\u0275text(1, "Email is required.");
    \u0275\u0275elementEnd();
...
function IasSignupComponent_div_10_div_7_small_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small");
    \u0275\u0275text(1, "Enter a Valid Email Id");
    \u0275\u0275elementEnd();
...
function IasSignupComponent_div_10_div_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20);
    \u0275\u0275template(1, IasSignupComponent_div_10_div_7_small_1_Template, 2, 0, "small", 0)(2, IasSignupComponent_div_10_div_7_small_2_Template, 2, 0, "small", 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_2_0;
...
function IasSignupComponent_div_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "form", 12);
    \u0275\u0275listener("ngSubmit", function IasSignupComponent_div_10_Template_form_ngSubmit_3_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.submitEmail());
    });
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(6, "input", 14);
    \u0275\u0275template(7, IasSignupComponent_div_10_div_7_Template, 3, 2, "div", 15);
    \u0275\u0275elementStart(8, "button", 16);
    \u0275\u0275text(9, "Sign up");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 17)(11, "span");
    \u0275\u0275namespaceSVG();
...
function IasSignupComponent_div_11_input_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "input", 28);
    \u0275\u0275listener("input", function IasSignupComponent_div_11_input_7_Template_input_input_0_listener($event) {
      const i_r5 = \u0275\u0275restoreView(_r4).index;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onOtpInput($event, i_r5));
    })("keydown", function IasSignupComponent_div_11_input_7_Template_input_keydown_0_listener($event) {
      const i_r5 = \u0275\u0275restoreView(_r4).index;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.handleKeyDown($event, i_r5));
    });
...
function IasSignupComponent_div_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "form", 12);
    \u0275\u0275listener("ngSubmit", function IasSignupComponent_div_11_Template_form_ngSubmit_5_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.submitOtp());
    });
    \u0275\u0275elementStart(6, "div", 21);
    \u0275\u0275template(7, IasSignupComponent_div_11_input_7_Template, 1, 1, "input", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "button", 23);
    \u0275\u0275text(9, "Continue");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function IasSignupComponent_div_11_Template_span_click_13_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(!ctx_r1.isResendDisabled && ctx_r1.onResendOtp());
    });
...
function IasSignupComponent_div_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 10)(1, "h1", 11);
    ...
    \u0275\u0275listener("click", function IasSignupComponent_div_12_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function IasSignupComponent_div_12_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
...
function IasSignupComponent_div_13_div_13_small_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small");
...
function IasSignupComponent_div_13_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20);
    \u0275\u0275template(1, IasSignupComponent_div_13_div_13_small_1_Template, 2, 0, "small", 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_2_0;
...
function IasSignupComponent_div_13_div_19_small_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small");
...
function IasSignupComponent_div_13_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20);
    \u0275\u0275template(1, IasSignupComponent_div_13_div_19_small_1_Template, 2, 0, "small", 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_2_0;
...
function IasSignupComponent_div_13_div_25_small_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small");
    \u0275\u0275text(1, " Enter a valid email ");
    \u0275\u0275elementEnd();
...
function IasSignupComponent_div_13_div_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20);
    \u0275\u0275template(1, IasSignupComponent_div_13_div_25_small_1_Template, 2, 0, "small", 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_2_0;
...
function IasSignupComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 10)(1, "p")(2, "span", 32);
    \u0275\u0275listener("click", function IasSignupComponent_div_13_Template_span_click_2_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("ngSubmit", function IasSignupComponent_div_13_Template_form_ngSubmit_7_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("keypress", function IasSignupComponent_div_13_Template_input_keypress_12_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.allowOnlyLetters($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, IasSignupComponent_div_13_div_13_Template, 2, 1, "div", 15);
    ...
    \u0275\u0275template(19, IasSignupComponent_div_13_div_19_Template, 2, 1, "div", 15);
    \u0275\u0275elementStart(20, "div", 39)(21, "div", 40)(22, "label", 41);
...
function IasSignupComponent_div_14_For_23_Template(rf, ctx) {
  if (rf & 1) {
...
function IasSignupComponent_div_14_div_72_small_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small");
    \u0275\u0275text(1, " Enter a valid email ");
    \u0275\u0275elementEnd();
...
function IasSignupComponent_div_14_div_72_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20);
    \u0275\u0275template(1, IasSignupComponent_div_14_div_72_small_1_Template, 2, 0, "small", 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_2_0;
...
function IasSignupComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 10)(1, "p")(2, "span", 32);
    \u0275\u0275listener("click", function IasSignupComponent_div_14_Template_span_click_2_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.currentStep = 3);
    });
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "form", 12);
    \u0275\u0275listener("ngSubmit", function IasSignupComponent_div_14_Template_form_ngSubmit_7_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("keypress", function IasSignupComponent_div_14_Template_input_keypress_12_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.allowOnlyLetters($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 48)(14, "div", 40)(15, "label", 49);
    \u0275\u0275text(16, "Cadre");
    \u0275\u0275elementStart(17, "span", 35);
    \u0275\u0275text(18, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "select", 50)(20, "option", 51);
    \u0275\u0275text(21, "Enter Cadre");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(22, IasSignupComponent_div_14_For_23_Template, 2, 2, "option", 52, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "div", 40)(25, "label", 53);
    \u0275\u0275text(26, "Allotment Year");
    \u0275\u0275elementStart(27, "span", 35);
    \u0275\u0275text(28, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "input", 54);
    \u0275\u0275listener("input", function IasSignupComponent_div_14_Template_input_input_29_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.validateYear($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "div", 40)(31, "label", 55);
    \u0275\u0275text(32, "Gender");
    \u0275\u0275elementStart(33, "span", 35);
    \u0275\u0275text(34, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "select", 56)(36, "option", 57);
    ...
    \u0275\u0275text(41, "Female");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "option", 60);
    \u0275\u0275text(43, "Other");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(44, "div", 40)(45, "label", 61);
    \u0275\u0275text(46, "Date of Birth");
    \u0275\u0275elementStart(47, "span", 35);
    \u0275\u0275text(48, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(49, "input", 62);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "div", 40)(51, "label", 63);
    \u0275\u0275text(52, "Mother Tongue");
    \u0275\u0275elementStart(53, "span", 35);
    \u0275\u0275text(54, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(55, "input", 64);
    \u0275\u0275listener("keypress", function IasSignupComponent_div_14_Template_input_keypress_55_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.allowOnlyLetters($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(56, "div", 40)(57, "label", 65);
    \u0275\u0275text(58, "Service Status");
    \u0275\u0275elementStart(59, "span", 35);
    \u0275\u0275text(60, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(61, "select", 66)(62, "option", 57);
    \u0275\u0275text(63, "Select Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "option", 67);
    \u0275\u0275text(65, "Serving");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "option", 68);
    \u0275\u0275text(67, "Superannuated");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(68, "div", 40)(69, "label", 69);
    \u0275\u0275text(70, "Alternate Email ID");
    \u0275\u0275elementEnd();
    \u0275\u0275element(71, "input", 70);
    \u0275\u0275template(72, IasSignupComponent_div_14_div_72_Template, 2, 1, "div", 15);
    \u0275\u0275elementEnd();
...
function IasSignupComponent_div_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 78)(10, "span");
...
var authGuard = (route, state) => {
  ...
  if (isPlatformBrowser(platformId)) {
    ...
    const toastService2 = inject(ToastService);
    if (token) {
      ...
      if (expectedRoles && !expectedRoles.includes(role)) {
        if (role === "admin" && expectedRoles.includes("user")) {
          toastService2.showToast("You are logged in as admin. To visit this page, login with member credentials.", "danger");
        } else {
    ...
    toastService2.showToast("To visit this page you need to Login", "success");
...
var routes = [
    ...
    children: [
      {
        ...
        loadComponent: () => import("./chunk-KTODOADC.mjs").then((m) => m.IasHomepageComponent)
      },
      {
        path: "about-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-RBHQL4BZ.mjs").then((m) => m.IasAboutusComponent)
      },
      {
        path: "contact-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-H5UUVDQW.mjs").then((m) => m.IasContactusComponent)
      },
      {
        path: "community",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-XAGQDXY4.mjs").then((m) => m.IasCommunityComponent)
      },
      {
        path: "post",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-XDVQZSTU.mjs").then((m) => m.PostComponent)
      },
      {
        path: "caruna",
        loadComponent: () => import("./chunk-JEPZOQPD.mjs").then((m) => m.IasCarunaComponent)
      },
      {
        path: "all-members",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-R7JVYNLC.mjs").then((m) => m.AllMembersComponent)
      },
      {
        path: "news-blogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-EKLJYE4X.mjs").then((m) => m.NewsBlogsComponent)
      },
      {
        path: "caruna",
        // component:IasHomepageComponent,
      ...
      },
      {
        ...
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-SNKB5FTV.mjs").then((m) => m.WelfareMembershipComponent)
      },
      {
        path: "lifetime-membership",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-DECCGSV3.mjs").then((m) => m.LifetimeMembershipComponent)
      },
      {
        path: "readmorenews",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-Y4Z5LC3U.mjs").then((m) => m.ReadmoreNewsComponent)
      },
      {
        path: "readmoreblogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-IZAFG43O.mjs").then((m) => m.ReadmoreBlogsComponent)
      },
      {
        path: "membership",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-Q6VMMBK6.mjs").then((m) => m.CombinedMemberPageComponent)
      },
      {
        path: "Terms-Conditions",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-YV5CP3BW.mjs").then((m) => m.TermsConditionsComponent)
      },
      {
      ...
      },
      {
        path: "Privacy-Policy",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-RBCJRFBE.mjs").then((m) => m.PrivacyPolicyComponent)
      }
    ]
  },
  {
  ...
  },
  {
    ...
    canActivate: [authGuard],
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-7FTRE4IQ.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-Y42V62GS.mjs").then((m) => m.DashboardComponent)
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-VPYHI3CT.mjs").then((m) => m.ProfileInfoComponent)
      },
      {
        path: "publications",
        loadComponent: () => import("./chunk-DOOIAPG7.mjs").then((m) => m.PublicationsComponent)
      },
      {
        path: "blogs",
        loadComponent: () => import("./chunk-B3QJ2LKZ.mjs").then((m) => m.BlogsComponent)
      },
      {
        path: "news",
        loadComponent: () => import("./chunk-77G5AHYZ.mjs").then((m) => m.NewsComponent)
      },
      {
        path: "mom",
        loadComponent: () => import("./chunk-OEXGA2R4.mjs").then((m) => m.MoMComponent)
      },
      {
        path: "feedbacks",
        loadComponent: () => import("./chunk-5BPBWQPR.mjs").then((m) => m.FeedbacksComponent)
      },
      {
        path: "my-transaction",
        loadComponent: () => import("./chunk-GTCBDGOM.mjs").then((m) => m.MyTransactionComponent)
      },
      {
        path: "approved-user",
        loadComponent: () => import("./chunk-CRJZHNFP.mjs").then((m) => m.ApprovedUserComponent)
      },
      {
        path: "pending-approval-user",
        loadComponent: () => import("./chunk-VPUQ55DR.mjs").then((m) => m.NotApprovedUserComponent)
      },
      {
        path: "rejected-user",
        loadComponent: () => import("./chunk-SG5OXTAH.mjs").then((m) => m.RejectedUsersComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-RG3QV6NN.mjs").then((m) => m.UserDashboardComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-GATHXY3G.mjs").then((m) => m.UserHomeComponent)
      },
      {
        path: "user-profile",
        loadComponent: () => import("./chunk-ZNCXKJUI.mjs").then((m) => m.UserProfileComponent)
      },
      {
        path: "user-events",
        loadComponent: () => import("./chunk-OK2V22KO.mjs").then((m) => m.UserEventsComponent)
      },
      {
        path: "user-membership",
        loadComponent: () => import("./chunk-MCI2UQXG.mjs").then((m) => m.UserMembershipComponent)
      },
      {
        path: "user-members",
        loadComponent: () => import("./chunk-4EWY7KIR.mjs").then((m) => m.UserMembersComponent)
      },
      {
        path: "user-transactions",
        loadComponent: () => import("./chunk-ZRHHC6QG.mjs").then((m) => m.MyTransactionsComponent)
      },
      {
        path: "payment-status",
        loadComponent: () => import("./chunk-WYKYAV4J.mjs").then((m) => m.PaymentStatusComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-5Y7XKS36.mjs").then((m) => m.UserNotApprovedLayoutComponent)
  },
  {
    path: "**",
    // wildcard → catch all unknown routes
    loadComponent: () => import("./chunk-XQXSHW5S.mjs").then((m) => m.RouteErrorComponent)
  }
];
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const moduleImpl = this.moduleImpl ?? import("./chunk-2HYMYBD6.mjs");
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-KJBENMAQ.mjs.map
