...
// src/app/IAS-portal/pages/donations/donations.component.ts
var _c0 = ["errorToast"];
var _c1 = () => [];
function DonationsComponent_tr_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function DonationsComponent_tr_31_Template_button_click_17_listener() {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", user_r3.message === "Success" ? "Success" : "Undefined");
    \u0275\u0275advance();
...
function DonationsComponent_li_38_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 15)(1, "a", 16);
    \u0275\u0275listener("click", function DonationsComponent_li_38_Template_a_click_1_listener() {
...
var DonationsComponent = class _DonationsComponent {
  constructor(fb, http) {
    this.fb = fb;
    this.http = http;
    this.users = [];
  ...
  static {
    this.\u0275fac = function DonationsComponent_Factory(t) {
      return new (t || _DonationsComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(HttpClient));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DonationsComponent, selectors: [["app-donations"]], viewQuery: function DonationsComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c0, 5);
      }
      if (rf & 2) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275template(31, DonationsComponent_tr_31_Template, 23, 10, "tr", 12);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(32, "div", 13)(33, "nav")(34, "ul", 14)(35, "li", 15)(36, "a", 16);
        \u0275\u0275listener("click", function DonationsComponent_Template_a_click_36_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goPrevious());
        });
        \u0275\u0275text(37, "\u2039");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(38, DonationsComponent_li_38_Template, 3, 3, "li", 17);
        \u0275\u0275elementStart(39, "li", 15)(40, "a", 16);
        \u0275\u0275listener("click", function DonationsComponent_Template_a_click_40_listener() {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275listener("change", function DonationsComponent_Template_select_change_43_listener($event) {
          \u0275\u0275restoreView(_r1);
