...
function PostComponent_div_12_div_8_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, PostComponent_div_12_div_8_ng_container_1_img_1_Template, 1, 1, "img", 31)(2, PostComponent_div_12_div_8_ng_container_1_video_2_Template, 1, 1, "video", 32);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function PostComponent_div_12_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, PostComponent_div_12_div_8_ng_container_1_Template, 3, 2, "ng-container", 30);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function PostComponent_div_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PostComponent_div_12_Template_div_click_17_listener() {
      ...
      return \u0275\u0275resetView(ctx_r2.toggleLike(ctx_r2.postData));
    });
    \u0275\u0275namespaceSVG();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275classProp("liked", ctx_r2.postData == null ? null : ctx_r2.postData.isLiked)("animate", ctx_r2.postData == null ? null : ctx_r2.postData.animate);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", ctx_r2.postData == null ? null : ctx_r2.postData.likes, " Likes");
  }
}
function PostComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 35)(1, "p", 35);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PostComponent, { className: "PostComponent", filePath: "src/app/website/pages/post/post.component.ts", lineNumber: 16 });
})();
export {
  PostComponent
};
//# sourceMappingURL=chunk-HRMHVGQE.mjs.map
