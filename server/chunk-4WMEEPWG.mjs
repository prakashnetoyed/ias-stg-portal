...
var routes = [
  ...
  },
  {
    ...
    canActivate: [authGuard],
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-AT3JRNKD.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
  ...
  },
  {
    ...
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-UJERHVDZ.mjs").then((m) => m.UserHomeComponent)
      },
      {
        path: "user-profile",
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-4WMEEPWG.mjs.map
