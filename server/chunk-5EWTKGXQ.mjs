...
} from "./chunk-VB2QR6D5.mjs";
import "./chunk-YGRMO6BY.mjs";
...
var _c1 = () => [];
function NotApprovedUserComponent_table_34_tr_22_a_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 54);
    \u0275\u0275listener("click", function NotApprovedUserComponent_table_34_tr_22_a_24_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const user_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.approveUser(user_r5));
    });
    \u0275\u0275namespaceSVG();
...
function NotApprovedUserComponent_table_34_tr_22_a_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 48);
    \u0275\u0275listener("click", function NotApprovedUserComponent_table_34_tr_22_a_26_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const user_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.rejectUser(user_r5));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 49)(2, "mask", 50);
    \u0275\u0275element(3, "rect", 51);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "g", 52);
    \u0275\u0275element(5, "path", 53);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(6, "Reject");
    \u0275\u0275elementEnd();
...
function NotApprovedUserComponent_table_34_tr_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td")(4, "input", 41);
    \u0275\u0275twoWayListener("ngModelChange", function NotApprovedUserComponent_table_34_tr_22_Template_input_ngModelChange_4_listener($event) {
      const user_r5 = \u0275\u0275restoreView(_r4).$implicit;
      \u0275\u0275twoWayBindingSet(user_r5.selected, $event) || (user_r5.selected = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("change", function NotApprovedUserComponent_table_34_tr_22_Template_input_change_4_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "td")(14, "span", 42);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "td");
    \u0275\u0275text(17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "td")(19, "div", 43)(20, "button", 44);
    \u0275\u0275text(21, " \u22EE ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "ul", 45)(23, "li");
    \u0275\u0275template(24, NotApprovedUserComponent_table_34_tr_22_a_24_Template, 4, 0, "a", 46);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "li");
    \u0275\u0275template(26, NotApprovedUserComponent_table_34_tr_22_a_26_Template, 7, 0, "a", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "li")(28, "a", 48);
    \u0275\u0275listener("click", function NotApprovedUserComponent_table_34_tr_22_Template_a_click_28_listener() {
      const user_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.openDeleteModal(user_r5.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(29, "svg", 49)(30, "mask", 50);
    \u0275\u0275element(31, "rect", 51);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "g", 52);
    \u0275\u0275element(33, "path", 53);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(34, " Deactivate account");
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
...
function NotApprovedUserComponent_table_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "table", 38)(1, "thead")(2, "tr")(3, "th");
    \u0275\u0275text(4, "S.no");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "th")(6, "input", 39);
    \u0275\u0275listener("change", function NotApprovedUserComponent_table_34_Template_input_change_6_listener($event) {
      \u0275\u0275restoreView(_r2);
    ...
    \u0275\u0275template(22, NotApprovedUserComponent_table_34_tr_22_Template, 35, 11, "tr", 40);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275property("checked", ctx_r2.allSelected);
    \u0275\u0275advance(16);
    \u0275\u0275property("ngForOf", ctx_r2.users);
  }
}
function NotApprovedUserComponent_ng_template_35_Template(rf, ctx) {
  if (rf & 1) {
...
function NotApprovedUserComponent_li_43_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 30)(1, "a", 31);
    \u0275\u0275listener("click", function NotApprovedUserComponent_li_43_Template_a_click_1_listener() {
      const i_r10 = \u0275\u0275restoreView(_r9).index;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.changePage(i_r10 + 1));
    });
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classProp("active", i_r10 + 1 === ctx_r2.currentPage);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(i_r10 + 1);
  }
}
var NotApprovedUserComponent = class _NotApprovedUserComponent {
  constructor(http) {
    this.http = http;
    this.users = [];
  ...
  loadUsers(page = 1, limit = this.pageSize) {
    ...
    let url = `${environment.apiUrl}/admin/users?limit=${limit}&page=${page}&isActive=true&role=user&status=created`;
    if (this.searchText?.trim()) {
      url += `&name=${encodeURIComponent(this.searchText.trim())}`;
    }
    this.http.get(url, { headers }).subscribe({
      next: (res) => {
        this.allApprovedUsers = res.data.data.filter((user) => user.status === this.AccountActivityStatus.CREATED);
  ...
  rejectUser(user) {
    ...
    this.http.put(`${environment.apiUrl}/admin/users&isActive=true`, body, { headers }).subscribe({
      next: () => {
  ...
  bulkApprove() {
    ...
    if (selectedUsers.length === 0) {
      this.showToast("No users selected for approval", "warning");
      return;
    }
    const token = localStorage.getItem("authToken");
    const headers = new HttpHeaders({ Authorization: `Bearer ${token}` });
    ...
    this.http.put(`${environment.apiUrl}/admin/users`, body, { headers }).subscribe({
      next: () => {
        this.showToast(`${selectedUsers.length} users approved successfully`, "success");
        this.loadUsers();
      },
      error: (err) => {
        console.error("Error bulk approving users:", err);
        this.showToast("Bulk approval failed", "danger");
      }
    });
  }
  ...
  static {
    this.\u0275fac = function NotApprovedUserComponent_Factory(t) {
      return new (t || _NotApprovedUserComponent)(\u0275\u0275directiveInject(HttpClient));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NotApprovedUserComponent, selectors: [["app-not-approved-user"]], viewQuery: function NotApprovedUserComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c0, 5);
      }
      if (rf & 2) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275listener("click", function NotApprovedUserComponent_Template_button_click_19_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.confirmDelete());
        });
        \u0275\u0275text(20, "Deactivate");
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(21, "div", 17)(22, "div", 18)(23, "h5");
        \u0275\u0275text(24, "Pending For Approval");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(25, "div", 19)(26, "div", 20)(27, "span", 21);
        \u0275\u0275namespaceSVG();
        ...
        \u0275\u0275twoWayListener("ngModelChange", function NotApprovedUserComponent_Template_input_ngModelChange_30_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.searchText, $event) || (ctx.searchText = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275listener("keyup", function NotApprovedUserComponent_Template_input_keyup_30_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onSearchKeyup());
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(31, "button", 25);
        \u0275\u0275listener("click", function NotApprovedUserComponent_Template_button_click_31_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.bulkApprove());
        });
        \u0275\u0275text(32, " Bulk Approve ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(33, "div", 26);
        \u0275\u0275template(34, NotApprovedUserComponent_table_34_Template, 23, 2, "table", 27);
        \u0275\u0275elementEnd();
        \u0275\u0275template(35, NotApprovedUserComponent_ng_template_35_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementStart(37, "div", 28)(38, "nav")(39, "ul", 29)(40, "li", 30)(41, "a", 31);
        \u0275\u0275listener("click", function NotApprovedUserComponent_Template_a_click_41_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goPrevious());
        });
        \u0275\u0275text(42, "\u2039");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(43, NotApprovedUserComponent_li_43_Template, 3, 3, "li", 32);
        \u0275\u0275elementStart(44, "li", 30)(45, "a", 31);
        \u0275\u0275listener("click", function NotApprovedUserComponent_Template_a_click_45_listener() {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275listener("change", function NotApprovedUserComponent_Template_select_change_48_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onPageSizeChange($event));
        });
        \u0275\u0275elementStart(49, "option", 35);
        \u0275\u0275text(50, "5 /Page");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(51, "option", 36);
        \u0275\u0275text(52, "10 /Page");
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        const noUsers_r11 = \u0275\u0275reference(36);
        \u0275\u0275advance();
        ...
        \u0275\u0275advance();
        \u0275\u0275property("disabled", !ctx.hasSelectedUsers());
        \u0275\u0275advance(3);
        \u0275\u0275property("ngIf", ctx.users && ctx.users.length)("ngIfElse", noUsers_r11);
        \u0275\u0275advance(6);
