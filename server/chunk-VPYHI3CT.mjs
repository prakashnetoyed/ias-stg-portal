...
var _c1 = ["errorToast"];
function ProfileInfoComponent_image_cropper_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "image-cropper", 24);
    \u0275\u0275listener("imageCropped", function ProfileInfoComponent_image_cropper_23_Template_image_cropper_imageCropped_0_listener($event) {
      \u0275\u0275restoreView(_r2);
...
function ProfileInfoComponent_div_25_Template(rf, ctx) {
  if (rf & 1) {
...
function ProfileInfoComponent_div_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 25)(1, "p", 26);
...
function ProfileInfoComponent_div_34__svg_svg_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 66)(1, "g", 67);
    \u0275\u0275element(2, "path", 68);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "defs")(4, "clipPath", 69);
    \u0275\u0275element(5, "rect", 70);
    \u0275\u0275elementEnd()()();
  }
}
function ProfileInfoComponent_div_34__svg_svg_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 66)(1, "g", 71);
    \u0275\u0275element(2, "path", 72);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "defs")(4, "clipPath", 73);
    \u0275\u0275element(5, "rect", 70);
    \u0275\u0275elementEnd()()();
  }
}
function ProfileInfoComponent_div_34_div_23_span_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ProfileInfoComponent_div_34_div_23_span_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function ProfileInfoComponent_div_34_div_23_span_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function ProfileInfoComponent_div_34_div_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 74);
    \u0275\u0275template(1, ProfileInfoComponent_div_34_div_23_span_1_Template, 2, 0, "span", 75)(2, ProfileInfoComponent_div_34_div_23_span_2_Template, 2, 0, "span", 75)(3, ProfileInfoComponent_div_34_div_23_span_3_Template, 2, 0, "span", 75);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
...
function ProfileInfoComponent_div_34__svg_svg_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 66)(1, "g", 67);
    \u0275\u0275element(2, "path", 68);
...
function ProfileInfoComponent_div_34__svg_svg_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 66)(1, "g", 71);
    \u0275\u0275element(2, "path", 72);
...
function ProfileInfoComponent_div_34_div_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 74);
...
function ProfileInfoComponent_div_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngSubmit", function ProfileInfoComponent_div_34_Template_form_ngSubmit_13_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ProfileInfoComponent_div_34_Template_button_click_20_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.toggleNewPassword());
    });
    \u0275\u0275template(21, ProfileInfoComponent_div_34__svg_svg_21_Template, 6, 0, "svg", 45)(22, ProfileInfoComponent_div_34__svg_svg_22_Template, 6, 0, "svg", 45);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(23, ProfileInfoComponent_div_34_div_23_Template, 4, 3, "div", 46);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ProfileInfoComponent_div_34_Template_button_click_29_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.toggleConfirmPassword());
    });
    \u0275\u0275template(30, ProfileInfoComponent_div_34__svg_svg_30_Template, 6, 0, "svg", 45)(31, ProfileInfoComponent_div_34__svg_svg_31_Template, 6, 0, "svg", 45);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(32, ProfileInfoComponent_div_34_div_32_Template, 2, 0, "div", 46);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ProfileInfoComponent_div_34_Template_button_click_47_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
...
var ProfileInfoComponent = class _ProfileInfoComponent {
  ...
  // ===== Toast helpers =====
  showSuccessToast() {
    new bootstrap.Toast(this.successToast.nativeElement).show();
  }
  showErrorToast() {
    new bootstrap.Toast(this.errorToast.nativeElement).show();
  }
  // ===== Password change =====
  onSubmit() {
    ...
    this.http.post(`${environment.apiUrl}/accounts/setup-password`, { password: newPassword, confirmPassword }, { headers }).subscribe({
      next: () => {
  ...
  static {
    this.\u0275fac = function ProfileInfoComponent_Factory(t) {
      return new (t || _ProfileInfoComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(UserService), \u0275\u0275directiveInject(HttpClient), \u0275\u0275directiveInject(ToastService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProfileInfoComponent, selectors: [["app-profile-info"]], viewQuery: function ProfileInfoComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c0, 7);
        \u0275\u0275viewQuery(_c1, 7);
      }
      ...
      if (rf & 1) {
        ...
        \u0275\u0275listener("change", function ProfileInfoComponent_Template_input_change_22_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onFileChange($event));
        });
        \u0275\u0275elementEnd();
        \u0275\u0275template(23, ProfileInfoComponent_image_cropper_23_Template, 1, 6, "image-cropper", 16);
        \u0275\u0275elementStart(24, "div", 17);
        \u0275\u0275template(25, ProfileInfoComponent_div_25_Template, 4, 1, "div", 18)(26, ProfileInfoComponent_div_26_Template, 4, 1, "div", 18);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(27, "div", 19)(28, "button", 20);
        \u0275\u0275text(29, "Cancel");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(30, "button", 21);
        \u0275\u0275listener("click", function ProfileInfoComponent_Template_button_click_30_listener() {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275listener("click", function ProfileInfoComponent_Template_button_click_32_listener() {
          \u0275\u0275restoreView(_r1);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProfileInfoComponent, { className: "ProfileInfoComponent", filePath: "src/app/IAS-portal/pages/profile-info/profile-info.component.ts", lineNumber: 22 });
})();
export {
  ProfileInfoComponent
};
//# sourceMappingURL=chunk-VPYHI3CT.mjs.map
