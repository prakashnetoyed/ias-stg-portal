...
var _c0 = ["errorToast"];
var _c1 = () => [];
function MoMComponent_div_62_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function MoMComponent_div_62_Template_i_click_5_listener() {
      \u0275\u0275restoreView(_r2);
...
function MoMComponent_table_69_tr_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(8, "td");
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(9, "svg", 62)(10, "mask", 63);
    \u0275\u0275element(11, "rect", 64);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "g", 65);
    \u0275\u0275element(13, "path", 66);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(14, "td")(15, "div", 67)(16, "button", 68);
    \u0275\u0275text(17, " \u22EE ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "ul", 69)(19, "li")(20, "a", 70);
    \u0275\u0275listener("click", function MoMComponent_table_69_tr_14_Template_a_click_20_listener() {
      const user_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.deleteNews(user_r5.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(21, "svg", 71)(22, "mask", 72);
    \u0275\u0275element(23, "rect", 73);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "g", 74);
    \u0275\u0275element(25, "path", 75);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(26, " Delete ");
    \u0275\u0275elementEnd()()()()()();
  }
...
function MoMComponent_table_69_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(14, MoMComponent_table_69_tr_14_Template, 27, 6, "tr", 61);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function MoMComponent_ng_template_70_Template(rf, ctx) {
  if (rf & 1) {
...
function MoMComponent_li_78_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 48)(1, "a", 49);
    \u0275\u0275listener("click", function MoMComponent_li_78_Template_a_click_1_listener() {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MoMComponent, selectors: [["app-mo-m"]], viewQuery: function MoMComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275text(17, "Minutes of Meeting");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(18, "div", 17)(19, "button", 18);
        \u0275\u0275text(20, " Add Minutes of Meeting ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(21, "div", 19)(22, "div", 20)(23, "h5", 21);
        \u0275\u0275text(24, "Add Minutes of Meeting");
        \u0275\u0275elementEnd();
        \u0275\u0275element(25, "button", 22);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(26, "div", 23)(27, "form", 24);
        \u0275\u0275listener("ngSubmit", function MoMComponent_Template_form_ngSubmit_27_listener() {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275listener("change", function MoMComponent_Template_input_change_61_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onFileSelected($event));
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275template(62, MoMComponent_div_62_Template, 6, 0, "div", 40);
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275template(69, MoMComponent_table_69_Template, 15, 1, "table", 45);
        \u0275\u0275elementEnd();
        \u0275\u0275template(70, MoMComponent_ng_template_70_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementStart(72, "div", 46)(73, "nav")(74, "ul", 47)(75, "li", 48)(76, "a", 49);
        \u0275\u0275listener("click", function MoMComponent_Template_a_click_76_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goPrevious());
        });
        \u0275\u0275text(77, "\u2039");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(78, MoMComponent_li_78_Template, 3, 3, "li", 50);
        \u0275\u0275elementStart(79, "li", 48)(80, "a", 49);
        \u0275\u0275listener("click", function MoMComponent_Template_a_click_80_listener() {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275listener("change", function MoMComponent_Template_select_change_83_listener($event) {
          \u0275\u0275restoreView(_r1);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MoMComponent, { className: "MoMComponent", filePath: "src/app/IAS-portal/pages/mo-m/mo-m.component.ts", lineNumber: 15 });
})();
export {
  MoMComponent
};
//# sourceMappingURL=chunk-V6HF7EIT.mjs.map
