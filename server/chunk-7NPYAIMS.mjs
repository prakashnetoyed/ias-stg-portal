...
function UserEventsComponent_div_4_div_1_button_19_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 19);
    \u0275\u0275listener("click", function UserEventsComponent_div_4_div_1_button_19_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
...
function UserEventsComponent_div_4_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(19, UserEventsComponent_div_4_div_1_button_19_Template, 2, 0, "button", 18);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function UserEventsComponent_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, UserEventsComponent_div_4_div_1_Template, 20, 12, "div", 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var UserEventsComponent = class _UserEventsComponent {
  ...
  loadEvents() {
    this.http.get(`${environment.apiUrl}/events?isActive=true&limit=0`).subscribe({
      next: (res) => {
...
//# sourceMappingURL=chunk-7NPYAIMS.mjs.map
