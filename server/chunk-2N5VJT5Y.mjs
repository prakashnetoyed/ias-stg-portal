  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _IasHeaderComponent, selectors: [["app-ias-header"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 53, vars: 31, consts: [["initials", ""], ["userMenu", ""], [1, "main-ncs-header-div"], [1, "container", "d-flex", "align-items-center", "justify-content-between"], [1, "logo-div", 2, "cursor", "pointer", 3, "routerLink"], ["src", "../../../assets/logo/ias-small-logo.png", "alt", "ias-logo", "draggable", "false"], [1, "navigationmenu", "d-flex", "align-items-center"], [1, "navbar", "navbar-expand-lg"], [1, "container-fluid"], ["type", "button", "data-bs-toggle", "offcanvas", "data-bs-target", "#offcanvasNavbar", "aria-controls", "offcanvasNavbar", 1, "navbar-toggler"], [1, "navbar-toggler-icon"], ["id", "navbarNavAltMarkup", 1, "collapse", "navbar-collapse", "d-none", "d-lg-flex"], [1, "navbar-nav", "ms-auto"], ["routerLinkActive", "active-link", 1, "nav-link", 3, "routerLink", "routerLinkActiveOptions"], [1, "nav-item", "dropdown"], ["data-bs-toggle", "dropdown", "aria-expanded", "false", "id", "dropdownMenuButton", 1, "d-flex", "align-items-center", "text-decoration-none", "nav-link"], [1, "me-2"], [1, "arrow-icon"], ["xmlns", "http://www.w3.org/2000/svg", "width", "14", "height", "10", "fill", "none"], ["d", "M12.6 0.8L14 2.2 7 9.2 0 2.2 1.4 0.8 7 6.375 12.6 0.8Z", "fill", "#222"], ["aria-labelledby", "dropdownMenuButton", 1, "dropdown-menu", "dropdown-menu-dark"], [1, "dropdown-item", 3, "routerLink"], ["tabindex", "-1", "id", "offcanvasNavbar", "aria-labelledby", "offcanvasNavbarLabel", 1, "offcanvas", "offcanvas-start", "d-lg-none"], [1, "offcanvas-header"], ["id", "offcanvasNavbarLabel", 1, "offcanvas-title"], ["type", "button", "data-bs-dismiss", "offcanvas", "aria-label", "Close", 1, "btn-close", "text-reset"], [1, "offcanvas-body"], [1, "navbar-nav"], ["routerLinkActive", "active-link", "data-bs-dismiss", "offcanvas", 1, "nav-link", 3, "routerLink", "routerLinkActiveOptions"], [4, "ngIf"], ["class", "dropdown", 4, "ngIf"], [1, "dropdown"], ["type", "button", "id", "profileDropdown", "data-bs-toggle", "dropdown", "aria-expanded", "false", 1, "btn", "dropdown-toggle", "user-profile", "d-flex", "align-items-center", "p-0"], [1, "avatar"], [4, "ngIf", "ngIfElse"], ["aria-labelledby", "profileDropdown", 1, "dropdown-menu", "dropdown-menu-end"], [1, "dropdown-divider"], [1, "dropdown-item", "text-danger", 2, "cursor", "pointer", 3, "click"], ["alt", "User Avatar", 3, "src"], [1, "btn", "btn-prime", 3, "routerLink"]], template: function IasHeaderComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(13);
        \u0275\u0275property("routerLink", "/about-us")("routerLinkActiveOptions", \u0275\u0275pureFunction0(22, _c02));
        \u0275\u0275advance(2);
        ...
        \u0275\u0275advance(9);
        \u0275\u0275property("routerLink", "/about-us")("routerLinkActiveOptions", \u0275\u0275pureFunction0(26, _c02));
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", "membership")("routerLinkActiveOptions", \u0275\u0275pureFunction0(27, _c02));
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", "community")("routerLinkActiveOptions", \u0275\u0275pureFunction0(28, _c02));
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", "news-blogs")("routerLinkActiveOptions", \u0275\u0275pureFunction0(29, _c02));
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", "/contact-us")("routerLinkActiveOptions", \u0275\u0275pureFunction0(30, _c02));
        \u0275\u0275advance(2);
...
var routes = [
    ...
    children: [
      {
        ...
        loadComponent: () => import("./chunk-XUVMGBU6.mjs").then((m) => m.IasHomepageComponent)
      },
      {
        path: "about-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-BXUXDKAU.mjs").then((m) => m.IasAboutusComponent)
      },
      {
        path: "contact-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-RG6JXH5J.mjs").then((m) => m.IasContactusComponent)
      },
      {
        path: "community",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-D43ULNZB.mjs").then((m) => m.IasCommunityComponent)
      },
      {
        path: "post",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-SJDJWLQ7.mjs").then((m) => m.PostComponent)
      },
      {
        path: "caruna",
        loadComponent: () => import("./chunk-243BGJUD.mjs").then((m) => m.IasCarunaComponent)
      },
      {
        path: "all-members",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-PEQ6U7M7.mjs").then((m) => m.AllMembersComponent)
      },
      {
        path: "news-blogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-3EEHKWML.mjs").then((m) => m.NewsBlogsComponent)
      },
      {
        path: "caruna",
        // component:IasHomepageComponent,
      ...
      },
      {
        ...
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-ZKHGNBNN.mjs").then((m) => m.WelfareMembershipComponent)
      },
      {
        path: "lifetime-membership",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-37IMLYZT.mjs").then((m) => m.LifetimeMembershipComponent)
      },
      {
        path: "readmorenews",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-B6ITF6IP.mjs").then((m) => m.ReadmoreNewsComponent)
      },
      {
        path: "readmoreblogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-SVN7DADV.mjs").then((m) => m.ReadmoreBlogsComponent)
      },
      {
        path: "membership",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-SKSOTQFK.mjs").then((m) => m.CombinedMemberPageComponent)
      },
      {
        path: "Terms-Conditions",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-XYCASXGS.mjs").then((m) => m.TermsConditionsComponent)
      },
      {
        path: "Refund-Cancellation-Policy",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-DZHGNWKJ.mjs").then((m) => m.RefundCancellationPolicyComponent)
      },
      {
        path: "Privacy-Policy",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-4YJJ4DDU.mjs").then((m) => m.PrivacyPolicyComponent)
      }
    ]
  },
  {
  ...
  },
  {
    ...
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-LUDGL2WV.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-BDAUJDDU.mjs").then((m) => m.DashboardComponent)
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-Q6T4GX5E.mjs").then((m) => m.ProfileInfoComponent)
      },
      {
        path: "publications",
        loadComponent: () => import("./chunk-ABDXU5HQ.mjs").then((m) => m.PublicationsComponent)
      },
      {
        path: "blogs",
        loadComponent: () => import("./chunk-4C3CI6L5.mjs").then((m) => m.BlogsComponent)
      },
      {
        path: "news",
        loadComponent: () => import("./chunk-C6VF4P4A.mjs").then((m) => m.NewsComponent)
      },
      {
        path: "feedbacks",
        loadComponent: () => import("./chunk-BD2RXLG6.mjs").then((m) => m.FeedbacksComponent)
      },
      {
        path: "my-transaction",
        loadComponent: () => import("./chunk-DJRYMLSZ.mjs").then((m) => m.MyTransactionComponent)
      },
      {
        path: "approved-user",
        loadComponent: () => import("./chunk-5HITDF4F.mjs").then((m) => m.ApprovedUserComponent)
      },
      {
        path: "pending-approval-user",
        loadComponent: () => import("./chunk-LSY275RY.mjs").then((m) => m.NotApprovedUserComponent)
      },
      {
        path: "rejected-user",
        loadComponent: () => import("./chunk-GNJBDBLP.mjs").then((m) => m.RejectedUsersComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-N24P2Y2A.mjs").then((m) => m.UserDashboardComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-5TMI4CZP.mjs").then((m) => m.UserHomeComponent)
      },
      {
        path: "user-profile",
        loadComponent: () => import("./chunk-IEI4WLQ5.mjs").then((m) => m.UserProfileComponent)
      },
      {
        path: "user-events",
        loadComponent: () => import("./chunk-W5AAQNJN.mjs").then((m) => m.UserEventsComponent)
      },
      {
        path: "user-membership",
        loadComponent: () => import("./chunk-4C32ZGFZ.mjs").then((m) => m.UserMembershipComponent)
      },
      {
        path: "user-members",
        loadComponent: () => import("./chunk-TIICOVRL.mjs").then((m) => m.UserMembersComponent)
      },
      {
        path: "user-transactions",
        loadComponent: () => import("./chunk-CAV6T4FA.mjs").then((m) => m.MyTransactionsComponent)
      },
      {
        path: "payment-status",
        loadComponent: () => import("./chunk-XQ7GY765.mjs").then((m) => m.PaymentStatusComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-2PYT24QS.mjs").then((m) => m.UserNotApprovedLayoutComponent)
  },
  {
    path: "**",
    // wildcard → catch all unknown routes
    loadComponent: () => import("./chunk-HN2PVTZE.mjs").then((m) => m.RouteErrorComponent)
  }
];
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const moduleImpl = this.moduleImpl ?? import("./chunk-AY4FKLY6.mjs");
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-2N5VJT5Y.mjs.map
