...
function DashboardComponent_table_96_tr_24_a_28_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 81);
    \u0275\u0275listener("click", function DashboardComponent_table_96_tr_24_a_28_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r5);
...
function DashboardComponent_table_96_tr_24_a_30_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 75);
    \u0275\u0275listener("click", function DashboardComponent_table_96_tr_24_a_30_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const user_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r6 = \u0275\u0275nextContext(2);
...
function DashboardComponent_table_96_tr_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "td")(23, "div", 70)(24, "button", 71);
    \u0275\u0275text(25, " \u22EE ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "ul", 72)(27, "li");
    \u0275\u0275template(28, DashboardComponent_table_96_tr_24_a_28_Template, 4, 0, "a", 73);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "li");
    \u0275\u0275template(30, DashboardComponent_table_96_tr_24_a_30_Template, 7, 0, "a", 74);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "li")(32, "a", 75);
    \u0275\u0275listener("click", function DashboardComponent_table_96_tr_24_Template_a_click_32_listener() {
      const user_r6 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r6 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r6.openDeleteModal(user_r6.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(33, "svg", 76)(34, "mask", 77);
    \u0275\u0275element(35, "rect", 78);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "g", 79);
    \u0275\u0275element(37, "path", 80);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(38, " Deactivate account");
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", user_r6.memberShipStartedAt ? \u0275\u0275pipeBind2(19, 13, user_r6.memberShipStartedAt, "dd-MM-yyyy") : "N/A", "\n");
    \u0275\u0275advance(3);
...
function DashboardComponent_table_96_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(24, DashboardComponent_table_96_tr_24_Template, 39, 16, "tr", 68);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
//# sourceMappingURL=chunk-CCZ62KNE.mjs.map
