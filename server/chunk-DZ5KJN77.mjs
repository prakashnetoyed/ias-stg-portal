  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserSidebarComponent, selectors: [["app-user-sidebar"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 61, vars: 17, consts: [[1, "main-side-bar-component", "d-flex", "flex-column", "justify-content-between"], [1, "top-div"], ["data-bs-toggle", "tooltip", "title", "Click to go Home", 1, "left-logo-div", "d-flex", "align-items-center", "gap-2", "mb-4", 3, "click"], ["src", "../../../assets/logo/ias-small-logo.png", "alt", "epfo-logo", 1, "ll"], [1, "epfo-name-text", "w-100"], [1, "epfo-text", "w-100"], [1, "navigation-div", "mt-2"], [1, "p-0"], ["routerLinkActive", "active", "data-bs-dismiss", "offcanvas", "aria-label", "Close", 1, "d-flex", "align-items-center", "gap-2", "nav-option", 3, "routerLink", "routerLinkActiveOptions"], ["xmlns", "http://www.w3.org/2000/svg", "width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", 1, "dash"], ["d", "M10 3H3V10H10V3Z", "stroke", "#211B3A", "stroke-width", "1.5", "stroke-linecap", "round", "stroke-linejoin", "round"], ["d", "M21 3H14V10H21V3Z", "stroke", "#211B3A", "stroke-width", "1.5", "stroke-linecap", "round", "stroke-linejoin", "round"], ["d", "M21 14H14V21H21V14Z", "stroke", "#211B3A", "stroke-width", "1.5", "stroke-linecap", "round", "stroke-linejoin", "round"], ["d", "M10 14H3V21H10V14Z", "stroke", "#211B3A", "stroke-width", "1.5", "stroke-linecap", "round", "stroke-linejoin", "round"], [1, "navigation-text"], ["routerLinkActive", "active", "data-bs-dismiss", "offcanvas", "aria-label", "Close", 1, "d-flex", "align-items-center", "gap-2", "mt-2", "nav-option", 3, "routerLink", "routerLinkActiveOptions"], ["xmlns", "http://www.w3.org/2000/svg", "width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", 1, "nav-svg"], ["clip-path", "url(#clip0_50872_3818)"], ["d", "M12 5.9C13.16 5.9 14.1 6.84 14.1 8C14.1 9.16 13.16 10.1 12 10.1C10.84 10.1 9.9 9.16 9.9 8C9.9 6.84 10.84 5.9 12 5.9ZM12 14.9C14.97 14.9 18.1 16.36 18.1 17V18.1H5.9V17C5.9 16.36 9.03 14.9 12 14.9ZM12 4C9.79 4 8 5.79 8 8C8 10.21 9.79 12 12 12C14.21 12 16 10.21 16 8C16 5.79 14.21 4 12 4ZM12 13C9.33 13 4 14.34 4 17V20H20V17C20 14.34 14.67 13 12 13Z", "fill", "#211B3A"], ["id", "clip0_50872_3818"], ["width", "24", "height", "24", "fill", "white"], ["id", "mask0_50872_3825", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "24", "height", "24", 2, "mask-type", "alpha"], ["width", "24", "height", "24", "fill", "#D9D9D9"], ["mask", "url(#mask0_50872_3825)"], ["d", "M5 19V5V9.475V9V19ZM7 13H12.525C12.5583 12.6333 12.6417 12.2833 12.775 11.95C12.9083 11.6167 13.075 11.3 13.275 11H7V13ZM7 17H10.925C11.2083 16.6667 11.5333 16.3958 11.9 16.1875C12.2667 15.9792 12.65 15.8083 13.05 15.675C12.9833 15.575 12.925 15.4667 12.875 15.35C12.825 15.2333 12.7833 15.1167 12.75 15H7V17ZM7 9H17V7H7V9ZM5 21C4.45 21 3.97917 20.8042 3.5875 20.4125C3.19583 20.0208 3 19.55 3 19V5C3 4.45 3.19583 3.97917 3.5875 3.5875C3.97917 3.19583 4.45 3 5 3H19C19.55 3 20.0208 3.19583 20.4125 3.5875C20.8042 3.97917 21 4.45 21 5V11.45C20.7667 11.0167 20.4833 10.6333 20.15 10.3C19.8167 9.96667 19.4333 9.69167 19 9.475V5H5V19H10.05C10.0333 19.1 10.0208 19.2 10.0125 19.3C10.0042 19.4 10 19.5 10 19.6V21H5ZM17 16C16.3 16 15.7083 15.7583 15.225 15.275C14.7417 14.7917 14.5 14.2 14.5 13.5C14.5 12.8 14.7417 12.2083 15.225 11.725C15.7083 11.2417 16.3 11 17 11C17.7 11 18.2917 11.2417 18.775 11.725C19.2583 12.2083 19.5 12.8 19.5 13.5C19.5 14.2 19.2583 14.7917 18.775 15.275C18.2917 15.7583 17.7 16 17 16ZM12 21V19.6C12 19.2 12.1042 18.8292 12.3125 18.4875C12.5208 18.1458 12.8167 17.9 13.2 17.75C13.8 17.5 14.4208 17.3125 15.0625 17.1875C15.7042 17.0625 16.35 17 17 17C17.65 17 18.2958 17.0625 18.9375 17.1875C19.5792 17.3125 20.2 17.5 20.8 17.75C21.1833 17.9 21.4792 18.1458 21.6875 18.4875C21.8958 18.8292 22 19.2 22 19.6V21H12Z", "fill", "#211B3A"], ["clip-path", "url(#clip0_50872_3834)"], ["d", "M4 6H2V20C2 21.1 2.9 22 4 22H18V20H4V6ZM20 2H8C6.9 2 6 2.9 6 4V16C6 17.1 6.9 18 8 18H20C21.1 18 22 17.1 22 16V4C22 2.9 21.1 2 20 2ZM20 16H8V4H20V16ZM10 9H18V11H10V9ZM10 12H14V14H10V12ZM10 6H18V8H10V6Z", "fill", "#211B3A"], ["id", "clip0_50872_3834"], ["routerLink", "my-donation", "routerLinkActive", "active", "data-bs-dismiss", "offcanvas", "aria-label", "Close", 1, "d-flex", "align-items-center", "gap-2", "mt-2", "nav-option", 3, "routerLinkActiveOptions"], ["id", "mask0_50872_3868", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "24", "height", "24", 2, "mask-type", "alpha"], ["mask", "url(#mask0_50872_3868)"], ["d", "M17.275 20.25L20.75 16.8L19.7 15.75L17.275 18.125L16.3 17.15L15.25 18.225L17.275 20.25ZM6 9H18V7H6V9ZM18 23C16.6167 23 15.4375 22.5125 14.4625 21.5375C13.4875 20.5625 13 19.3833 13 18C13 16.6167 13.4875 15.4375 14.4625 14.4625C15.4375 13.4875 16.6167 13 18 13C19.3833 13 20.5625 13.4875 21.5375 14.4625C22.5125 15.4375 23 16.6167 23 18C23 19.3833 22.5125 20.5625 21.5375 21.5375C20.5625 22.5125 19.3833 23 18 23ZM3 22V5C3 4.45 3.19583 3.97917 3.5875 3.5875C3.97917 3.19583 4.45 3 5 3H19C19.55 3 20.0208 3.19583 20.4125 3.5875C20.8042 3.97917 21 4.45 21 5V11.675C20.6833 11.525 20.3583 11.4 20.025 11.3C19.6917 11.2 19.35 11.125 19 11.075V5H5V19.05H11.075C11.1583 19.5667 11.2875 20.0583 11.4625 20.525C11.6375 20.9917 11.8667 21.4333 12.15 21.85L12 22L10.5 20.5L9 22L7.5 20.5L6 22L4.5 20.5L3 22ZM6 17H11.075C11.125 16.65 11.2 16.3083 11.3 15.975C11.4 15.6417 11.525 15.3167 11.675 15H6V17ZM6 13H13.1C13.7333 12.3833 14.4708 11.8958 15.3125 11.5375C16.1542 11.1792 17.05 11 18 11H6V13Z", "fill", "#211B3A"]], template: function UserSidebarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(45, "li", 28);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(46, "svg", 16)(47, "mask", 29);
        \u0275\u0275element(48, "rect", 22);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(49, "g", 30);
        \u0275\u0275element(50, "path", 31);
        \u0275\u0275elementEnd()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(51, "h1", 14);
        \u0275\u0275text(52, "My Donations");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(53, "li", 15);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(54, "svg", 16)(55, "mask", 29);
        \u0275\u0275element(56, "rect", 22);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(57, "g", 30);
        \u0275\u0275element(58, "path", 31);
        \u0275\u0275elementEnd()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(59, "h1", 14);
        \u0275\u0275text(60, "My Transactions");
        \u0275\u0275elementEnd()()()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(11);
        \u0275\u0275property("routerLink", "/user-home")("routerLinkActiveOptions", \u0275\u0275pureFunction0(11, _c0));
        \u0275\u0275advance(8);
        \u0275\u0275property("routerLink", "user-events")("routerLinkActiveOptions", \u0275\u0275pureFunction0(12, _c0));
        \u0275\u0275advance(9);
        \u0275\u0275property("routerLink", "user-membership")("routerLinkActiveOptions", \u0275\u0275pureFunction0(13, _c0));
        \u0275\u0275advance(8);
        \u0275\u0275property("routerLink", "user-members")("routerLinkActiveOptions", \u0275\u0275pureFunction0(14, _c0));
        \u0275\u0275advance(9);
        \u0275\u0275property("routerLinkActiveOptions", \u0275\u0275pureFunction0(15, _c0));
        \u0275\u0275advance(8);
        \u0275\u0275property("routerLink", "user-transactions")("routerLinkActiveOptions", \u0275\u0275pureFunction0(16, _c0));
      }
...
function UserHeaderComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
...
function UserHeaderComponent_ng_container_16_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
...
function UserHeaderComponent_ng_container_16_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
...
function UserHeaderComponent_ng_container_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, UserHeaderComponent_ng_container_16_ng_container_1_Template, 2, 1, "ng-container", 23)(2, UserHeaderComponent_ng_container_16_ng_template_2_Template, 1, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
var UserHeaderComponent = class _UserHeaderComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserHeaderComponent, selectors: [["app-user-header"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 29, vars: 4, consts: [["toastContainer", ""], ["initialsBlock", ""], [1, "position-fixed", "top-0", "end-0", "p-3", 2, "z-index", "1100"], ["tabindex", "-1", "id", "sidebar", "aria-labelledby", "sidebarLabel", 1, "offcanvas", "offcanvas-start"], [1, "offcanvas-header"], ["id", "sidebarLabel"], ["type", "button", "data-bs-dismiss", "offcanvas", "aria-label", "Close", 1, "btn-close", "text-reset"], [1, "offcanvas-body"], [1, "main-epfo-header"], [1, "right-side", "d-flex", "align-items-center", "gap-3"], ["data-bs-toggle", "offcanvas", "data-bs-target", "#sidebar", 1, "btn", "btn-donate"], [1, "dropdown"], ["type", "button", "id", "profileDropdown", "data-bs-toggle", "dropdown", "aria-expanded", "false", 1, "btn", "dropdown-toggle", "user-profile", "d-flex", "align-items-center"], ["class", "user-info text-end me-2", 4, "ngIf"], [1, "avatar"], [4, "ngIf"], ["aria-labelledby", "profileDropdown", 1, "dropdown-menu", "dropdown-menu-end"], [1, "dropdown-item", 3, "routerLink"], [1, "dropdown-divider"], [1, "dropdown-item", "text-danger", 2, "cursor", "pointer", 3, "click"], [1, "user-info", "text-end", "me-2"], [1, "name"], [1, "role"], [4, "ngIf", "ngIfElse"], ["alt", "Avatar", "draggable", "false", 3, "src"]], template: function UserHeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(7, "app-user-sidebar");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(8, "div", 8)(9, "div", 9)(10, "button", 10);
        \u0275\u0275text(11, "Sidebar");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(12, "div", 11)(13, "button", 12);
        \u0275\u0275template(14, UserHeaderComponent_div_14_Template, 5, 2, "div", 13);
        \u0275\u0275elementStart(15, "div", 14);
        \u0275\u0275template(16, UserHeaderComponent_ng_container_16_Template, 4, 2, "ng-container", 15);
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275listener("click", function UserHeaderComponent_Template_a_click_27_listener() {
          \u0275\u0275restoreView(_r1);
...
//# sourceMappingURL=chunk-DZ5KJN77.mjs.map
