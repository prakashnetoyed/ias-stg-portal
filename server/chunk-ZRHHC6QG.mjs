...
function MyTransactionsComponent_tbody_20_tr_1_span_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "Annual Membership");
    \u0275\u0275elementEnd();
  }
}
function MyTransactionsComponent_tbody_20_tr_1_span_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "Tenure Membership");
    \u0275\u0275elementEnd();
  }
}
function MyTransactionsComponent_tbody_20_tr_1_span_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "Lifetime Membership");
    \u0275\u0275elementEnd();
  }
}
function MyTransactionsComponent_tbody_20_tr_1_span_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function MyTransactionsComponent_tbody_20_tr_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(4, MyTransactionsComponent_tbody_20_tr_1_span_4_Template, 2, 0, "span", 11)(5, MyTransactionsComponent_tbody_20_tr_1_span_5_Template, 2, 0, "span", 11)(6, MyTransactionsComponent_tbody_20_tr_1_span_6_Template, 2, 0, "span", 11)(7, MyTransactionsComponent_tbody_20_tr_1_span_7_Template, 2, 0, "span", 12);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "td", 5)(16, "p", 14);
    \u0275\u0275listener("click", function MyTransactionsComponent_tbody_20_tr_1_Template_p_click_16_listener() {
      const tx_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.downloadReceipt(tx_r2));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(17, "svg", 15)(18, "mask", 16);
    \u0275\u0275element(19, "rect", 17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "g", 18);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitch", tx_r2 == null ? null : tx_r2.amount);
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitchCase", "200.00");
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitchCase", "1000.00");
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitchCase", "500.00");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(9, _c0, tx_r2.transaction_status == "200", tx_r2.transaction_status != "200"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", tx_r2 == null ? null : tx_r2.transaction_payment_status, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Rs ", tx_r2 == null ? null : tx_r2.amount, "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(tx_r2 == null ? null : tx_r2.transaction_time);
  }
}
function MyTransactionsComponent_tbody_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tbody", 8);
    \u0275\u0275template(1, MyTransactionsComponent_tbody_20_tr_1_Template, 22, 12, "tr", 9);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var MyTransactionsComponent = class _MyTransactionsComponent {
  ...
  mytransactions() {
    this.http.get(`${environment.apiUrl}/airpay/transactions?limit=0`).subscribe({
      next: (res) => {
        console.log(res);
  ...
  downloadReceipt(tx) {
    ...
    doc.setFontSize(10);
    doc.text(`${tx?.customer_name || "N/A"}`, 14, 45);
    doc.text(`${tx?.customer_email || "N/A"}`, 14, 51);
    doc.text(`${tx?.customer_phone || "N/A"}`, 14, 57);
    const startX = 120;
    doc.setFontSize(10);
    doc.text(`Order ID: ${tx?.orderid || "N/A"}`, startX, 38);
    doc.text(`Payment Time: ${tx?.transaction_time || "N/A"}`, startX, 45);
    doc.setFontSize(9);
    doc.text(`Order ID: ${tx?.orderid || "N/A"}`, 14, 72);
    let posY = 90;
    ...
    doc.text("Lifetime Membership", 14, posY + 6);
    posY += 20;
    ...
    doc.save(`Receipt_${tx?.orderid || "txn"}.pdf`);
  }
  static {
...
//# sourceMappingURL=chunk-ZRHHC6QG.mjs.map
