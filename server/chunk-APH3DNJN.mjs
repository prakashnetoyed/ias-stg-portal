...
function UserHomeComponent_div_24_div_6_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, UserHomeComponent_div_24_div_6_ng_container_1_img_1_Template, 1, 1, "img", 82)(2, UserHomeComponent_div_24_div_6_ng_container_1_video_2_Template, 1, 1, "video", 83);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function UserHomeComponent_div_24_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, UserHomeComponent_div_24_div_6_ng_container_1_Template, 3, 2, "ng-container", 81);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function UserHomeComponent_div_24_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(12, "svg", 96)(13, "mask", 97);
    \u0275\u0275element(14, "rect", 98);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "g", 99);
...
function UserHomeComponent_div_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 75)(1, "div", 76)(2, "div")(3, "small", 64);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "timeAgo");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(6, UserHomeComponent_div_24_div_6_Template, 2, 1, "div", 77);
    \u0275\u0275elementStart(7, "p", 75);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275element(9, "hr", 78);
    \u0275\u0275template(10, UserHomeComponent_div_24_div_10_Template, 18, 10, "div", 79);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserHomeComponent_div_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 75)(1, "p", 75);
...
function UserHomeComponent_div_32_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(7, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 106)(9, "h6", 107);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "p", 108);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(12, "svg", 109)(13, "mask", 110);
    \u0275\u0275element(14, "rect", 111);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "g", 112);
    \u0275\u0275element(16, "path", 113);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(18, UserHomeComponent_div_32_div_1_button_18_Template, 2, 0, "button", 114);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function UserHomeComponent_div_32_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, UserHomeComponent_div_32_div_1_Template, 19, 12, "div", 101);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserHomeComponent_div_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 117)(1, "h1");
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "hr");
    \u0275\u0275elementStart(5, "div", 118)(6, "div", 119)(7, "div", 14);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(8, "svg", 120);
    ...
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(15, "div", 123)(16, "div", 14);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(17, "svg", 109)(18, "mask", 124);
    \u0275\u0275element(19, "rect", 111);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "g", 125);
    \u0275\u0275element(21, "path", 126);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(25, "svg", 127)(26, "title", 128);
    \u0275\u0275text(27, "Success");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "desc", 129);
    \u0275\u0275text(29, "Green circle with small white tick");
    \u0275\u0275elementEnd();
    \u0275\u0275element(30, "circle", 130)(31, "path", 131);
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserHomeComponent_ng_container_44_div_1_div_9_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, UserHomeComponent_ng_container_44_div_1_div_9_ng_container_1_img_1_Template, 1, 1, "img", 82)(2, UserHomeComponent_ng_container_44_div_1_div_9_ng_container_1_video_2_Template, 1, 1, "video", 83);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const file_r11 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", file_r11.endsWith(".jpg") || file_r11.endsWith(".jpeg") || file_r11.endsWith(".png"));
    \u0275\u0275advance();
...
function UserHomeComponent_ng_container_44_div_1_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, UserHomeComponent_ng_container_44_div_1_div_9_ng_container_1_Template, 3, 2, "ng-container", 81);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const post_r10 = \u0275\u0275nextContext().$implicit;
...
function UserHomeComponent_ng_container_44_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 133)(1, "div", 76);
    \u0275\u0275template(2, UserHomeComponent_ng_container_44_div_1_img_2_Template, 1, 1, "img", 134);
    \u0275\u0275elementStart(3, "div")(4, "h6", 135);
    \u0275\u0275text(5);
    \u0275\u0275elementStart(6, "small", 64);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "timeAgo");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(9, UserHomeComponent_ng_container_44_div_1_div_9_Template, 2, 1, "div", 136);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(20, "svg", 93);
    \u0275\u0275element(21, "path", 94);
    \u0275\u0275elementEnd();
    \u0275\u0275text(22, "Copy Link ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(24, "svg", 96)(25, "mask", 97);
    \u0275\u0275element(26, "rect", 98);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "g", 99);
    \u0275\u0275element(28, "path", 100);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(29, " Comment ");
    \u0275\u0275elementEnd()()();
  }
...
function UserHomeComponent_ng_container_44_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, UserHomeComponent_ng_container_44_div_1_Template, 30, 17, "div", 132);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserHomeComponent_option_74_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", tag_r12.name, " ");
  }
}
function UserHomeComponent_div_99_ng_container_1_img_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 146);
  }
  if (rf & 2) {
    const preview_r14 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("src", preview_r14, \u0275\u0275sanitizeUrl);
  }
}
function UserHomeComponent_div_99_ng_container_1_video_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "video", 147);
  }
  if (rf & 2) {
    const preview_r14 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("src", preview_r14, \u0275\u0275sanitizeUrl);
...
function UserHomeComponent_div_99_ng_container_1_div_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Progress: ", ctx_r1.uploadProgress[i_r15], "%");
  }
}
function UserHomeComponent_div_99_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 142);
    \u0275\u0275template(2, UserHomeComponent_div_99_ng_container_1_img_2_Template, 1, 1, "img", 143)(3, UserHomeComponent_div_99_ng_container_1_video_3_Template, 1, 1, "video", 144)(4, UserHomeComponent_div_99_ng_container_1_div_4_Template, 3, 1, "div", 32);
    \u0275\u0275elementStart(5, "button", 145);
    \u0275\u0275listener("click", function UserHomeComponent_div_99_ng_container_1_Template_button_click_5_listener() {
      const i_r15 = \u0275\u0275restoreView(_r13).index;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.removeFile(i_r15));
    });
    \u0275\u0275text(6, " \u2715 ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.selectedFiles[i_r15].type.startsWith("image/"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.selectedFiles[i_r15].type.startsWith("video/"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.uploadProgress[i_r15] >= 0);
  }
}
function UserHomeComponent_div_99_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 141);
    \u0275\u0275template(1, UserHomeComponent_div_99_ng_container_1_Template, 7, 3, "ng-container", 81);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserHomeComponent_div_100_Template(rf, ctx) {
  if (rf & 1) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserHomeComponent, selectors: [["app-user-home"]], viewQuery: function UserHomeComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275text(70, "*");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(71, "select", 46)(72, "option", 47);
        \u0275\u0275text(73, "Select tag");
        \u0275\u0275elementEnd();
        \u0275\u0275template(74, UserHomeComponent_option_74_Template, 2, 2, "option", 48);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(75, "div", 49)(76, "label", 41);
        \u0275\u0275text(77, "Upload Media");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(78, "label", 50)(79, "div", 51);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(80, "svg", 52);
        \u0275\u0275element(81, "circle", 53);
        \u0275\u0275elementStart(82, "mask", 54);
        \u0275\u0275element(83, "rect", 55);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(84, "g", 56);
        \u0275\u0275element(85, "path", 57);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(86, "defs")(87, "linearGradient", 58);
        \u0275\u0275element(88, "stop", 59)(89, "stop", 60);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(90, "linearGradient", 61);
        \u0275\u0275element(91, "stop", 59)(92, "stop", 60);
        \u0275\u0275elementEnd()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(93, "div", 62)(94, "p", 63);
        \u0275\u0275text(95, "Click to upload");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(96, "small", 64);
        \u0275\u0275text(97, "Max size: 256MB each");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(98, "input", 65);
        \u0275\u0275listener("change", function UserHomeComponent_Template_input_change_98_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onFileSelected($event));
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275template(99, UserHomeComponent_div_99_Template, 2, 1, "div", 66)(100, UserHomeComponent_div_100_Template, 5, 0, "div", 67);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(101, "div", 68)(102, "button", 69);
        \u0275\u0275text(103, "Back");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(104, "button", 70);
        \u0275\u0275text(105, "Submit");
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        let tmp_13_0;
        const noevent_r16 = \u0275\u0275reference(34);
        \u0275\u0275advance();
        ...
        \u0275\u0275advance(7);
        \u0275\u0275property("ngIf", ctx.eventsList.length !== 0)("ngIfElse", noevent_r16);
        \u0275\u0275advance(3);
...
//# sourceMappingURL=chunk-APH3DNJN.mjs.map
