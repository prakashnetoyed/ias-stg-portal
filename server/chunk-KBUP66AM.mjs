...
var routes = [
    ...
    children: [
      {
        ...
        loadComponent: () => import("./chunk-IQZEFKUU.mjs").then((m) => m.IasHomepageComponent)
      },
      {
        path: "about-us",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "contact-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-5VYZAEDE.mjs").then((m) => m.IasContactusComponent)
      },
      {
        path: "community",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-UMSBHB2K.mjs").then((m) => m.IasCommunityComponent)
      },
      {
        path: "post",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-U4FUPRID.mjs").then((m) => m.PostComponent)
      },
      {
        path: "caruna",
  ...
  },
  {
    ...
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-6PUWE45W.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-RYMUFK47.mjs").then((m) => m.DashboardComponent)
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-KGBU5MSM.mjs").then((m) => m.ProfileInfoComponent)
      },
      {
        path: "publications",
      ...
      {
        path: "news",
        loadComponent: () => import("./chunk-OMQ6TCIM.mjs").then((m) => m.NewsComponent)
      },
      {
        path: "feedbacks",
        loadComponent: () => import("./chunk-RBOVLYVF.mjs").then((m) => m.FeedbacksComponent)
      },
      {
        path: "my-transaction",
        loadComponent: () => import("./chunk-E442GZ3F.mjs").then((m) => m.MyTransactionComponent)
      },
      {
        path: "approved-user",
        loadComponent: () => import("./chunk-35GBA7NQ.mjs").then((m) => m.ApprovedUserComponent)
      },
      {
        path: "pending-approval-user",
        loadComponent: () => import("./chunk-G3DU7VZR.mjs").then((m) => m.NotApprovedUserComponent)
      },
      {
        path: "rejected-user",
        loadComponent: () => import("./chunk-NZ2IMUD5.mjs").then((m) => m.RejectedUsersComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-HDT47RHP.mjs").then((m) => m.UserDashboardComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-TC6X2AYS.mjs").then((m) => m.UserHomeComponent)
      },
      {
        path: "user-profile",
        loadComponent: () => import("./chunk-YE4GIZUO.mjs").then((m) => m.UserProfileComponent)
      },
      {
        path: "user-events",
        loadComponent: () => import("./chunk-4NW3JPYE.mjs").then((m) => m.UserEventsComponent)
      },
      {
        path: "user-membership",
        loadComponent: () => import("./chunk-YRAQY6Z5.mjs").then((m) => m.UserMembershipComponent)
      },
      {
        path: "user-members",
        loadComponent: () => import("./chunk-U4QXIAZL.mjs").then((m) => m.UserMembersComponent)
      },
      {
        path: "user-transactions",
        loadComponent: () => import("./chunk-2PT6KV4P.mjs").then((m) => m.MyTransactionsComponent)
      },
      {
        path: "payment-status",
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-KBUP66AM.mjs.map
