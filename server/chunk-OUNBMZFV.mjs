...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "about-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-2UN7YWHY.mjs").then((m) => m.IasAboutusComponent)
      },
      {
        path: "contact-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-QCX2ETKY.mjs").then((m) => m.IasContactusComponent)
      },
      {
        path: "community",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "all-members",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-PWMG3BOK.mjs").then((m) => m.AllMembersComponent)
      },
      {
        path: "news-blogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-IVPZNHTG.mjs").then((m) => m.NewsBlogsComponent)
      },
      {
      ...
      },
      {
        ...
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-HBLHW2SO.mjs").then((m) => m.ReadmoreCaseStudiesComponent)
      },
      {
        path: "caruna",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "readmorenews",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-F2LNVC3C.mjs").then((m) => m.ReadmoreNewsComponent)
      },
      {
        path: "readmoreblogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-WLXXVU2N.mjs").then((m) => m.ReadmoreBlogsComponent)
      },
      {
        path: "membership",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-3MPUQFGO.mjs").then((m) => m.CombinedMemberPageComponent)
      },
      {
      ...
      },
      {
        path: "coming-soon",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-6XMH5YSG.mjs").then((m) => m.ComingSoonComponent)
      }
    ]
  },
  {
  ...
  },
  {
    ...
    canActivate: [authGuard],
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-RPTJPJ7D.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-NRQ2U76K.mjs").then((m) => m.DashboardComponent)
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-JL5YBPCQ.mjs").then((m) => m.ProfileInfoComponent)
      },
      {
        path: "publications",
        loadComponent: () => import("./chunk-SXALG6C6.mjs").then((m) => m.PublicationsComponent)
      },
      {
        path: "blogs",
        loadComponent: () => import("./chunk-5JPLRQEL.mjs").then((m) => m.BlogsComponent)
      },
      {
        path: "news",
        loadComponent: () => import("./chunk-AV4I5J5A.mjs").then((m) => m.NewsComponent)
      },
      {
        path: "case-study",
        loadComponent: () => import("./chunk-ITJJRS5L.mjs").then((m) => m.CaseStudiesComponent)
      },
      {
        path: "mom",
        loadComponent: () => import("./chunk-2SIUHU3W.mjs").then((m) => m.MoMComponent)
      },
      {
        path: "feedbacks",
        loadComponent: () => import("./chunk-KUTL4RME.mjs").then((m) => m.FeedbacksComponent)
      },
      {
        path: "my-transaction",
        loadComponent: () => import("./chunk-DU6OQHSX.mjs").then((m) => m.MyTransactionComponent)
      },
      {
        path: "approved-user",
        loadComponent: () => import("./chunk-ELTDZWMB.mjs").then((m) => m.ApprovedUserComponent)
      },
      {
        path: "pending-approval-user",
        loadComponent: () => import("./chunk-P7TR2TXQ.mjs").then((m) => m.NotApprovedUserComponent)
      },
      {
        path: "rejected-user",
        loadComponent: () => import("./chunk-5D4HOUAA.mjs").then((m) => m.RejectedUsersComponent)
      },
      {
        path: "user-info",
        loadComponent: () => import("./chunk-N2OEAR6Y.mjs").then((m) => m.DetailedUserInfoComponent)
      },
      {
        path: "donation",
        loadComponent: () => import("./chunk-LI5XX7DV.mjs").then((m) => m.DonationsComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-DZ5KJN77.mjs").then((m) => m.UserDashboardComponent),
    children: [
      {
        path: "",
      ...
      {
        path: "user-profile",
        loadComponent: () => import("./chunk-H2U55VJT.mjs").then((m) => m.UserProfileComponent)
      },
      {
        path: "user-events",
        loadComponent: () => import("./chunk-U5J3EKFV.mjs").then((m) => m.UserEventsComponent)
      },
      {
        path: "user-membership",
        loadComponent: () => import("./chunk-6U3A472G.mjs").then((m) => m.UserMembershipComponent)
      },
      {
        path: "user-members",
        loadComponent: () => import("./chunk-2SZYX7JJ.mjs").then((m) => m.UserMembersComponent)
      },
      {
        path: "user-transactions",
        loadComponent: () => import("./chunk-AWTNPZWM.mjs").then((m) => m.MyTransactionsComponent)
      },
      {
        path: "my-donation",
        loadComponent: () => import("./chunk-X2YGRG5R.mjs").then((m) => m.UserDonationsComponent)
      },
      {
        path: "payment-status",
        loadComponent: () => import("./chunk-2GWQA4BZ.mjs").then((m) => m.PaymentStatusComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-CIT3Z7XP.mjs").then((m) => m.StateDashboardLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-SELNUQRS.mjs").then((m) => m.StateAboutUsComponent)
      },
      {
        path: "state-news",
        loadComponent: () => import("./chunk-2MHJOK2I.mjs").then((m) => m.StateNewsComponent)
      },
      {
        path: "state-events",
        loadComponent: () => import("./chunk-F5P7YOLR.mjs").then((m) => m.StateEventsComponent)
      },
      {
        path: "state-office-bearers",
        loadComponent: () => import("./chunk-L7KQ6GFG.mjs").then((m) => m.StateOfficeBearersComponent)
      },
      {
        path: "state-gallery",
        loadComponent: () => import("./chunk-6PX3OAVK.mjs").then((m) => m.StateGalleryComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-KWYRTOBP.mjs").then((m) => m.UserNotApprovedLayoutComponent)
  },
  {
    path: "login",
    redirectTo: "",
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-3YL6A5TP.mjs").then((m) => m.RouteErrorComponent)
  }
];
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const moduleImpl = this.moduleImpl ?? import("./chunk-J2FISKEZ.mjs");
