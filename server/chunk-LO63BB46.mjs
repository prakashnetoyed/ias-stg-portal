...
var routes = [
    ...
    children: [
      {
        ...
        loadComponent: () => import("./chunk-J6RX6NVF.mjs").then((m) => m.IasHomepageComponent)
      },
      {
        path: "about-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-JGTDAOVT.mjs").then((m) => m.IasAboutusComponent)
      },
      {
        path: "contact-us",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "community",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-SLJXQMQE.mjs").then((m) => m.IasCommunityComponent)
      },
      {
        path: "my-posts",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-ODYZMMOP.mjs").then((m) => m.MyPostsComponent)
      },
      {
        path: "post",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-NDKIUGES.mjs").then((m) => m.PostComponent)
      },
      {
        path: "caruna",
      ...
      },
      {
        path: "news-blogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-ZNLE7A6S.mjs").then((m) => m.NewsBlogsComponent)
      },
      {
        path: "caruna",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "readmorenews",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-OGJSULBS.mjs").then((m) => m.ReadmoreNewsComponent)
      },
      {
        path: "readmoreblogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-XBQ47E4Q.mjs").then((m) => m.ReadmoreBlogsComponent)
      },
      {
        path: "membership",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-FG2ZMQHR.mjs").then((m) => m.CombinedMemberPageComponent)
      },
      {
  ...
  },
  {
    ...
    canActivate: [authGuard],
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-YZN4KDAW.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-RGUV62K6.mjs").then((m) => m.DashboardComponent)
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-MU74ZB24.mjs").then((m) => m.ProfileInfoComponent)
      },
      {
        path: "publications",
      ...
      {
        path: "mom",
        loadComponent: () => import("./chunk-PAJEZLOS.mjs").then((m) => m.MoMComponent)
      },
      {
        path: "feedbacks",
      ...
      {
        path: "approved-user",
        loadComponent: () => import("./chunk-CYMRPUPG.mjs").then((m) => m.ApprovedUserComponent)
      },
      {
        path: "pending-approval-user",
        loadComponent: () => import("./chunk-2BU4N7FL.mjs").then((m) => m.NotApprovedUserComponent)
      },
      {
        path: "rejected-user",
        loadComponent: () => import("./chunk-SA7YJ3Z3.mjs").then((m) => m.RejectedUsersComponent)
      },
      {
        path: "user-info",
        loadComponent: () => import("./chunk-RFVIHT2H.mjs").then((m) => m.DetailedUserInfoComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-XBYIAOAD.mjs").then((m) => m.UserDashboardComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-QBDJBOS4.mjs").then((m) => m.UserHomeComponent)
      },
      {
        path: "user-profile",
        loadComponent: () => import("./chunk-3LKPOC3U.mjs").then((m) => m.UserProfileComponent)
      },
      {
        path: "user-events",
      ...
      {
        path: "payment-status",
        loadComponent: () => import("./chunk-N6UQYT6Q.mjs").then((m) => m.PaymentStatusComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-BABNEYPR.mjs").then((m) => m.UserNotApprovedLayoutComponent)
  },
  {
    path: "**",
    // wildcard → catch all unknown routes
    loadComponent: () => import("./chunk-26NRB2B2.mjs").then((m) => m.RouteErrorComponent)
  }
];
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-LO63BB46.mjs.map
