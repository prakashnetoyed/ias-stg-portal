...
function IasCommunityComponent_ng_container_32_div_1_div_8_ng_container_1_img_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("src", "https://iascaportal.s3.ap-south-1.amazonaws.com/" + file_r6, \u0275\u0275sanitizeUrl);
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(IasCommunityComponent, { className: "IasCommunityComponent", filePath: "src/app/website/pages/ias-community/ias-community.component.ts", lineNumber: 16 });
})();
export {
  IasCommunityComponent
};
//# sourceMappingURL=chunk-7RJDZVAY.mjs.map
