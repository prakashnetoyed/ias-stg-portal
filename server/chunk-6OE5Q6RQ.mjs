...
function UserHomeComponent_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 73)(1, "div", 74)(2, "div")(3, "small", 61);
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "timeAgo");
    \u0275\u0275elementEnd()()();
...
function UserHomeComponent_div_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 92)(1, "div", 93)(2, "div", 94);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "date");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(12, "svg", 99)(13, "mask", 100);
    \u0275\u0275element(14, "rect", 101);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "g", 102);
    \u0275\u0275element(16, "path", 103);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(18, UserHomeComponent_div_29_button_18_Template, 2, 0, "button", 104);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function UserHomeComponent_div_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "hr");
    \u0275\u0275elementStart(5, "div", 107)(6, "div", 108)(7, "div", 109);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(8, "svg", 110);
    \u0275\u0275element(9, "path", 111);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(10, "p")(11, "span");
    \u0275\u0275text(12, "Membership Type:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "span", 112);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(15, "div", 113)(16, "div", 109);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(17, "svg", 99)(18, "mask", 114);
    \u0275\u0275element(19, "rect", 101);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "g", 115);
    \u0275\u0275element(21, "path", 116);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(25, "svg", 117)(26, "title", 118);
    \u0275\u0275text(27, "Success");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "desc", 119);
    \u0275\u0275text(29, "Green circle with small white tick");
    \u0275\u0275elementEnd();
    \u0275\u0275element(30, "circle", 120)(31, "path", 121);
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserHomeComponent_ng_container_39_div_1_div_9_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, UserHomeComponent_ng_container_39_div_1_div_9_ng_container_1_img_1_Template, 1, 1, "img", 88)(2, UserHomeComponent_ng_container_39_div_1_div_9_ng_container_1_video_2_Template, 1, 1, "video", 89);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function UserHomeComponent_ng_container_39_div_1_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, UserHomeComponent_ng_container_39_div_1_div_9_ng_container_1_Template, 3, 2, "ng-container", 87);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const post_r10 = \u0275\u0275nextContext().$implicit;
...
function UserHomeComponent_ng_container_39_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 123)(1, "div", 74);
    \u0275\u0275template(2, UserHomeComponent_ng_container_39_div_1_img_2_Template, 1, 1, "img", 124);
    \u0275\u0275elementStart(3, "div")(4, "h6", 125);
    \u0275\u0275text(5);
    \u0275\u0275elementStart(6, "small", 61);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "timeAgo");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(9, UserHomeComponent_ng_container_39_div_1_div_9_Template, 2, 1, "div", 126);
...
function UserHomeComponent_ng_container_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, UserHomeComponent_ng_container_39_div_1_Template, 23, 12, "div", 122);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserHomeComponent_div_94_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, UserHomeComponent_div_94_ng_container_1_img_2_Template, 1, 1, "img", 133)(3, UserHomeComponent_div_94_ng_container_1_video_3_Template, 1, 1, "video", 134)(4, UserHomeComponent_div_94_ng_container_1_div_4_Template, 3, 1, "div", 29);
...
function UserHomeComponent_div_94_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, UserHomeComponent_div_94_ng_container_1_Template, 7, 3, "ng-container", 87);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserHomeComponent, selectors: [["app-user-home"]], viewQuery: function UserHomeComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275template(7, UserHomeComponent_div_7_Template, 8, 3, "div", 8);
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275template(29, UserHomeComponent_div_29_Template, 19, 12, "div", 23);
        \u0275\u0275elementEnd();
        \u0275\u0275template(30, UserHomeComponent_div_30_Template, 32, 5, "div", 24);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(70, "div", 46)(71, "label", 38);
        \u0275\u0275text(72, "Upload Media");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(73, "label", 47)(74, "div", 48);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(75, "svg", 49);
        \u0275\u0275element(76, "circle", 50);
        \u0275\u0275elementStart(77, "mask", 51);
        \u0275\u0275element(78, "rect", 52);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(79, "g", 53);
        \u0275\u0275element(80, "path", 54);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(81, "defs")(82, "linearGradient", 55);
        \u0275\u0275element(83, "stop", 56)(84, "stop", 57);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(85, "linearGradient", 58);
        \u0275\u0275element(86, "stop", 56)(87, "stop", 57);
        \u0275\u0275elementEnd()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(88, "div", 59)(89, "p", 60);
        \u0275\u0275text(90, "Click to upload");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(91, "small", 61);
        \u0275\u0275text(92, "Max size: 256MB each");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(93, "input", 62);
        \u0275\u0275listener("change", function UserHomeComponent_Template_input_change_93_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onFileSelected($event));
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275template(94, UserHomeComponent_div_94_Template, 2, 1, "div", 63)(95, UserHomeComponent_div_95_Template, 5, 0, "div", 64);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(96, "div", 65)(97, "button", 66);
        \u0275\u0275text(98, "Back");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(99, "button", 67);
        \u0275\u0275text(100, "Submit");
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
...
//# sourceMappingURL=chunk-6OE5Q6RQ.mjs.map
