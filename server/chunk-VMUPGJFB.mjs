...
function DashboardComponent_table_82_tr_20_a_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 71);
    \u0275\u0275listener("click", function DashboardComponent_table_82_tr_20_a_22_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function DashboardComponent_table_82_tr_20_a_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 65);
    \u0275\u0275listener("click", function DashboardComponent_table_82_tr_20_a_24_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const user_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 66)(2, "mask", 67);
    \u0275\u0275element(3, "rect", 68);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "g", 69);
    \u0275\u0275element(5, "path", 70);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(6, "Reject");
    \u0275\u0275elementEnd();
...
function DashboardComponent_table_82_tr_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td")(12, "span", 59);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "td");
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "td")(17, "div", 60)(18, "button", 61);
    \u0275\u0275text(19, " \u22EE ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "ul", 62)(21, "li");
    \u0275\u0275template(22, DashboardComponent_table_82_tr_20_a_22_Template, 4, 0, "a", 63);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "li");
    \u0275\u0275template(24, DashboardComponent_table_82_tr_20_a_24_Template, 7, 0, "a", 64);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "li")(26, "a", 65);
    \u0275\u0275listener("click", function DashboardComponent_table_82_tr_20_Template_a_click_26_listener() {
      const user_r4 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.openDeleteModal(user_r4.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(27, "svg", 66)(28, "mask", 67);
    \u0275\u0275element(29, "rect", 68);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "g", 69);
    \u0275\u0275element(31, "path", 70);
    \u0275\u0275elementEnd()();
...
function DashboardComponent_table_82_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(20, DashboardComponent_table_82_tr_20_Template, 33, 10, "tr", 58);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function DashboardComponent_li_91_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 49)(1, "a", 50);
    \u0275\u0275listener("click", function DashboardComponent_li_91_Template_a_click_1_listener() {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-dashboard"]], viewQuery: function DashboardComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(81, "div", 45);
        \u0275\u0275template(82, DashboardComponent_table_82_Template, 21, 1, "table", 46);
        \u0275\u0275elementEnd();
        \u0275\u0275template(83, DashboardComponent_ng_template_83_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementStart(85, "div", 47)(86, "nav")(87, "ul", 48)(88, "li", 49)(89, "a", 50);
        \u0275\u0275listener("click", function DashboardComponent_Template_a_click_89_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goPrevious());
        });
        \u0275\u0275text(90, "\u2039");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(91, DashboardComponent_li_91_Template, 3, 3, "li", 51);
        \u0275\u0275elementStart(92, "li", 49)(93, "a", 50);
        \u0275\u0275listener("click", function DashboardComponent_Template_a_click_93_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goNext());
        });
        \u0275\u0275text(94, "\u203A");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(95, "div", 52)(96, "select", 53);
        \u0275\u0275listener("change", function DashboardComponent_Template_select_change_96_listener($event) {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275text(98, "5 /Page");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(99, "option", 55);
        \u0275\u0275text(100, "10 /Page");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(101, "option", 56);
        \u0275\u0275text(102, "20 /Page");
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        const noUsers_r10 = \u0275\u0275reference(84);
        ...
        \u0275\u0275advance(3);
        \u0275\u0275property("ngForOf", \u0275\u0275pureFunction0(20, _c1).constructor(ctx.totalPages));
        \u0275\u0275advance();
...
//# sourceMappingURL=chunk-VMUPGJFB.mjs.map
