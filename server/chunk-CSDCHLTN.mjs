...
var _c0 = ["errorToast"];
var _c1 = () => [];
function PublicationsComponent_table_88_tr_18_ng_container_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "a", 73);
    \u0275\u0275namespaceSVG();
...
function PublicationsComponent_table_88_tr_18_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, "No link");
  }
}
function PublicationsComponent_table_88_tr_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(11, PublicationsComponent_table_88_tr_18_ng_container_11_Template, 5, 1, "ng-container", 58)(12, PublicationsComponent_table_88_tr_18_ng_template_12_Template, 1, 0, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "td")(15, "span", 59);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "td")(18, "div", 60)(19, "button", 61);
    \u0275\u0275text(20, " \u22EE ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "ul", 62)(22, "li")(23, "a", 63);
    \u0275\u0275listener("click", function PublicationsComponent_table_88_tr_18_Template_a_click_23_listener() {
      const user_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.openEditDrawer(user_r3));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(24, "svg", 64)(25, "mask", 65);
    \u0275\u0275element(26, "rect", 66);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "g", 67);
    \u0275\u0275element(28, "path", 68);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(29, "Edit");
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(30, "li")(31, "a", 69);
    \u0275\u0275listener("click", function PublicationsComponent_table_88_tr_18_Template_a_click_31_listener() {
      const user_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r3.onDeleteBlog(user_r3.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(32, "svg", 64)(33, "mask", 70);
    \u0275\u0275element(34, "rect", 66);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "g", 71);
...
function PublicationsComponent_table_88_Template(rf, ctx) {
  if (rf & 1) {
...
function PublicationsComponent_ng_template_89_Template(rf, ctx) {
  if (rf & 1) {
...
function PublicationsComponent_li_97_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 48)(1, "a", 49);
    \u0275\u0275listener("click", function PublicationsComponent_li_97_Template_a_click_1_listener() {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PublicationsComponent, selectors: [["app-publications"]], viewQuery: function PublicationsComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275text(71, "Announcements (if any)");
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275template(88, PublicationsComponent_table_88_Template, 19, 1, "table", 45);
        \u0275\u0275elementEnd();
        \u0275\u0275template(89, PublicationsComponent_ng_template_89_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementStart(91, "div", 46)(92, "nav")(93, "ul", 47)(94, "li", 48)(95, "a", 49);
        ...
        \u0275\u0275text(96, "\u2039");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(97, PublicationsComponent_li_97_Template, 3, 3, "li", 50);
        \u0275\u0275elementStart(98, "li", 48)(99, "a", 49);
        \u0275\u0275listener("click", function PublicationsComponent_Template_a_click_99_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goNext());
        });
        \u0275\u0275text(100, "\u203A");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(101, "div", 51)(102, "select", 52);
        \u0275\u0275listener("change", function PublicationsComponent_Template_select_change_102_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onPageSizeChange($event));
        });
        \u0275\u0275elementStart(103, "option", 53);
        \u0275\u0275text(104, "5 /Page");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(105, "option", 54);
        \u0275\u0275text(106, "10 /Page");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(107, "option", 55);
        \u0275\u0275text(108, "20 /Page");
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        const noUsers_r9 = \u0275\u0275reference(90);
        \u0275\u0275advance(5);
        ...
        \u0275\u0275advance(13);
        \u0275\u0275property("min", ctx.todayDateTime);
        \u0275\u0275advance(32);
...
//# sourceMappingURL=chunk-CSDCHLTN.mjs.map
