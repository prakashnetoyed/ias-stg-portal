...
var _c1 = ["errorToast"];
function UserProfileComponent_div_14__svg_svg_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function UserProfileComponent_div_14__svg_svg_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 41)(1, "g", 46);
    \u0275\u0275element(2, "path", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "defs")(4, "clipPath", 48);
    \u0275\u0275element(5, "rect", 45);
    \u0275\u0275elementEnd()()();
  }
}
function UserProfileComponent_div_14_div_23_span_1_Template(rf, ctx) {
  if (rf & 1) {
...
function UserProfileComponent_div_14_div_23_span_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function UserProfileComponent_div_14_div_23_span_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function UserProfileComponent_div_14_div_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 49);
    \u0275\u0275template(1, UserProfileComponent_div_14_div_23_span_1_Template, 2, 0, "span", 50)(2, UserProfileComponent_div_14_div_23_span_2_Template, 2, 0, "span", 50)(3, UserProfileComponent_div_14_div_23_span_3_Template, 2, 0, "span", 50);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
...
function UserProfileComponent_div_14__svg_svg_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 41)(1, "g", 42);
    \u0275\u0275element(2, "path", 43);
...
function UserProfileComponent_div_14__svg_svg_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 41)(1, "g", 46);
    \u0275\u0275element(2, "path", 47);
...
function UserProfileComponent_div_14_div_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 49);
...
function UserProfileComponent_div_14_div_82_Template(rf, ctx) {
  if (rf & 1) {
...
function UserProfileComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngSubmit", function UserProfileComponent_div_14_Template_form_ngSubmit_13_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function UserProfileComponent_div_14_Template_button_click_20_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleNewPassword());
    });
    \u0275\u0275template(21, UserProfileComponent_div_14__svg_svg_21_Template, 6, 0, "svg", 25)(22, UserProfileComponent_div_14__svg_svg_22_Template, 6, 0, "svg", 25);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(23, UserProfileComponent_div_14_div_23_Template, 4, 3, "div", 26);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function UserProfileComponent_div_14_Template_button_click_29_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleConfirmPassword());
    });
    \u0275\u0275template(30, UserProfileComponent_div_14__svg_svg_30_Template, 6, 0, "svg", 25)(31, UserProfileComponent_div_14__svg_svg_31_Template, 6, 0, "svg", 25);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(32, UserProfileComponent_div_14_div_32_Template, 2, 0, "div", 26);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(42, " Submit ");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(43, "div", 34)(44, "div", 35)(45, "div", 36)(46, "h2");
    \u0275\u0275text(47, "Personal Information");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "div", 37)(49, "div", 38)(50, "span");
    \u0275\u0275text(51, "Name: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "h5");
    \u0275\u0275text(53);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(54, "div", 38)(55, "span");
    \u0275\u0275text(56, "Gender: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "h5");
    \u0275\u0275text(58);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(59, "div", 38)(60, "span");
    \u0275\u0275text(61, "DOB: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "h5");
    \u0275\u0275text(63);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(64, "div", 36)(65, "h2");
    \u0275\u0275text(66, "Contact Details");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(67, "div", 37)(68, "div", 39)(69, "span");
    \u0275\u0275text(70, "E- Mail: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "h5");
    \u0275\u0275text(72);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(77);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(78, "div", 36)(79, "h2");
    \u0275\u0275text(80, "Place Of Domicile");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(81, "div", 37);
    \u0275\u0275template(82, UserProfileComponent_div_14_div_82_Template, 5, 1, "div", 40);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    let tmp_7_0;
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserProfileComponent, selectors: [["app-user-profile"]], viewQuery: function UserProfileComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(14, UserProfileComponent_div_14_Template, 83, 16, "div", 8);
      }
      if (rf & 2) {
        \u0275\u0275advance(14);
...
//# sourceMappingURL=chunk-JD3CUQH6.mjs.map
