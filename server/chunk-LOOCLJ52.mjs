...
function IasCommunityComponent_ng_container_32_div_1_div_8_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, IasCommunityComponent_ng_container_32_div_1_div_8_ng_container_1_img_1_Template, 1, 1, "img", 52)(2, IasCommunityComponent_ng_container_32_div_1_div_8_ng_container_1_video_2_Template, 1, 1, "video", 53);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function IasCommunityComponent_ng_container_32_div_1_div_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, IasCommunityComponent_ng_container_32_div_1_div_8_ng_container_1_Template, 3, 2, "ng-container", 51);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const post_r5 = \u0275\u0275nextContext().$implicit;
...
function IasCommunityComponent_ng_container_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, IasCommunityComponent_ng_container_32_div_1_Template, 34, 18, "div", 28);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var IasCommunityComponent = class _IasCommunityComponent {
  constructor(http, toastService, titleService) {
    this.http = http;
  ...
  ngOnInit() {
    ...
    this.auth.checkAuth();
    this.community();
    this.titleService.setTitle("IASCA Portal - Community");
  }
  toggleLike(post) {
    if (!post)
      return;
  ...
  static {
    this.\u0275fac = function IasCommunityComponent_Factory(t) {
      return new (t || _IasCommunityComponent)(\u0275\u0275directiveInject(HttpClient), \u0275\u0275directiveInject(ToastService), \u0275\u0275directiveInject(Title));
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(IasCommunityComponent, { className: "IasCommunityComponent", filePath: "src/app/website/pages/ias-community/ias-community.component.ts", lineNumber: 18 });
})();
export {
  IasCommunityComponent
};
//# sourceMappingURL=chunk-LOOCLJ52.mjs.map
