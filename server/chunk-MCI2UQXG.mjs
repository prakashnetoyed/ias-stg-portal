...
function UserMembershipComponent_ng_container_0_p_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275template(1, UserMembershipComponent_ng_container_0_p_24_ng_container_1_Template, 3, 4, "ng-container", 19);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275nextContext();
...
function UserMembershipComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "div", 3)(2, "h5");
    \u0275\u0275text(3, "Membership");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 4)(5, "div", 5)(6, "h4")(7, "span", 6);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275text(9, " Membership");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275element(12, "hr");
    \u0275\u0275elementStart(13, "div", 8)(14, "div", 9)(15, "div", 10)(16, "p");
    ...
    \u0275\u0275pipe(20, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 10)(22, "p");
    \u0275\u0275text(23, " Valid Till: ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(24, UserMembershipComponent_ng_container_0_p_24_Template, 2, 2, "p", 11)(25, UserMembershipComponent_ng_container_0_ng_template_25_Template, 1, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "div", 12)(28, "div", 10)(29, "p");
    \u0275\u0275text(30, " Fee Paid : ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(31, "svg", 13)(32, "title", 14);
    \u0275\u0275text(33, "Success");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "desc", 15);
    \u0275\u0275text(35, "Green circle with small white tick");
    \u0275\u0275elementEnd();
    \u0275\u0275element(36, "circle", 16)(37, "path", 17);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(38, "div", 10)(39, "p");
...
function UserMembershipComponent_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementContainerStart(0, 2);
    \u0275\u0275elementStart(1, "div", 20)(2, "h5");
    \u0275\u0275text(3, "Choose Membership");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 21)(5, "div", 22)(6, "div", 23)(7, "div", 24)(8, "h5", 25);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(9, "svg", 26)(10, "mask", 27);
    \u0275\u0275element(11, "rect", 28);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "g", 29);
    ...
    \u0275\u0275listener("click", function UserMembershipComponent_ng_container_1_Template_button_click_22_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.paymentAirpay("lifetime"));
    });
    \u0275\u0275text(23, "Pay Now");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(24, "div", 22)(25, "div", 23)(26, "div", 24)(27, "h5", 25);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(28, "svg", 34)(29, "mask", 35);
    \u0275\u0275element(30, "rect", 36);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "g", 37);
    \u0275\u0275element(32, "path", 38);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(35, "p", 31);
    \u0275\u0275text(36, "\u20B91,000 per Tenure");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "ul", 32)(38, "li");
    ...
    \u0275\u0275listener("click", function UserMembershipComponent_ng_container_1_Template_button_click_42_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.paymentAirpay("tenure"));
    });
    \u0275\u0275text(43, "Pay Now");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(44, "div", 22)(45, "div", 23)(46, "div", 24)(47, "h5", 25);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(48, "svg", 26)(49, "mask", 40);
    \u0275\u0275element(50, "rect", 41);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "g", 42);
    \u0275\u0275element(52, "path", 43);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("click", function UserMembershipComponent_ng_container_1_Template_button_click_61_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.paymentAirpay("annual"));
    });
    \u0275\u0275text(62, "Pay Now");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementContainerEnd();
...
//# sourceMappingURL=chunk-MCI2UQXG.mjs.map
