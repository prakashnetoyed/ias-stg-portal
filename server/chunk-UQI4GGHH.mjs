...
function DashboardComponent_table_102_tr_20_a_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 34)(2, "mask", 75);
    \u0275\u0275element(3, "rect", 76);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "g", 77);
    \u0275\u0275element(5, "path", 78);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(6, "Reject");
    \u0275\u0275elementEnd();
...
function DashboardComponent_table_102_tr_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td")(12, "span", 68);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "td");
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "td")(17, "div", 69)(18, "button", 70);
    \u0275\u0275text(19, " \u22EE ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "ul", 71)(21, "li");
    \u0275\u0275template(22, DashboardComponent_table_102_tr_20_a_22_Template, 4, 0, "a", 72);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "li");
    \u0275\u0275template(24, DashboardComponent_table_102_tr_20_a_24_Template, 7, 0, "a", 73);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "li")(26, "a", 74);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(27, "svg", 34)(28, "mask", 75);
    \u0275\u0275element(29, "rect", 76);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "g", 77);
    \u0275\u0275element(31, "path", 78);
    \u0275\u0275elementEnd()();
...
function DashboardComponent_table_102_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "table", 66)(1, "thead")(2, "tr")(3, "th");
    \u0275\u0275text(4, "S.no");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "th");
    \u0275\u0275text(6, "Cadre");
    ...
    \u0275\u0275template(20, DashboardComponent_table_102_tr_20_Template, 33, 10, "tr", 67);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-dashboard"]], viewQuery: function DashboardComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()()()()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(51, "div", 39)(52, "div", 22);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(53, "svg", 23);
        \u0275\u0275element(54, "rect", 24);
        \u0275\u0275elementStart(55, "mask", 40);
        \u0275\u0275element(56, "rect", 26);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(57, "g", 41);
        \u0275\u0275element(58, "path", 42);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(59, "defs")(60, "linearGradient", 43);
        ...
        \u0275\u0275elementEnd()()()()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(76, "div", 39)(77, "div", 22);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(78, "svg", 23);
        \u0275\u0275element(79, "rect", 24);
        \u0275\u0275elementStart(80, "mask", 44);
        \u0275\u0275element(81, "rect", 26);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(82, "g", 45);
        \u0275\u0275element(83, "path", 46);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(84, "defs")(85, "linearGradient", 47);
        ...
        \u0275\u0275element(96, "path", 50);
        \u0275\u0275elementEnd()()()()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(97, "div", 51)(98, "div", 52)(99, "h5", 53);
        \u0275\u0275text(100, "User Management");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(101, "div", 54);
        \u0275\u0275template(102, DashboardComponent_table_102_Template, 21, 1, "table", 55);
        \u0275\u0275elementEnd();
        \u0275\u0275template(103, DashboardComponent_ng_template_103_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementStart(105, "div", 56)(106, "nav")(107, "ul", 57)(108, "li", 58)(109, "a", 59);
        ...
        \u0275\u0275text(110, "\u2039");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(111, DashboardComponent_li_111_Template, 3, 3, "li", 60);
        \u0275\u0275elementStart(112, "li", 58)(113, "a", 59);
        ...
        \u0275\u0275text(114, "\u203A");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(115, "div", 61)(116, "select", 62);
        ...
        \u0275\u0275elementStart(117, "option", 63);
        \u0275\u0275text(118, "5 /Page");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(119, "option", 64);
        \u0275\u0275text(120, "10 /Page");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(121, "option", 65);
        \u0275\u0275text(122, "20 /Page");
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
...
//# sourceMappingURL=chunk-UQI4GGHH.mjs.map
