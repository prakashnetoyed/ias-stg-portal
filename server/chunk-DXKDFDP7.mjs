...
var routes = [
    ...
    children: [
      {
        ...
        loadComponent: () => import("./chunk-LHVXLLW5.mjs").then((m) => m.IasHomepageComponent)
      },
      {
        path: "about-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-MHMUKHNW.mjs").then((m) => m.IasAboutusComponent)
      },
      {
        path: "contact-us",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "community",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-YQYPOXZ2.mjs").then((m) => m.IasCommunityComponent)
      },
      {
        path: "post",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-OGAYPRDF.mjs").then((m) => m.PostComponent)
      },
      {
        path: "caruna",
      ...
      },
      {
        path: "news-blogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-KIOLAGZ5.mjs").then((m) => m.NewsBlogsComponent)
      },
      {
        path: "caruna",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "readmorenews",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-3MPAAMGZ.mjs").then((m) => m.ReadmoreNewsComponent)
      },
      {
        path: "readmoreblogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-JF73SRGV.mjs").then((m) => m.ReadmoreBlogsComponent)
      },
      {
        path: "membership",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-WGN4FBHK.mjs").then((m) => m.CombinedMemberPageComponent)
      },
      {
  ...
  },
  {
    ...
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-GOTIO3JC.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
      ...
      {
        path: "publications",
        loadComponent: () => import("./chunk-ID5GY3IL.mjs").then((m) => m.PublicationsComponent)
      },
      {
        path: "blogs",
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-BCQKILCU.mjs").then((m) => m.UserDashboardComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-KRDMHJB4.mjs").then((m) => m.UserHomeComponent)
      },
      {
        path: "user-profile",
      ...
      {
        path: "payment-status",
        loadComponent: () => import("./chunk-UFRC2IYF.mjs").then((m) => m.PaymentStatusComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-ZWSSQB75.mjs").then((m) => m.UserNotApprovedLayoutComponent)
  },
  {
    path: "**",
    // wildcard → catch all unknown routes
    loadComponent: () => import("./chunk-FYMYYTPV.mjs").then((m) => m.RouteErrorComponent)
  }
];
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-DXKDFDP7.mjs.map
