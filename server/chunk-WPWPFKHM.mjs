...
function DashboardComponent_table_96_tr_22_a_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 81);
    \u0275\u0275listener("click", function DashboardComponent_table_96_tr_22_a_25_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r5);
...
function DashboardComponent_table_96_tr_22_a_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 75);
    \u0275\u0275listener("click", function DashboardComponent_table_96_tr_22_a_27_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const user_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r6 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 76)(2, "mask", 77);
    \u0275\u0275element(3, "rect", 78);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "g", 79);
    \u0275\u0275element(5, "path", 80);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(6, "Reject");
    \u0275\u0275elementEnd();
...
function DashboardComponent_table_96_tr_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td")(12, "span", 69);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "td")(15, "span", 69);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "td");
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "td")(20, "div", 70)(21, "button", 71);
    \u0275\u0275text(22, " \u22EE ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "ul", 72)(24, "li");
    \u0275\u0275template(25, DashboardComponent_table_96_tr_22_a_25_Template, 4, 0, "a", 73);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "li");
    \u0275\u0275template(27, DashboardComponent_table_96_tr_22_a_27_Template, 7, 0, "a", 74);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "li")(29, "a", 75);
    \u0275\u0275listener("click", function DashboardComponent_table_96_tr_22_Template_a_click_29_listener() {
      const user_r6 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r6 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r6.openDeleteModal(user_r6.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(30, "svg", 76)(31, "mask", 77);
    \u0275\u0275element(32, "rect", 78);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "g", 79);
    \u0275\u0275element(34, "path", 80);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(35, " Deactivate account");
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(user_r6.email || "Not Found");
    \u0275\u0275advance(7);
...
function DashboardComponent_table_96_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(22, DashboardComponent_table_96_tr_22_Template, 36, 12, "tr", 68);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-dashboard"]], viewQuery: function DashboardComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(90, "div", 49)(91, "span", 50);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(92, "svg", 51);
        \u0275\u0275element(93, "path", 52);
        \u0275\u0275elementEnd()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(94, "input", 53);
        \u0275\u0275twoWayListener("ngModelChange", function DashboardComponent_Template_input_ngModelChange_94_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.searchText, $event) || (ctx.searchText = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275listener("keyup", function DashboardComponent_Template_input_keyup_94_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onSearchKeyup());
        });
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(95, "div", 54);
        \u0275\u0275template(96, DashboardComponent_table_96_Template, 23, 1, "table", 55);
        \u0275\u0275elementEnd();
...
//# sourceMappingURL=chunk-WPWPFKHM.mjs.map
