...
var HeroSectionComponent = class _HeroSectionComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeroSectionComponent, selectors: [["app-hero-section"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 14, vars: 1, consts: [[1, "main-hero-div"], [1, "container", "d-flex", "align-items-center"], [1, "left-heading-div"], ["class", "btn btn-black", 3, "routerLink", 4, "ngIf"], [1, "right-logo-div", "d-flex", "align-items-center", "justify-content-center"], ["src", "../../../../assets/logo/ias-big-logo.png", "alt", "ias-big logo", "draggable", "false"], [1, "btn", "btn-black", 3, "routerLink"]], template: function HeroSectionComponent_Template(rf, ctx) {
      if (rf & 1) {
...
var IasCommunityMembersComponent = class _IasCommunityMembersComponent {
  ...
  sendMail(member) {
    const subject = encodeURIComponent(`Hello ${member.name}`);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _IasPrivilegesComponent, selectors: [["app-ias-privileges"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 51, vars: 1, consts: [[1, "main-prividleges-div"], [1, "container"], [1, "main-heading-div", "mb-5"], [1, "other-privileges"], [1, "privilege"], ["xmlns", "http://www.w3.org/2000/svg", "width", "50", "height", "50", "viewBox", "0 0 50 50", "fill", "none"], ["id", "mask0_234_491", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "50", "height", "50", 2, "mask-type", "alpha"], ["width", "50", "height", "50", "fill", "#D9D9D9"], ["mask", "url(#mask0_234_491)"], ["d", "M24.9997 24.9999C22.708 24.9999 20.7462 24.1839 19.1143 22.552C17.4823 20.9201 16.6663 18.9583 16.6663 16.6666C16.6663 14.3749 17.4823 12.4131 19.1143 10.7812C20.7462 9.14922 22.708 8.33325 24.9997 8.33325C27.2913 8.33325 29.2531 9.14922 30.8851 10.7812C32.517 12.4131 33.333 14.3749 33.333 16.6666C33.333 18.9583 32.517 20.9201 30.8851 22.552C29.2531 24.1839 27.2913 24.9999 24.9997 24.9999ZM8.33301 41.6666V35.8333C8.33301 34.6527 8.63683 33.5676 9.24447 32.578C9.85211 31.5885 10.6594 30.8333 11.6663 30.3124C13.8191 29.236 16.0066 28.4287 18.2288 27.8905C20.4511 27.3523 22.708 27.0833 24.9997 27.0833C27.2913 27.0833 29.5483 27.3523 31.7705 27.8905C33.9927 28.4287 36.1802 29.236 38.333 30.3124C39.34 30.8333 40.1472 31.5885 40.7549 32.578C41.3625 33.5676 41.6663 34.6527 41.6663 35.8333V41.6666H8.33301ZM12.4997 37.4999H37.4997V35.8333C37.4997 35.4513 37.4042 35.1041 37.2132 34.7916C37.0222 34.4791 36.7705 34.236 36.458 34.0624C34.583 33.1249 32.6906 32.4218 30.7809 31.953C28.8712 31.4843 26.9441 31.2499 24.9997 31.2499C23.0552 31.2499 21.1281 31.4843 19.2184 31.953C17.3087 32.4218 15.4163 33.1249 13.5413 34.0624C13.2288 34.236 12.9771 34.4791 12.7861 34.7916C12.5952 35.1041 12.4997 35.4513 12.4997 35.8333V37.4999ZM24.9997 20.8333C26.1455 20.8333 27.1264 20.4253 27.9424 19.6093C28.7584 18.7933 29.1663 17.8124 29.1663 16.6666C29.1663 15.5208 28.7584 14.5398 27.9424 13.7239C27.1264 12.9079 26.1455 12.4999 24.9997 12.4999C23.8538 12.4999 22.8729 12.9079 22.057 13.7239C21.241 14.5398 20.833 15.5208 20.833 16.6666C20.833 17.8124 21.241 18.7933 22.057 19.6093C22.8729 20.4253 23.8538 20.8333 24.9997 20.8333Z", "fill", "white"], ["id", "mask0_90_103", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "50", "height", "50", 2, "mask-type", "alpha"], ["mask", "url(#mask0_90_103)"], ["d", "M24.7396 41.6668C24.8785 41.6668 25.0174 41.632 25.1562 41.5626C25.2951 41.4931 25.3993 41.4237 25.4687 41.3543L42.5521 24.2709C42.9688 23.8542 43.2726 23.3855 43.4635 22.8647C43.6545 22.3438 43.75 21.823 43.75 21.3022C43.75 20.7466 43.6545 20.2171 43.4635 19.7136C43.2726 19.2102 42.9688 18.7674 42.5521 18.3855L33.6979 9.53133C33.316 9.11467 32.8733 8.81085 32.3698 8.61987C31.8663 8.4289 31.3368 8.33342 30.7812 8.33342C30.2604 8.33342 29.7396 8.4289 29.2188 8.61987C28.6979 8.81085 28.2292 9.11467 27.8125 9.53133L27.2396 10.1042L31.0938 14.0105C31.6146 14.4966 31.9965 15.0522 32.2396 15.6772C32.4826 16.3022 32.6042 16.9619 32.6042 17.6563C32.6042 19.1147 32.1094 20.3386 31.1198 21.3282C30.1302 22.3178 28.9062 22.8126 27.4479 22.8126C26.7535 22.8126 26.0851 22.6911 25.4427 22.448C24.8003 22.2049 24.2361 21.8404 23.75 21.3542L19.8437 17.5001L10.7292 26.6147C10.625 26.7188 10.5469 26.8317 10.4948 26.9532C10.4427 27.0747 10.4167 27.2049 10.4167 27.3438C10.4167 27.6216 10.5208 27.8733 10.7292 28.099C10.9375 28.3247 11.1806 28.4376 11.4583 28.4376C11.5972 28.4376 11.7361 28.4029 11.875 28.3334C12.0139 28.264 12.1181 28.1945 12.1875 28.1251L19.2708 21.0417L22.1875 23.9584L15.1562 31.0418C15.0521 31.1459 14.974 31.2588 14.9219 31.3803C14.8698 31.5018 14.8437 31.632 14.8437 31.7709C14.8437 32.0487 14.9479 32.2918 15.1562 32.5001C15.3646 32.7084 15.6076 32.8126 15.8854 32.8126C16.0243 32.8126 16.1632 32.7779 16.3021 32.7084C16.441 32.639 16.5451 32.5695 16.6146 32.5001L23.6979 25.4688L26.6146 28.3855L19.5833 35.4688C19.4792 35.5383 19.401 35.6424 19.349 35.7813C19.2969 35.9202 19.2708 36.0591 19.2708 36.198C19.2708 36.4758 19.375 36.7188 19.5833 36.9272C19.7917 37.1355 20.0347 37.2397 20.3125 37.2397C20.4514 37.2397 20.5816 37.2136 20.7031 37.1615C20.8247 37.1095 20.9375 37.0313 21.0417 36.9272L28.125 29.8959L31.0417 32.8126L23.9583 39.8959C23.8542 40.0001 23.776 40.1129 23.724 40.2345C23.6719 40.356 23.6458 40.4862 23.6458 40.6251C23.6458 40.9029 23.7587 41.1459 23.9844 41.3543C24.2101 41.5626 24.4618 41.6668 24.7396 41.6668ZM24.6875 45.8334C23.4028 45.8334 22.2656 45.4081 21.276 44.5574C20.2865 43.7067 19.7049 42.639 19.5312 41.3543C18.3507 41.1806 17.3611 40.6945 16.5625 39.8959C15.7639 39.0973 15.2778 38.1077 15.1042 36.9272C13.9236 36.7536 12.9427 36.2588 12.1615 35.4428C11.3802 34.6268 10.9028 33.6459 10.7292 32.5001C9.40972 32.3265 8.33333 31.7536 7.5 30.7813C6.66667 29.8091 6.25 28.6633 6.25 27.3438C6.25 26.6494 6.38021 25.981 6.64062 25.3386C6.90104 24.6963 7.27431 24.132 7.76042 23.6459L19.8437 11.6147L26.6667 18.4376C26.7361 18.5417 26.8403 18.6199 26.9792 18.672C27.1181 18.724 27.2569 18.7501 27.3958 18.7501C27.7083 18.7501 27.9687 18.6546 28.1771 18.4636C28.3854 18.2727 28.4896 18.0209 28.4896 17.7084C28.4896 17.5695 28.4635 17.4306 28.4115 17.2917C28.3594 17.1529 28.2812 17.0487 28.1771 16.9792L20.7292 9.53133C20.3472 9.11467 19.9045 8.81085 19.401 8.61987C18.8976 8.4289 18.3681 8.33342 17.8125 8.33342C17.2917 8.33342 16.7708 8.4289 16.25 8.61987C15.7292 8.81085 15.2604 9.11467 14.8437 9.53133L7.5 16.9272C7.1875 17.2397 6.92708 17.6042 6.71875 18.0209C6.51042 18.4376 6.37153 18.8542 6.30208 19.2709C6.23264 19.6876 6.23264 20.1129 6.30208 20.547C6.37153 20.981 6.51042 21.389 6.71875 21.7709L3.69792 24.7917C3.10764 23.9931 2.67361 23.1164 2.39583 22.1615C2.11806 21.2067 2.01389 20.2431 2.08333 19.2709C2.15278 18.2987 2.39583 17.3525 2.8125 16.4324C3.22917 15.5122 3.80208 14.6876 4.53125 13.9584L11.875 6.61467C12.7083 5.81605 13.6372 5.20841 14.6615 4.79175C15.6858 4.37508 16.7361 4.16675 17.8125 4.16675C18.8889 4.16675 19.9392 4.37508 20.9635 4.79175C21.9878 5.20841 22.8993 5.81605 23.6979 6.61467L24.2708 7.18758L24.8438 6.61467C25.6771 5.81605 26.6059 5.20841 27.6302 4.79175C28.6545 4.37508 29.7049 4.16675 30.7812 4.16675C31.8576 4.16675 32.908 4.37508 33.9323 4.79175C34.9566 5.20841 35.8681 5.81605 36.6667 6.61467L45.4688 15.4167C46.2674 16.2154 46.875 17.1355 47.2917 18.1772C47.7083 19.2188 47.9167 20.2779 47.9167 21.3542C47.9167 22.4306 47.7083 23.481 47.2917 24.5053C46.875 25.5296 46.2674 26.4411 45.4688 27.2397L28.3854 44.2709C27.8993 44.757 27.3351 45.139 26.6927 45.4168C26.0503 45.6945 25.3819 45.8334 24.6875 45.8334Z", "fill", "white"], ["id", "mask0_90_107", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "50", "height", "50", 2, "mask-type", "alpha"], ["mask", "url(#mask0_90_107)"], ["d", "M25.0003 45.8334C22.1531 45.8334 19.4621 45.2865 16.9274 44.1928C14.3927 43.099 12.1791 41.606 10.2868 39.7136C8.39442 37.8213 6.90137 35.6077 5.80762 33.073C4.71387 30.5383 4.16699 27.8473 4.16699 25.0001C4.16699 22.1181 4.71387 19.4185 5.80762 16.9011C6.90137 14.3838 8.39442 12.1789 10.2868 10.2865C12.1791 8.39418 14.3927 6.90112 16.9274 5.80737C19.4621 4.71362 22.1531 4.16675 25.0003 4.16675C27.8823 4.16675 30.5819 4.71362 33.0993 5.80737C35.6166 6.90112 37.8215 8.39418 39.7139 10.2865C41.6062 12.1789 43.0993 14.3838 44.193 16.9011C45.2868 19.4185 45.8337 22.1181 45.8337 25.0001C45.8337 27.8473 45.2868 30.5383 44.193 33.073C43.0993 35.6077 41.6062 37.8213 39.7139 39.7136C37.8215 41.606 35.6166 43.099 33.0993 44.1928C30.5819 45.2865 27.8823 45.8334 25.0003 45.8334ZM25.0003 41.5626C25.9031 40.3126 26.6844 39.0105 27.3441 37.6563C28.0038 36.3022 28.542 34.8612 28.9587 33.3334H21.042C21.4587 34.8612 21.9969 36.3022 22.6566 37.6563C23.3163 39.0105 24.0975 40.3126 25.0003 41.5626ZM19.5837 40.7293C18.9587 39.5834 18.4118 38.3942 17.943 37.1615C17.4743 35.9289 17.0837 34.6529 16.7712 33.3334H10.6253C11.6323 35.0695 12.891 36.5799 14.4014 37.8647C15.9118 39.1494 17.6392 40.1043 19.5837 40.7293ZM30.417 40.7293C32.3614 40.1043 34.0889 39.1494 35.5993 37.8647C37.1097 36.5799 38.3684 35.0695 39.3753 33.3334H33.2295C32.917 34.6529 32.5264 35.9289 32.0576 37.1615C31.5889 38.3942 31.042 39.5834 30.417 40.7293ZM8.85449 29.1667H15.9378C15.8337 28.4723 15.7555 27.7865 15.7035 27.1095C15.6514 26.4324 15.6253 25.7292 15.6253 25.0001C15.6253 24.2709 15.6514 23.5678 15.7035 22.8907C15.7555 22.2136 15.8337 21.5279 15.9378 20.8334H8.85449C8.68088 21.5279 8.55067 22.2136 8.46387 22.8907C8.37706 23.5678 8.33366 24.2709 8.33366 25.0001C8.33366 25.7292 8.37706 26.4324 8.46387 27.1095C8.55067 27.7865 8.68088 28.4723 8.85449 29.1667ZM20.1045 29.1667H29.8962C30.0003 28.4723 30.0785 27.7865 30.1305 27.1095C30.1826 26.4324 30.2087 25.7292 30.2087 25.0001C30.2087 24.2709 30.1826 23.5678 30.1305 22.8907C30.0785 22.2136 30.0003 21.5279 29.8962 20.8334H20.1045C20.0003 21.5279 19.9222 22.2136 19.8701 22.8907C19.818 23.5678 19.792 24.2709 19.792 25.0001C19.792 25.7292 19.818 26.4324 19.8701 27.1095C19.9222 27.7865 20.0003 28.4723 20.1045 29.1667ZM34.0628 29.1667H41.1462C41.3198 28.4723 41.45 27.7865 41.5368 27.1095C41.6236 26.4324 41.667 25.7292 41.667 25.0001C41.667 24.2709 41.6236 23.5678 41.5368 22.8907C41.45 22.2136 41.3198 21.5279 41.1462 20.8334H34.0628C34.167 21.5279 34.2451 22.2136 34.2972 22.8907C34.3493 23.5678 34.3753 24.2709 34.3753 25.0001C34.3753 25.7292 34.3493 26.4324 34.2972 27.1095C34.2451 27.7865 34.167 28.4723 34.0628 29.1667ZM33.2295 16.6667H39.3753C38.3684 14.9306 37.1097 13.4202 35.5993 12.1355C34.0889 10.8508 32.3614 9.89592 30.417 9.27092C31.042 10.4167 31.5889 11.606 32.0576 12.8386C32.5264 14.0713 32.917 15.3473 33.2295 16.6667ZM21.042 16.6667H28.9587C28.542 15.139 28.0038 13.698 27.3441 12.3438C26.6844 10.9897 25.9031 9.68758 25.0003 8.43758C24.0975 9.68758 23.3163 10.9897 22.6566 12.3438C21.9969 13.698 21.4587 15.139 21.042 16.6667ZM10.6253 16.6667H16.7712C17.0837 15.3473 17.4743 14.0713 17.943 12.8386C18.4118 11.606 18.9587 10.4167 19.5837 9.27092C17.6392 9.89592 15.9118 10.8508 14.4014 12.1355C12.891 13.4202 11.6323 14.9306 10.6253 16.6667Z", "fill", "white"], [1, "privilege", "border-end-0"], ["id", "mask0_90_99", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "50", "height", "50", 2, "mask-type", "alpha"], ["mask", "url(#mask0_90_99)"], ["d", "M37.4997 43.7501L45.833 35.4167L42.9163 32.5001L39.583 35.8334V27.1355H35.4163V35.8334L32.083 32.5001L29.1663 35.4167L37.4997 43.7501ZM29.1663 50.0001V45.8334H45.833V50.0001H29.1663ZM12.4997 41.6667C11.3538 41.6667 10.3729 41.2588 9.55697 40.4428C8.74099 39.6268 8.33301 38.6459 8.33301 37.5001V8.33341C8.33301 7.18758 8.74099 6.20668 9.55697 5.39071C10.3729 4.57473 11.3538 4.16675 12.4997 4.16675H27.083L39.583 16.6667V22.9688H35.4163V18.7501H24.9997V8.33341H12.4997V37.5001H24.9997V41.6667H12.4997Z", "fill", "white"], [1, "button-div", "w-100", "d-flex", "align-items-center", "justify-content-center", "mt-5"], [1, "btn", "btn-prime", "w-25", 3, "routerLink"]], template: function IasPrivilegesComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(16, "p");
        \u0275\u0275text(17, "Guidance from seasoned officers throughout your IAS journey.");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275text(25, "Vibrant Community");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(26, "p");
        \u0275\u0275text(27, "Join a purpose-driven network of IAS officers");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275text(35, "Real-World Impact");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(36, "p");
        \u0275\u0275text(37, "Opportunities to contribute to real projects and grassroots initiatives that shape society");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275text(45, "Discussion Forum");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(46, "p");
        \u0275\u0275text(47, "A space for members to share ideas, raise questions, and exchange knowledge. Collaborate with peers, contribute your voice, and shape the dialogue");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(48, "div", 20)(49, "button", 21);
        \u0275\u0275text(50, "Join the Discussion");
        \u0275\u0275elementEnd()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(49);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(IasPrivilegesComponent, { className: "IasPrivilegesComponent", filePath: "src/app/website/components/ias-privileges/ias-privileges.component.ts", lineNumber: 13 });
})();
    ...
    this.faqs = [
      {
        ...
        status: "",
        description: "Members of the Service posted at NCT of Delhi shall pay a tenure membership fee of \u20B91000 per tenure posting in Government of India",
        isOpen: true
      },
      {
        title: "Annual Membership",
        status: "",
        description: "Other members of the Association posted in the NCT of Delhi shall pay an annual membership fee of \u20B9200",
        isOpen: false
      },
      {
...
function IasMonthlymeetComponent_div_5_div_1_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 25);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 26)(2, "mask", 27);
    \u0275\u0275element(3, "rect", 28);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "g", 29);
    \u0275\u0275element(5, "path", 30);
    \u0275\u0275elementEnd()()();
  }
}
function IasMonthlymeetComponent_div_5_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 8)(1, "div", 9);
    \u0275\u0275listener("click", function IasMonthlymeetComponent_div_5_div_1_Template_div_click_1_listener() {
      const blog_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(blog_r2.url && ctx_r2.goToUserEvents());
    });
    \u0275\u0275template(2, IasMonthlymeetComponent_div_5_div_1_div_2_Template, 6, 0, "div", 10);
    \u0275\u0275elementStart(3, "div", 11)(4, "div", 12)(5, "div", 13)(6, "div", 14);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "date");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(11, "date");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "div", 16)(13, "div", 17)(14, "div")(15, "h5");
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "p");
    \u0275\u0275text(18);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(20, "svg", 19)(21, "mask", 20);
    \u0275\u0275element(22, "rect", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "g", 22);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(blog_r2.description);
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(blog_r2.location);
  }
}
...
function IasMonthlymeetComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
...
var IasMonthlymeetComponent = class _IasMonthlymeetComponent {
  ...
  static {
    this.\u0275fac = function IasMonthlymeetComponent_Factory(t) {
      return new (t || _IasMonthlymeetComponent)(\u0275\u0275directiveInject(HttpClient), \u0275\u0275directiveInject(PLATFORM_ID), \u0275\u0275directiveInject(Router));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _IasMonthlymeetComponent, selectors: [["app-ias-monthlymeet"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 8, vars: 2, consts: [["noUsers", ""], [1, "ias-bg"], [1, "container", "heading"], [1, "ias-title", "mb-5"], [1, "container", "my-5"], ["class", "row g-4", 4, "ngIf", "ngIfElse"], [1, "row", "g-4"], ["class", "col-md-6", 4, "ngFor", "ngForOf"], [1, "col-md-6"], [1, "event-card", "event1", "p-3", 3, "click"], ["class", "white-link-div", 4, "ngIf"], [1, "row"], [1, "col-lg-5", "col-xl-4"], [1, "ms-3"], [1, "event-month", "ps-2"], [1, "event-day"], [1, "col-lg-7", "col-xl-8"], [1, "event-details"], [1, "d-flex", "align-items-center", "gap-1"], ["xmlns", "http://www.w3.org/2000/svg", "width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none"], ["id", "mask0_50758_556", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "24", "height", "24", 2, "mask-type", "alpha"], ["width", "24", "height", "24", "fill", "#D9D9D9"], ["mask", "url(#mask0_50758_556)"], ["d", "M12 12C12.55 12 13.0208 11.8042 13.4125 11.4125C13.8042 11.0208 14 10.55 14 10C14 9.45 13.8042 8.97917 13.4125 8.5875C13.0208 8.19583 12.55 8 12 8C11.45 8 10.9792 8.19583 10.5875 8.5875C10.1958 8.97917 10 9.45 10 10C10 10.55 10.1958 11.0208 10.5875 11.4125C10.9792 11.8042 11.45 12 12 12ZM12 19.35C14.0333 17.4833 15.5417 15.7875 16.525 14.2625C17.5083 12.7375 18 11.3833 18 10.2C18 8.38333 17.4208 6.89583 16.2625 5.7375C15.1042 4.57917 13.6833 4 12 4C10.3167 4 8.89583 4.57917 7.7375 5.7375C6.57917 6.89583 6 8.38333 6 10.2C6 11.3833 6.49167 12.7375 7.475 14.2625C8.45833 15.7875 9.96667 17.4833 12 19.35ZM12 22C9.31667 19.7167 7.3125 17.5958 5.9875 15.6375C4.6625 13.6792 4 11.8667 4 10.2C4 7.7 4.80417 5.70833 6.4125 4.225C8.02083 2.74167 9.88333 2 12 2C14.1167 2 15.9792 2.74167 17.5875 4.225C19.1958 5.70833 20 7.7 20 10.2C20 11.8667 19.3375 13.6792 18.0125 15.6375C16.6875 17.5958 14.6833 19.7167 12 22Z", "fill", "white"], [1, "mb-0"], [1, "white-link-div"], ["xmlns", "http://www.w3.org/2000/svg", "width", "18", "height", "18", "viewBox", "0 0 18 18", "fill", "none"], ["id", "mask0_52563_2958", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "18", "height", "18", 2, "mask-type", "alpha"], ["width", "18", "height", "18", "fill", "#D9D9D9"], ["mask", "url(#mask0_52563_2958)"], ["d", "M6.1875 13.5C4.8875 13.5 3.78125 13.0437 2.86875 12.1313C1.95625 11.2188 1.5 10.1125 1.5 8.8125C1.5 7.5125 1.95625 6.40625 2.86875 5.49375C3.78125 4.58125 4.8875 4.125 6.1875 4.125H13.125C14.0625 4.125 14.8594 4.45312 15.5156 5.10938C16.1719 5.76562 16.5 6.5625 16.5 7.5C16.5 8.4375 16.1719 9.23438 15.5156 9.89062C14.8594 10.5469 14.0625 10.875 13.125 10.875H6.5625C5.9875 10.875 5.5 10.675 5.1 10.275C4.7 9.875 4.5 9.3875 4.5 8.8125C4.5 8.2375 4.7 7.75 5.1 7.35C5.5 6.95 5.9875 6.75 6.5625 6.75H13.5V8.25H6.5625C6.4 8.25 6.26562 8.30312 6.15938 8.40938C6.05312 8.51562 6 8.65 6 8.8125C6 8.975 6.05312 9.10938 6.15938 9.21562C6.26562 9.32188 6.4 9.375 6.5625 9.375H13.125C13.65 9.3625 14.0938 9.17813 14.4562 8.82188C14.8187 8.46563 15 8.025 15 7.5C15 6.975 14.8187 6.53125 14.4562 6.16875C14.0938 5.80625 13.65 5.625 13.125 5.625H6.1875C5.3 5.6125 4.54688 5.91875 3.92812 6.54375C3.30937 7.16875 3 7.925 3 8.8125C3 9.6875 3.30937 10.4313 3.92812 11.0438C4.54688 11.6563 5.3 11.975 6.1875 12H13.5V13.5H6.1875Z", "fill", "white"], [1, "text-center", "p-4", "d-flex", "align-items-center", "justify-content-center", "nouser", "flex-column"], ["src", "../../../../assets/icons/empty-img-gray.png", "alt", "empty state"]], template: function IasMonthlymeetComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "h2", 3);
        \u0275\u0275text(3, "Upcoming Events");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(4, "div", 4);
        \u0275\u0275template(5, IasMonthlymeetComponent_div_5_Template, 2, 1, "div", 5)(6, IasMonthlymeetComponent_ng_template_6_Template, 4, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        const noUsers_r4 = \u0275\u0275reference(7);
        \u0275\u0275advance(5);
        \u0275\u0275property("ngIf", ctx.blogs && ctx.blogs.length)("ngIfElse", noUsers_r4);
      }
    }, dependencies: [CommonModule, NgForOf, NgIf, DatePipe], styles: ['\n\n.ias-bg[_ngcontent-%COMP%] {\n  background: #15142b;\n  color: #fff;\n  padding-top: 60px;\n  padding-bottom: 60px;\n}\n.ias-label[_ngcontent-%COMP%] {\n  color: #fff;\n  font-family: "Urbanist";\n  font-size: 12px;\n  font-weight: 400;\n  line-height: normal;\n  text-transform: uppercase;\n}\n.ias-title[_ngcontent-%COMP%] {\n  color: #fff;\n  font-family: "Urbanist";\n  font-size: 40px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: normal;\n}\n.contribution-banner[_ngcontent-%COMP%] {\n  position: relative;\n  overflow: hidden;\n  border-radius: 24px;\n  background:\n    linear-gradient(\n      130deg,\n      #492fb2 -1.74%,\n      #adadad 108.02%);\n}\n.contribution-content[_ngcontent-%COMP%] {\n  padding: 3.5rem;\n}\n.contribution-content[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%] {\n  color: #fff;\n  font-family: Urbanist;\n  font-size: 36px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: 42px;\n}\n.contribution-content[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  color: #fff;\n  font-family: Urbanist;\n  font-size: 16px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: 24px;\n}\n.nouser[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  color: #fff;\n  font-family: Urbanist;\n  font-size: 18px;\n  font-style: normal;\n  font-weight: 400;\n  line-height: 150%;\n}\n.makebg[_ngcontent-%COMP%] {\n  position: absolute;\n  bottom: 0;\n  right: 0;\n  height: 100%;\n  z-index: 1;\n  object-fit: cover;\n}\n.makeimage[_ngcontent-%COMP%] {\n  position: relative;\n  z-index: 2;\n}\n.badge[_ngcontent-%COMP%] {\n  border-radius: 8px;\n  background: #8c7fc3;\n  display: inline-flex;\n  gap: 3px;\n  align-items: center;\n  padding: 0 6px;\n  margin: 0 4px;\n  color: #fff;\n  font-family: Urbanist;\n  font-size: 14px;\n  font-style: normal;\n  font-weight: 400;\n  line-height: 24px;\n}\n.make-btn[_ngcontent-%COMP%] {\n  border-radius: 8px;\n  background: #fff;\n  padding: 8px 12px;\n  color: #063787;\n  text-align: center;\n  font-family: Urbanist;\n  font-size: 14px;\n  font-style: normal;\n  font-weight: 600;\n  line-height: 16px;\n  letter-spacing: var(--Letter-Spacing-3, 0.5px);\n}\n.event-card[_ngcontent-%COMP%] {\n  border-radius: 18px;\n  border: 1px solid rgba(101, 130, 255, 0.18);\n  transition: all 0.3s ease;\n  height: 100%;\n  position: relative;\n}\n.event-card.clickable[_ngcontent-%COMP%] {\n  cursor: pointer;\n  transition: transform 0.2s;\n  border: 1px solid white;\n}\n.white-link-div[_ngcontent-%COMP%] {\n  position: absolute;\n  background-color: #ffffff;\n  border-radius: 999px;\n  height: 40px;\n  width: 40px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  top: -20px;\n  right: -10px;\n}\n.white-link-div[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%]   path[_ngcontent-%COMP%] {\n  fill: #15142b;\n}\n.event1[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      90deg,\n      #1b112b 0%,\n      #2f2a38 100%);\n}\n.event2[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      -90deg,\n      #1b112b 0%,\n      #2f2a38 100%);\n}\n.event-card[_ngcontent-%COMP%]:hover {\n  transform: translateY(-5px);\n}\n.event-month[_ngcontent-%COMP%] {\n  color: #fff;\n  font-family: Urbanist;\n  font-size: 16px;\n  font-style: normal;\n  font-weight: 400;\n  line-height: 100%;\n}\n.event-day[_ngcontent-%COMP%] {\n  font-family: Urbanist;\n  font-size: 155px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: 80%;\n  opacity: 0.2;\n  background:\n    linear-gradient(\n      331deg,\n      rgba(153, 153, 153, 0) -3.74%,\n      rgba(255, 255, 255, 0.69) 89.74%);\n  background-clip: text;\n  -webkit-background-clip: text;\n  -webkit-text-fill-color: transparent;\n}\n.event-details[_ngcontent-%COMP%] {\n  padding: 16px;\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  justify-content: space-between;\n}\n.event-details[_ngcontent-%COMP%]   h5[_ngcontent-%COMP%] {\n  color: #fff;\n  font-family: Urbanist;\n  font-size: 22px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: 102.5%;\n}\n.event-details[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  color: #fff;\n  font-family: Urbanist;\n  font-size: 16px;\n  font-style: normal;\n  font-weight: 400;\n  line-height: 162%;\n  opacity: 0.5;\n}\n@media only screen and (max-width: 767px) {\n  .contribution-content[_ngcontent-%COMP%] {\n    padding: 2rem;\n  }\n}\n@media only screen and (max-width: 991px) {\n  .makebg[_ngcontent-%COMP%] {\n    display: none;\n  }\n}\n@media only screen and (min-width: 992px) and (max-width: 1399px) {\n  .event-day[_ngcontent-%COMP%] {\n    font-size: 132px;\n  }\n}\n/*# sourceMappingURL=ias-monthlymeet.component.css.map */'] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(IasMonthlymeetComponent, { className: "IasMonthlymeetComponent", filePath: "src/app/website/components/ias-monthlymeet/ias-monthlymeet.component.ts", lineNumber: 14 });
})();
...
var IasInitiativesComponent = class _IasInitiativesComponent {
  constructor(platformId, router) {
    ...
    this.cards = [
      ...
      { title: "IAS Odisha Association", image: "assets/images/odisha.png", link: "https://x.com/ias_odisha" },
      { title: "IAS Gujarat Association", image: "../../../../assets/images/gujrat.png", link: "https://x.com/IASGujarat" },
      { title: "IAS Punjab Association", image: "assets/images/punjab.png", link: "https://x.com/iaspunjab" },
  ...
  static {
    this.\u0275fac = function IasInitiativesComponent_Factory(t) {
      return new (t || _IasInitiativesComponent)(\u0275\u0275directiveInject(PLATFORM_ID), \u0275\u0275directiveInject(Router));
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(IasInitiativesComponent, { className: "IasInitiativesComponent", filePath: "src/app/website/components/ias-initiatives/ias-initiatives.component.ts", lineNumber: 12 });
})();

// src/app/website/components/ias-createshare/ias-createshare.component.ts
var _c03 = () => ["/user-home"];
var _c13 = () => ["/homepage/post"];
var _c2 = (a0) => ({ id: a0 });
function IasCreateshareComponent_ng_container_27_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("src", ctx_r1.post == null ? null : ctx_r1.post.createdBy.doptOfficer.profilePic, \u0275\u0275sanitizeUrl);
  }
}
function IasCreateshareComponent_ng_container_27_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 60);
  }
}
function IasCreateshareComponent_ng_container_27_div_9_ng_container_1_img_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 65);
  }
  if (rf & 2) {
...
function IasCreateshareComponent_ng_container_27_div_9_ng_container_1_video_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "video", 66);
  }
  if (rf & 2) {
    const file_r3 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function IasCreateshareComponent_ng_container_27_div_9_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, IasCreateshareComponent_ng_container_27_div_9_ng_container_1_img_1_Template, 1, 1, "img", 63)(2, IasCreateshareComponent_ng_container_27_div_9_ng_container_1_video_2_Template, 1, 1, "video", 64);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function IasCreateshareComponent_ng_container_27_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 61);
    \u0275\u0275template(1, IasCreateshareComponent_ng_container_27_div_9_ng_container_1_Template, 3, 2, "ng-container", 62);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r1.post.mediaFile);
  }
}
function IasCreateshareComponent_ng_container_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 42);
    \u0275\u0275template(2, IasCreateshareComponent_ng_container_27_ng_container_2_Template, 2, 1, "ng-container", 23)(3, IasCreateshareComponent_ng_container_27_ng_template_3_Template, 1, 0, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
    \u0275\u0275text(5);
    \u0275\u0275elementStart(6, "span");
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "timeAgo");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(9, IasCreateshareComponent_ng_container_27_div_9_Template, 2, 1, "div", 43);
    ...
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 45)(15, "div", 46)(16, "div", 47);
    \u0275\u0275listener("click", function IasCreateshareComponent_ng_container_27_Template_div_click_16_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleLike(ctx_r1.post));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(17, "svg", 48);
    \u0275\u0275element(18, "path", 49);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275listener("click", function IasCreateshareComponent_ng_container_27_Template_div_click_21_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.copyPostLink(ctx_r1.post.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(22, "svg", 10)(23, "mask", 52);
    \u0275\u0275element(24, "rect", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "g", 53);
    \u0275\u0275element(26, "path", 54);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(27, " Copy Link ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(28, "div", 55);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(29, "svg", 10)(30, "mask", 56);
    \u0275\u0275element(31, "rect", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "g", 57);
    \u0275\u0275element(33, "path", 58);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(34, " Comment ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const avatarFallback_r4 = \u0275\u0275reference(4);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.post == null ? null : ctx_r1.post.createdBy == null ? null : ctx_r1.post.createdBy.doptOfficer == null ? null : ctx_r1.post.createdBy.doptOfficer.profilePic)("ngIfElse", avatarFallback_r4);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", (ctx_r1.post == null ? null : ctx_r1.post.createdBy == null ? null : ctx_r1.post.createdBy.doptOfficer == null ? null : ctx_r1.post.createdBy.doptOfficer.englishName) || "Unknown User", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(8, 14, ctx_r1.post == null ? null : ctx_r1.post.createdAt));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", (ctx_r1.post == null ? null : ctx_r1.post.mediaFile == null ? null : ctx_r1.post.mediaFile.length) > 0);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.post == null ? null : ctx_r1.post.caption);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.post == null ? null : ctx_r1.post.description, " ");
    \u0275\u0275advance(3);
    \u0275\u0275classProp("liked", ctx_r1.post == null ? null : ctx_r1.post.isLiked)("animate", ctx_r1.post == null ? null : ctx_r1.post.animate);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", ctx_r1.post == null ? null : ctx_r1.post.likes, " Likes");
    \u0275\u0275advance(8);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(16, _c13))("queryParams", \u0275\u0275pureFunction1(17, _c2, ctx_r1.post.id));
  }
}
function IasCreateshareComponent_ng_template_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 67)(1, "span", 21);
    \u0275\u0275text(2, "No Featured Post Available");
    \u0275\u0275elementEnd()();
  }
}
function IasCreateshareComponent_div_44_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275element(1, "img", 74);
    \u0275\u0275elementContainerEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("src", ctx_r1.featuredpost.doptOfficer.profilePic, \u0275\u0275sanitizeUrl);
  }
}
function IasCreateshareComponent_div_44_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15)(1, "div", 68)(2, "div", 69);
    \u0275\u0275template(3, IasCreateshareComponent_div_44_ng_container_3_Template, 2, 1, "ng-container", 70);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 71)(5, "div", 72)(6, "div", 73)(7, "span");
    \u0275\u0275text(8, "Name:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "span");
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 73)(12, "span");
    \u0275\u0275text(13, "Cadre:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "span");
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 73)(17, "span");
    \u0275\u0275text(18, "Posting:");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r1.featuredpost == null ? null : ctx_r1.featuredpost.doptOfficer == null ? null : ctx_r1.featuredpost.doptOfficer.profilePic);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate((ctx_r1.featuredpost.doptOfficer == null ? null : ctx_r1.featuredpost.doptOfficer.englishName) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((ctx_r1.featuredpost.doptOfficer == null ? null : ctx_r1.featuredpost.doptOfficer.cadre == null ? null : ctx_r1.featuredpost.doptOfficer.cadre.name) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((ctx_r1.featuredpost.doptOfficer == null ? null : ctx_r1.featuredpost.doptOfficer.posting) || "N/A");
  }
}
...
function IasCreateshareComponent_ng_container_60_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 77)(1, "div")(2, "h5", 78);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p", 78);
    \u0275\u0275text(5, "Added a new Post.");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function IasCreateshareComponent_ng_container_60_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, IasCreateshareComponent_ng_container_60_div_1_Template, 6, 1, "div", 76);
    \u0275\u0275pipe(2, "slice");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind3(2, 1, ctx_r1.posts, 0, 3));
  }
}
function IasCreateshareComponent_ng_template_61_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 75);
    \u0275\u0275text(1, "No Recent Activities Available.");
    \u0275\u0275elementEnd();
  }
}
var IasCreateshareComponent = class _IasCreateshareComponent {
  ...
  communityposts(forUser) {
    let URL;
    if (forUser) {
      URL = `${environment.apiUrl}/communities/users?populate=createdBy&limit=3`;
    } else {
      URL = `${environment.apiUrl}/communities?populate=createdBy&limit=3`;
    }
  ...
  getallid() {
    this.http.get(`${environment.apiUrl}/admin/users?limit=0&isActive=true&role=user`).subscribe({
      next: (res) => {
        const users = res?.data?.data || [];
        this.allavailableid = users.map((u) => u.id);
        this.featuredpic();
      },
      error: (err) => {
  ...
  // ✅ Helper: Get today's featured ID (same for everyone)
  getDailyId() {
    if (!this.allavailableid || this.allavailableid.length === 0) {
      return 0;
    }
    const today = (/* @__PURE__ */ new Date()).toDateString();
    const hash = this.hashString(today);
    const index = hash % this.allavailableid.length;
    return this.allavailableid[index];
  }
  ...
  // ✅ Fetch featured user for today
  featuredpic() {
    const id = this.getDailyId();
    if (!id)
      return;
    console.log("Today\u2019s featured ID:", id);
    this.http.get(`${environment.apiUrl}/admin/users?limit=1&isActive=true&role=user&id=${id}`).subscribe({
      next: (res) => {
        const data = res?.data?.data?.[0];
        if (data) {
          this.featuredpost = data;
        } else {
          console.warn("No data for ID:", id);
        }
      },
      error: (err) => {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _IasCreateshareComponent, selectors: [["app-ias-createshare"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 63, vars: 8, consts: [["nopost", ""], ["noFeaturedPost", ""], ["noactivity", ""], ["avatarFallback", ""], [1, "ias-bg"], [1, "container"], [1, "d-flex", "flex-column", "flex-lg-row", "justify-content-start", "justify-content-lg-between", "align-items-start", "align-items-lg-end", "mb-4"], [1, "ias-label", "mb-1"], [1, "ias-title", "pe-5", "mb-3"], [1, "add-post-btn", 3, "routerLink"], ["xmlns", "http://www.w3.org/2000/svg", "width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none"], ["id", "mask0_329_447", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "24", "height", "24", 2, "mask-type", "alpha"], ["width", "24", "height", "24", "fill", "#D9D9D9"], ["mask", "url(#mask0_329_447)"], ["d", "M11 13H5V11H11V5H13V11H19V13H13V19H11V13Z", "fill", "#150F22"], [1, "row"], [1, "col-lg-6"], [1, "card-Featured", "h-100"], ["src", "../../../../assets/images/featurecardbg.png", "alt", "", "srcset", "", 1, "featurecardbg"], [1, "z-1"], [1, "d-flex", "justify-content-between", "align-items-center", "mb-2"], [1, "Featured-head"], [1, "badge-trending"], [4, "ngIf", "ngIfElse"], [1, "col-lg-6", "mt-3", "mt-lg-0"], [1, "col-12", "mb-3"], [1, "card-Featured", "p-3", "mb-3", "h-100"], ["src", "../../../../assets/images/featureprofilebg.png", "alt", "", "srcset", "", 1, "featureprofilebg"], [1, "d-flex", "align-items-center", "mb-4", "gap-2"], ["id", "mask0_199_674", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "24", "height", "24", 2, "mask-type", "alpha"], ["mask", "url(#mask0_199_674)"], ["d", "M5.85 17.1C6.7 16.45 7.65 15.9375 8.7 15.5625C9.75 15.1875 10.85 15 12 15C13.15 15 14.25 15.1875 15.3 15.5625C16.35 15.9375 17.3 16.45 18.15 17.1C18.7333 16.4167 19.1875 15.6417 19.5125 14.775C19.8375 13.9083 20 12.9833 20 12C20 9.78333 19.2208 7.89583 17.6625 6.3375C16.1042 4.77917 14.2167 4 12 4C9.78333 4 7.89583 4.77917 6.3375 6.3375C4.77917 7.89583 4 9.78333 4 12C4 12.9833 4.1625 13.9083 4.4875 14.775C4.8125 15.6417 5.26667 16.4167 5.85 17.1ZM12 13C11.0167 13 10.1875 12.6625 9.5125 11.9875C8.8375 11.3125 8.5 10.4833 8.5 9.5C8.5 8.51667 8.8375 7.6875 9.5125 7.0125C10.1875 6.3375 11.0167 6 12 6C12.9833 6 13.8125 6.3375 14.4875 7.0125C15.1625 7.6875 15.5 8.51667 15.5 9.5C15.5 10.4833 15.1625 11.3125 14.4875 11.9875C13.8125 12.6625 12.9833 13 12 13ZM12 22C10.6167 22 9.31667 21.7375 8.1 21.2125C6.88333 20.6875 5.825 19.975 4.925 19.075C4.025 18.175 3.3125 17.1167 2.7875 15.9C2.2625 14.6833 2 13.3833 2 12C2 10.6167 2.2625 9.31667 2.7875 8.1C3.3125 6.88333 4.025 5.825 4.925 4.925C5.825 4.025 6.88333 3.3125 8.1 2.7875C9.31667 2.2625 10.6167 2 12 2C13.3833 2 14.6833 2.2625 15.9 2.7875C17.1167 3.3125 18.175 4.025 19.075 4.925C19.975 5.825 20.6875 6.88333 21.2125 8.1C21.7375 9.31667 22 10.6167 22 12C22 13.3833 21.7375 14.6833 21.2125 15.9C20.6875 17.1167 19.975 18.175 19.075 19.075C18.175 19.975 17.1167 20.6875 15.9 21.2125C14.6833 21.7375 13.3833 22 12 22ZM12 20C12.8833 20 13.7167 19.8708 14.5 19.6125C15.2833 19.3542 16 18.9833 16.65 18.5C16 18.0167 15.2833 17.6458 14.5 17.3875C13.7167 17.1292 12.8833 17 12 17C11.1167 17 10.2833 17.1292 9.5 17.3875C8.71667 17.6458 8 18.0167 7.35 18.5C8 18.9833 8.71667 19.3542 9.5 19.6125C10.2833 19.8708 11.1167 20 12 20ZM12 11C12.4333 11 12.7917 10.8583 13.075 10.575C13.3583 10.2917 13.5 9.93333 13.5 9.5C13.5 9.06667 13.3583 8.70833 13.075 8.425C12.7917 8.14167 12.4333 8 12 8C11.5667 8 11.2083 8.14167 10.925 8.425C10.6417 8.70833 10.5 9.06667 10.5 9.5C10.5 9.93333 10.6417 10.2917 10.925 10.575C11.2083 10.8583 11.5667 11 12 11Z", "fill", "white"], [1, "Featuredtitle"], ["class", "row", 4, "ngIf", "ngIfElse"], [1, "row", "gap-3", "gap-md-0"], [1, "col"], [1, "card-Featured", "p-4", "pb-2", "h-100"], ["src", "../../../../assets/images/recentbg.png", "alt", "", "srcset", "", 1, "recentbg"], [1, "d-flex", "align-items-center", "mb-3", "gap-2"], ["id", "mask0_329_397", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "24", "height", "24", 2, "mask-type", "alpha"], ["mask", "url(#mask0_329_397)"], ["d", "M11.0229 16.2L12.3997 14.8L9.25283 11.6V7H7.28606V12.4L11.0229 16.2ZM17.1199 20.5V18.3C18.3328 17.7167 19.2916 16.8583 19.9964 15.725C20.7011 14.5917 21.0535 13.35 21.0535 12C21.0535 10.65 20.7011 9.40833 19.9964 8.275C19.2916 7.14167 18.3328 6.28333 17.1199 5.7V3.5C18.9064 4.13333 20.3364 5.22917 21.41 6.7875C22.4835 8.34583 23.0203 10.0833 23.0203 12C23.0203 13.9167 22.4835 15.6542 21.41 17.2125C20.3364 18.7708 18.9064 19.8667 17.1199 20.5ZM8.26944 21C7.04021 21 5.88882 20.7625 4.81529 20.2875C3.74176 19.8125 2.80754 19.1708 2.01263 18.3625C1.21773 17.5542 0.586719 16.6042 0.11961 15.5125C-0.3475 14.4208 -0.581055 13.25 -0.581055 12C-0.581055 10.75 -0.3475 9.57917 0.11961 8.4875C0.586719 7.39583 1.21773 6.44583 2.01263 5.6375C2.80754 4.82917 3.74176 4.1875 4.81529 3.7125C5.88882 3.2375 7.04021 3 8.26944 3C9.49868 3 10.6501 3.2375 11.7236 3.7125C12.7971 4.1875 13.7313 4.82917 14.5263 5.6375C15.3212 6.44583 15.9522 7.39583 16.4193 8.4875C16.8864 9.57917 17.1199 10.75 17.1199 12C17.1199 13.25 16.8864 14.4208 16.4193 15.5125C15.9522 16.6042 15.3212 17.5542 14.5263 18.3625C13.7313 19.1708 12.7971 19.8125 11.7236 20.2875C10.6501 20.7625 9.49868 21 8.26944 21ZM8.26944 19C10.1871 19 11.8137 18.3208 13.1495 16.9625C14.4853 15.6042 15.1532 13.95 15.1532 12C15.1532 10.05 14.4853 8.39583 13.1495 7.0375C11.8137 5.67917 10.1871 5 8.26944 5C6.35184 5 4.72515 5.67917 3.38938 7.0375C2.05361 8.39583 1.38572 10.05 1.38572 12C1.38572 13.95 2.05361 15.6042 3.38938 16.9625C4.72515 18.3208 6.35184 19 8.26944 19Z", "fill", "white"], [1, "mb-3", "user"], ["class", "position-relative imgcontainer overflow-auto d-flex gap-3 w-100 pb-3", 4, "ngIf"], [1, "mb-3"], [1, "d-flex", "justify-content-end", "align-items-center", "gap-3"], [1, "like-div", "d-flex", "align-items-center"], [1, "like-button", "overflow-visible", 3, "click"], ["xmlns", "http://www.w3.org/2000/svg", "width", "21", "height", "19", "viewBox", "0 0 21 19", "fill", "none"], ["d", "M10.293 19L8.84297 17.7C7.15964 16.1834 5.76797 14.875 4.66797 13.775C3.56797 12.675 2.69297 11.6875 2.04297 10.8125C1.39297 9.93752 0.938802 9.13336 0.680469 8.40002C0.422135 7.66669 0.292969 6.91669 0.292969 6.15002C0.292969 4.58336 0.817969 3.27502 1.86797 2.22502C2.91797 1.17502 4.2263 0.650024 5.79297 0.650024C6.65964 0.650024 7.48464 0.833358 8.26797 1.20002C9.0513 1.56669 9.7263 2.08336 10.293 2.75002C10.8596 2.08336 11.5346 1.56669 12.318 1.20002C13.1013 0.833358 13.9263 0.650024 14.793 0.650024C16.3596 0.650024 17.668 1.17502 18.718 2.22502C19.768 3.27502 20.293 4.58336 20.293 6.15002C20.293 6.91669 20.1638 7.66669 19.9055 8.40002C19.6471 9.13336 19.193 9.93752 18.543 10.8125C17.893 11.6875 17.018 12.675 15.918 13.775C14.818 14.875 13.4263 16.1834 11.743 17.7L10.293 19ZM10.293 16.3C11.893 14.8667 13.2096 13.6375 14.243 12.6125C15.2763 11.5875 16.093 10.6959 16.693 9.93752C17.293 9.17919 17.7096 8.50419 17.943 7.91252C18.1763 7.32086 18.293 6.73336 18.293 6.15002C18.293 5.15002 17.9596 4.31669 17.293 3.65002C16.6263 2.98336 15.793 2.65002 14.793 2.65002C14.0096 2.65002 13.2846 2.87086 12.618 3.31252C11.9513 3.75419 11.493 4.31669 11.243 5.00002H9.34297C9.09297 4.31669 8.63464 3.75419 7.96797 3.31252C7.3013 2.87086 6.5763 2.65002 5.79297 2.65002C4.79297 2.65002 3.95964 2.98336 3.29297 3.65002C2.6263 4.31669 2.29297 5.15002 2.29297 6.15002C2.29297 6.73336 2.40964 7.32086 2.64297 7.91252C2.8763 8.50419 3.29297 9.17919 3.89297 9.93752C4.49297 10.6959 5.30964 11.5875 6.34297 12.6125C7.3763 13.6375 8.69297 14.8667 10.293 16.3Z", "fill", "white"], [1, "like-count"], [1, "share-div", "cursor-pointer", 3, "click"], ["id", "mask0_329_442", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "24", "height", "24", 2, "mask-type", "alpha"], ["mask", "url(#mask0_329_442)"], ["d", "M17 22C16.1667 22 15.4583 21.7083 14.875 21.125C14.2917 20.5417 14 19.8333 14 19C14 18.9 14.025 18.6667 14.075 18.3L7.05 14.2C6.78333 14.45 6.475 14.6458 6.125 14.7875C5.775 14.9292 5.4 15 5 15C4.16667 15 3.45833 14.7083 2.875 14.125C2.29167 13.5417 2 12.8333 2 12C2 11.1667 2.29167 10.4583 2.875 9.875C3.45833 9.29167 4.16667 9 5 9C5.4 9 5.775 9.07083 6.125 9.2125C6.475 9.35417 6.78333 9.55 7.05 9.8L14.075 5.7C14.0417 5.58333 14.0208 5.47083 14.0125 5.3625C14.0042 5.25417 14 5.13333 14 5C14 4.16667 14.2917 3.45833 14.875 2.875C15.4583 2.29167 16.1667 2 17 2C17.8333 2 18.5417 2.29167 19.125 2.875C19.7083 3.45833 20 4.16667 20 5C20 5.83333 19.7083 6.54167 19.125 7.125C18.5417 7.70833 17.8333 8 17 8C16.6 8 16.225 7.92917 15.875 7.7875C15.525 7.64583 15.2167 7.45 14.95 7.2L7.925 11.3C7.95833 11.4167 7.97917 11.5292 7.9875 11.6375C7.99583 11.7458 8 11.8667 8 12C8 12.1333 7.99583 12.2542 7.9875 12.3625C7.97917 12.4708 7.95833 12.5833 7.925 12.7L14.95 16.8C15.2167 16.55 15.525 16.3542 15.875 16.2125C16.225 16.0708 16.6 16 17 16C17.8333 16 18.5417 16.2917 19.125 16.875C19.7083 17.4583 20 18.1667 20 19C20 19.8333 19.7083 20.5417 19.125 21.125C18.5417 21.7083 17.8333 22 17 22ZM17 20C17.2833 20 17.5208 19.9042 17.7125 19.7125C17.9042 19.5208 18 19.2833 18 19C18 18.7167 17.9042 18.4792 17.7125 18.2875C17.5208 18.0958 17.2833 18 17 18C16.7167 18 16.4792 18.0958 16.2875 18.2875C16.0958 18.4792 16 18.7167 16 19C16 19.2833 16.0958 19.5208 16.2875 19.7125C16.4792 19.9042 16.7167 20 17 20ZM5 13C5.28333 13 5.52083 12.9042 5.7125 12.7125C5.90417 12.5208 6 12.2833 6 12C6 11.7167 5.90417 11.4792 5.7125 11.2875C5.52083 11.0958 5.28333 11 5 11C4.71667 11 4.47917 11.0958 4.2875 11.2875C4.09583 11.4792 4 11.7167 4 12C4 12.2833 4.09583 12.5208 4.2875 12.7125C4.47917 12.9042 4.71667 13 5 13ZM17 6C17.2833 6 17.5208 5.90417 17.7125 5.7125C17.9042 5.52083 18 5.28333 18 5C18 4.71667 17.9042 4.47917 17.7125 4.2875C17.5208 4.09583 17.2833 4 17 4C16.7167 4 16.4792 4.09583 16.2875 4.2875C16.0958 4.47917 16 4.71667 16 5C16 5.28333 16.0958 5.52083 16.2875 5.7125C16.4792 5.90417 16.7167 6 17 6Z", "fill", "white"], [1, "share-div", 2, "cursor", "pointer", 3, "routerLink", "queryParams"], ["id", "mask0_52684_2642", "maskUnits", "userSpaceOnUse", "x", "0", "y", "0", "width", "24", "height", "24", 2, "mask-type", "alpha"], ["mask", "url(#mask0_52684_2642)"], ["d", "M0 22V4C0 3.45 0.195833 2.97917 0.5875 2.5875C0.979167 2.19583 1.45 2 2 2H18C18.55 2 19.0208 2.19583 19.4125 2.5875C19.8042 2.97917 20 3.45 20 4V16C20 16.55 19.8042 17.0208 19.4125 17.4125C19.0208 17.8042 18.55 18 18 18H4L0 22ZM3.15 16H18V4H2V17.125L3.15 16Z", "fill", "white"], ["alt", "User", 1, "profile-imgg", "me-2", 3, "src"], [1, "profile-avatar", "rounded-circle", "me-2"], [1, "position-relative", "imgcontainer", "overflow-auto", "d-flex", "gap-3", "w-100", "pb-3"], [4, "ngFor", "ngForOf"], ["class", "img-fluid rounded", "alt", "Post Image", 3, "src", 4, "ngIf"], ["class", "img-fluid rounded", "controls", "", 3, "src", 4, "ngIf"], ["alt", "Post Image", 1, "img-fluid", "rounded", 3, "src"], ["controls", "", 1, "img-fluid", "rounded", 3, "src"], [1, "d-flex", "justify-content-center", "align-items-center", "mt-5", "pt-5"], [1, "col-sm-4"], [1, "d-flex", "flex-column", "gap-2", "align-items-center"], [4, "ngIf"], [1, "col-sm-8"], [1, "profile-details", "pt-3"], [1, "h6"], ["alt", "User", 1, "profile-pic", 3, "src"], [1, "text-center", "my-4"], ["class", "d-flex mb-3", 4, "ngFor", "ngForOf"], [1, "d-flex", "mb-3"], [1, "mb-1"]], template: function IasCreateshareComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(12, "svg", 10)(13, "mask", 11);
        \u0275\u0275element(14, "rect", 12);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(15, "g", 13);
        \u0275\u0275element(16, "path", 14);
        \u0275\u0275elementEnd()()()()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(17, "div", 15)(18, "div", 16)(19, "div", 17);
        \u0275\u0275element(20, "img", 18);
        \u0275\u0275elementStart(21, "div", 19)(22, "div", 20)(23, "span", 21);
        \u0275\u0275text(24, "Featured Post");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(25, "span", 22);
        \u0275\u0275text(26, "Trending");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(27, IasCreateshareComponent_ng_container_27_Template, 35, 19, "ng-container", 23)(28, IasCreateshareComponent_ng_template_28_Template, 3, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(30, "div", 24)(31, "div", 15)(32, "div", 25)(33, "div", 26);
        \u0275\u0275element(34, "img", 27);
        \u0275\u0275elementStart(35, "div", 19)(36, "div", 28);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(37, "svg", 10)(38, "mask", 29);
        \u0275\u0275element(39, "rect", 12);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(40, "g", 30);
        \u0275\u0275element(41, "path", 31);
        \u0275\u0275elementEnd()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(42, "span", 32);
        \u0275\u0275text(43, "Featured Profile");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(44, IasCreateshareComponent_div_44_Template, 21, 4, "div", 33)(45, IasCreateshareComponent_ng_template_45_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(47, "div", 34)(48, "div", 35)(49, "div", 36);
        \u0275\u0275element(50, "img", 37);
        \u0275\u0275elementStart(51, "div", 19)(52, "div", 38);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(53, "svg", 10)(54, "mask", 39);
        \u0275\u0275element(55, "rect", 12);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(56, "g", 40);
        \u0275\u0275element(57, "path", 41);
        \u0275\u0275elementEnd()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(58, "span", 32);
        \u0275\u0275text(59, "Recent Activities");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(60, IasCreateshareComponent_ng_container_60_Template, 3, 5, "ng-container", 23)(61, IasCreateshareComponent_ng_template_61_Template, 2, 0, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd()()()()()()()();
      }
      if (rf & 2) {
        const nopost_r6 = \u0275\u0275reference(29);
        const noFeaturedPost_r7 = \u0275\u0275reference(46);
        const noactivity_r8 = \u0275\u0275reference(62);
        \u0275\u0275advance(9);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(7, _c03));
        \u0275\u0275advance(18);
        \u0275\u0275property("ngIf", ctx.post)("ngIfElse", nopost_r6);
        \u0275\u0275advance(17);
        \u0275\u0275property("ngIf", ctx.featuredpost)("ngIfElse", noFeaturedPost_r7);
        \u0275\u0275advance(16);
        \u0275\u0275property("ngIf", ctx.posts)("ngIfElse", noactivity_r8);
      }
    }, dependencies: [RouterModule, RouterLink, CommonModule, NgForOf, NgIf, SlicePipe, TimeAgoPipe], styles: ['\n\n.ias-bg[_ngcontent-%COMP%] {\n  background: #15142b;\n  color: #fff;\n  padding-top: 60px;\n  padding-bottom: 60px;\n}\n.ias-label[_ngcontent-%COMP%] {\n  color: #fff;\n  font-family: "Urbanist";\n  font-size: 12px;\n  font-weight: 400;\n  line-height: normal;\n  text-transform: uppercase;\n}\n.seeall[_ngcontent-%COMP%] {\n  border-radius: 4px;\n  border: 1px solid #fff;\n  color: #fff;\n  background: transparent;\n  padding: 8px 20px;\n  display: inline-flex;\n  padding: 12px 24px;\n  font-family: Urbanist;\n  font-size: 16px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: 24px;\n  letter-spacing: 0.15px;\n}\n.add-post-btn[_ngcontent-%COMP%] {\n  border-radius: 4px;\n  border: 1px solid #fff;\n  background: #fff;\n  border-radius: 4px;\n  padding: 8px 20px;\n  display: inline-flex;\n  padding: 12px 24px;\n  justify-content: center;\n  align-items: center;\n  gap: 8px;\n  text-align: center;\n  font-family: Urbanist;\n  font-size: 16px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: 24px;\n  letter-spacing: 0.15px;\n}\n.card-Featured[_ngcontent-%COMP%] {\n  position: relative;\n  border-radius: 16px;\n  border: 1px solid rgba(101, 130, 255, 0.18);\n  background:\n    linear-gradient(\n      0deg,\n      #150f22 0%,\n      #1b112b 100%);\n  color: #fff;\n  overflow: hidden;\n  padding: 15px 15px 30px 15px;\n}\n.card-Featured[_ngcontent-%COMP%]   h5[_ngcontent-%COMP%] {\n  color: #fff;\n  font-family: Urbanist;\n  font-size: 17.682px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: 19.647px;\n  display: -webkit-box;\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.card-Featured[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  color: rgba(255, 255, 255, 0.52);\n  font-family: Urbanist;\n  font-size: 15.718px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: 19.647px;\n}\n.featurecardbg[_ngcontent-%COMP%] {\n  position: absolute;\n  bottom: 0px;\n  left: 0px;\n  z-index: 0;\n}\n.featureprofilebg[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 0px;\n  left: 0px;\n  z-index: 0;\n}\n.recentbg[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 0px;\n  right: 0px;\n  z-index: 0;\n}\n.z-1[_ngcontent-%COMP%] {\n  position: relative;\n  z-index: 1;\n}\n.imgcontainer[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 320px;\n}\n.imgcontainer[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  object-fit: cover;\n  border-radius: 16px;\n  height: 100%;\n  width: auto;\n}\n.user[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  color: #fff;\n  font-family: Urbanist;\n  font-size: 13.753px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: 19.647px;\n}\n.user[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: rgba(255, 255, 255, 0.37);\n  font-family: Urbanist;\n  font-size: 13.753px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: 19.647px;\n}\n.profile-imgg[_ngcontent-%COMP%] {\n  width: 26px;\n  height: 26px;\n  border-radius: 50%;\n  object-fit: cover;\n  border: 1px solid #fff;\n}\n.profile-avatar[_ngcontent-%COMP%] {\n  width: 26px;\n  height: 26px;\n  border-radius: 50%;\n  object-fit: cover;\n  border: 1px solid #fff;\n  background: rgba(255, 255, 255, 0.28);\n}\n.Featured-head[_ngcontent-%COMP%] {\n  color: #fff;\n  font-family: Urbanist;\n  font-size: 15.718px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: 19.647px;\n}\n.badge-trending[_ngcontent-%COMP%] {\n  border-radius: 18px;\n  border: 1px solid rgba(101, 130, 255, 0.4);\n  background: rgba(255, 255, 255, 0.22);\n  padding: 4px 12px;\n  color: #fff;\n  font-family: "Urbanist";\n  font-size: 14px;\n  font-style: normal;\n  font-weight: 500;\n}\n.Featuredtitle[_ngcontent-%COMP%] {\n  color: #fff;\n  font-family: Urbanist;\n  font-size: 22px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: 20px;\n}\n.profile-pic[_ngcontent-%COMP%] {\n  height: 160px;\n  width: 160px;\n  object-position: top;\n  border-radius: 50%;\n  object-fit: cover;\n}\n.profile-details[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  display: inline-block;\n  min-width: 70px;\n}\n.profile-details[_ngcontent-%COMP%]   .h6[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: start;\n  gap: 10px;\n  color: #c7c7c7;\n  font-family: Urbanist;\n  font-size: 18px;\n  font-style: normal;\n  margin-bottom: 0;\n  font-weight: 500;\n  line-height: 20px;\n  margin-bottom: 20px;\n}\n.profile-details[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  color: rgba(255, 255, 255, 0.63);\n  font-family: Urbanist;\n  font-size: 14px;\n  font-style: normal;\n  font-weight: 500;\n  line-height: 20px;\n}\n.girlimg[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 100%;\n  max-height: 260px;\n  object-fit: cover;\n  object-position: center;\n  border-radius: 16px;\n}\n@media (max-width: 1200px) {\n  .profile-pic[_ngcontent-%COMP%] {\n    height: 130px;\n    width: 130px;\n    object-position: top;\n    border-radius: 50%;\n    object-fit: cover;\n  }\n}\n/*# sourceMappingURL=ias-createshare.component.css.map */'] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(IasCreateshareComponent, { className: "IasCreateshareComponent", filePath: "src/app/website/components/ias-createshare/ias-createshare.component.ts", lineNumber: 17 });
})();

// src/app/website/components/news-slider/news-slider.component.ts
function NewsSliderComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(title_r1.title);
  }
}
var NewsSliderComponent = class _NewsSliderComponent {
  ...
  startAutoSlide() {
    this.autoSlideInterval = setInterval(() => this.nextSlide(), 5e3);
  }
  fetchNews() {
  ...
  static {
    this.\u0275fac = function NewsSliderComponent_Factory(t) {
      return new (t || _NewsSliderComponent)(\u0275\u0275directiveInject(PLATFORM_ID), \u0275\u0275directiveInject(HttpClient));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewsSliderComponent, selectors: [["app-news-slider"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 11, vars: 3, consts: [[1, "news-slider"], [1, "container", "position-relative"], [1, "arrow", "left", 3, "click"], ["_ngcontent-ng-c3725126013", "", "xmlns", "http://www.w3.org/2000/svg", "width", "10", "height", "18", "viewBox", "0 0 10 18", "fill", "none"], ["_ngcontent-ng-c3725126013", "", "d", "M8.19444 17.5507L0 8.99994L8.19444 0.449219L9.64896 1.96697L2.90903 8.99994L9.64896 16.0329L8.19444 17.5507Z", "fill", "#222222"], [1, "slider-wrapper"], [1, "slider"], ["class", "slide", 4, "ngFor", "ngForOf"], [1, "arrow", "right", 3, "click"], ["_ngcontent-ng-c3725126013", "", "xmlns", "http://www.w3.org/2000/svg", "width", "11", "height", "18", "viewBox", "0 0 11 18", "fill", "none"], ["_ngcontent-ng-c3725126013", "", "d", "M2.13893 17.5507L10.3334 8.99994L2.13893 0.449219L0.684416 1.96697L7.42435 8.99994L0.684416 16.0329L2.13893 17.5507Z", "fill", "#222222"], [1, "slide"], [3, "routerLink"]], template: function NewsSliderComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "button", 2);
        \u0275\u0275listener("click", function NewsSliderComponent_Template_button_click_2_listener() {
        ...
        \u0275\u0275template(7, NewsSliderComponent_div_7_Template, 3, 2, "div", 7);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(8, "button", 8);
        \u0275\u0275listener("click", function NewsSliderComponent_Template_button_click_8_listener() {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275styleProp("transform", "translateX(-" + ctx.currentIndex * 100 + "%)");
        \u0275\u0275advance();
        \u0275\u0275property("ngForOf", ctx.newsList);
      }
    }, dependencies: [CommonModule, NgForOf, RouterLink], styles: ['\n\n.news-slider[_ngcontent-%COMP%] {\n  margin: auto;\n  overflow: hidden;\n  text-align: center;\n  background: #150F22;\n}\n.slider-wrapper[_ngcontent-%COMP%] {\n  overflow: hidden;\n  position: relative;\n}\n.slider-wrapper[_ngcontent-%COMP%]::before, .slider-wrapper[_ngcontent-%COMP%]::after {\n  content: "";\n  position: absolute;\n  top: 0;\n  width: 50px;\n  height: 100%;\n  z-index: 2;\n  pointer-events: none;\n}\n.slider-wrapper[_ngcontent-%COMP%]::before {\n  left: 0;\n  background:\n    linear-gradient(\n      to right,\n      #150F22 0%,\n      transparent 100%);\n}\n.slider-wrapper[_ngcontent-%COMP%]::after {\n  right: 0;\n  background:\n    linear-gradient(\n      to left,\n      #150F22 0%,\n      transparent 100%);\n}\n.slider[_ngcontent-%COMP%] {\n  display: flex;\n  transition: transform 0.5s ease-in-out;\n}\n.slide[_ngcontent-%COMP%] {\n  min-width: 100%;\n  padding: 12px 0px;\n  margin: 0px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.slide[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n  margin: 0;\n  color: #fff;\n  font-family: "Urbanist", sans-serif;\n  font-size: 14px;\n  font-weight: 400;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  cursor: pointer;\n}\n.arrow[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  border: none;\n  color: white;\n  cursor: pointer;\n  z-index: 2;\n  background: none;\n}\n.arrow[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%]   path[_ngcontent-%COMP%] {\n  fill: #fff;\n}\n.arrow.left[_ngcontent-%COMP%] {\n  left: 0px;\n}\n.arrow.right[_ngcontent-%COMP%] {\n  right: 0px;\n}\n.pagination[_ngcontent-%COMP%] {\n  margin-top: 10px;\n}\n.pagination[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  display: inline-block;\n  width: 10px;\n  height: 10px;\n  margin: 0 4px;\n  background: #ccc;\n  border-radius: 50%;\n  cursor: pointer;\n}\n.pagination[_ngcontent-%COMP%]   span.active[_ngcontent-%COMP%] {\n  background: #333;\n}\n@media (max-width: 1190px) {\n  .slide[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n    font-size: 1rem;\n    max-width: 70%;\n  }\n  .slider-wrapper[_ngcontent-%COMP%]::before, .slider-wrapper[_ngcontent-%COMP%]::after {\n    width: 30px;\n  }\n}\n@media (max-width: 768px) {\n  .slide[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n    font-size: 1rem;\n    max-width: 80%;\n  }\n  .slider-wrapper[_ngcontent-%COMP%]::before, .slider-wrapper[_ngcontent-%COMP%]::after {\n    width: 30px;\n  }\n}\n@media (max-width: 480px) {\n  .slide[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n    font-size: 0.9rem;\n    max-width: 70%;\n  }\n  .arrow[_ngcontent-%COMP%] {\n    width: 24px;\n    height: 24px;\n  }\n  .slider-wrapper[_ngcontent-%COMP%]::before, .slider-wrapper[_ngcontent-%COMP%]::after {\n    width: 20px;\n  }\n}\n/*# sourceMappingURL=news-slider.component.css.map */'] });
  }
};
(() => {
...
var IasDonateComponent = class _IasDonateComponent {
  ...
  removeDecimal(event) {
    ...
    if (value.length > 7) {
      ...
      this.donationAmount = parseInt(event.target.value, 10);
      return;
    }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _IasDonateComponent, selectors: [["app-ias-donate"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 42, vars: 2, consts: [[1, "main-cta-div"], [1, "container"], [1, "main-payment-div", "d-flex", "position-relative"], [1, "left-side-cont-div", "w-50", "d-flex", "flex-column", "align-items-start", "justify-content-center"], [1, "type-div", "d-flex", "align-items-center", "gap-4", "mb-4"], [1, "type"], ["xmlns", "http://www.w3.org/2000/svg", "width", "8", "height", "12", "viewBox", "0 0 8 12", "fill", "none"], ["d", "M5.15 12L0.666667 7.33333V6H3C3.58889 6 4.09722 5.80833 4.525 5.425C4.95278 5.04167 5.21111 4.56667 5.3 4H0V2.66667H5.1C4.91111 2.27778 4.63056 1.95833 4.25833 1.70833C3.88611 1.45833 3.46667 1.33333 3 1.33333H0V0H8V1.33333H5.83333C5.98889 1.52222 6.12778 1.72778 6.25 1.95C6.37222 2.17222 6.46667 2.41111 6.53333 2.66667H8V4H6.65C6.56111 4.94444 6.17222 5.73611 5.48333 6.375C4.79445 7.01389 3.96667 7.33333 3 7.33333H2.51667L7 12H5.15Z", "fill", "white"], ["xmlns", "http://www.w3.org/2000/svg", "width", "14", "height", "14", "viewBox", "0 0 14 14", "fill", "none"], ["d", "M7.95 5.65L5.11667 2.81667L6.06667 1.88333L7.95 3.76667L11.7333 0L12.6667 0.933333L7.95 5.65ZM4 10.6167L8.63333 11.8833L12.6 10.65C12.5444 10.55 12.4639 10.4639 12.3583 10.3917C12.2528 10.3194 12.1333 10.2833 12 10.2833H8.63333C8.33333 10.2833 8.09444 10.2722 7.91667 10.25C7.73889 10.2278 7.55556 10.1833 7.36667 10.1167L5.81667 9.6L6.18333 8.3L7.53333 8.75C7.72222 8.80556 7.94444 8.85 8.2 8.88333C8.45556 8.91667 8.83333 8.93889 9.33333 8.95C9.33333 8.82778 9.29722 8.71111 9.225 8.6C9.15278 8.48889 9.06667 8.41667 8.96667 8.38333L5.06667 6.95H4V10.6167ZM0 12.95V5.61667H5.06667C5.14444 5.61667 5.22222 5.625 5.3 5.64167C5.37778 5.65833 5.45 5.67778 5.51667 5.7L9.43333 7.15C9.8 7.28333 10.0972 7.51667 10.325 7.85C10.5528 8.18333 10.6667 8.55 10.6667 8.95H12C12.5556 8.95 13.0278 9.13333 13.4167 9.5C13.8056 9.86667 14 10.35 14 10.95V11.6167L8.66667 13.2833L4 11.9833V12.95H0ZM1.33333 11.6167H2.66667V6.95H1.33333V11.6167Z", "fill", "white"], ["xmlns", "http://www.w3.org/2000/svg", "width", "16", "height", "8", "viewBox", "0 0 16 8", "fill", "none"], ["d", "M3.66667 7.33333C2.64444 7.33333 1.77778 6.97778 1.06667 6.26667C0.355556 5.55556 0 4.68889 0 3.66667C0 2.64444 0.355556 1.77778 1.06667 1.06667C1.77778 0.355556 2.64444 0 3.66667 0C4.07778 0 4.47222 0.0722222 4.85 0.216667C5.22778 0.361111 5.56667 0.566667 5.86667 0.833333L7 1.86667L6 2.76667L4.96667 1.83333C4.78889 1.67778 4.58889 1.55556 4.36667 1.46667C4.14444 1.37778 3.91111 1.33333 3.66667 1.33333C3.02222 1.33333 2.47222 1.56111 2.01667 2.01667C1.56111 2.47222 1.33333 3.02222 1.33333 3.66667C1.33333 4.31111 1.56111 4.86111 2.01667 5.31667C2.47222 5.77222 3.02222 6 3.66667 6C3.91111 6 4.14444 5.95556 4.36667 5.86667C4.58889 5.77778 4.78889 5.65556 4.96667 5.5L10.1333 0.833333C10.4333 0.566667 10.7722 0.361111 11.15 0.216667C11.5278 0.0722222 11.9222 0 12.3333 0C13.3556 0 14.2222 0.355556 14.9333 1.06667C15.6444 1.77778 16 2.64444 16 3.66667C16 4.68889 15.6444 5.55556 14.9333 6.26667C14.2222 6.97778 13.3556 7.33333 12.3333 7.33333C11.9222 7.33333 11.5278 7.26111 11.15 7.11667C10.7722 6.97222 10.4333 6.76667 10.1333 6.5L9 5.46667L10 4.56667L11.0333 5.5C11.2111 5.65556 11.4111 5.77778 11.6333 5.86667C11.8556 5.95556 12.0889 6 12.3333 6C12.9778 6 13.5278 5.77222 13.9833 5.31667C14.4389 4.86111 14.6667 4.31111 14.6667 3.66667C14.6667 3.02222 14.4389 2.47222 13.9833 2.01667C13.5278 1.56111 12.9778 1.33333 12.3333 1.33333C12.0889 1.33333 11.8556 1.37778 11.6333 1.46667C11.4111 1.55556 11.2111 1.67778 11.0333 1.83333L5.86667 6.5C5.56667 6.76667 5.22778 6.97222 4.85 7.11667C4.47222 7.26111 4.07778 7.33333 3.66667 7.33333Z", "fill", "white"], [1, "btn", "btn-white", 3, "click"], [1, "right-sidegradient-div", "w-50", "overflow-hidden", "position-relative"], ["src", "../../../../assets/images/make-image.png", "alt", "ias logo", 1, "position-absolute", "w-100", "donate-img"], ["id", "donationModal", "tabindex", "-1", "aria-labelledby", "donationModalLabel", "aria-hidden", "true", 1, "modal", "fade"], [1, "modal-dialog", "modal-dialog-centered"], [1, "modal-content"], [1, "modal-body"], ["id", "donationModalLabel", 1, "modal-title", "mb-4"], [1, "form-label"], ["type", "number", "placeholder", "Enter amount", "min", "1", "step", "1", 1, "form-control", 3, "ngModelChange", "keydown", "input", "ngModel"], [1, "modal-footer"], ["data-bs-dismiss", "modal", 1, "btn", "btn-black"], [1, "btn", "btn-donate", 3, "click", "disabled"]], template: function IasDonateComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275listener("keydown", function IasDonateComponent_Template_input_keydown_36_listener($event) {
          return ctx.blockInvalidKeys($event);
        })("input", function IasDonateComponent_Template_input_input_36_listener($event) {
          return ctx.removeDecimal($event);
        });
        \u0275\u0275elementEnd()();
...
var IasHomepageComponent = class _IasHomepageComponent {
  ...
  ngOnInit() {
    ...
    this.titleService.setTitle("IASCA Portal - Webpage");
    this.meta.addTags([
      { name: "description", content: "Join the IASCA community. Explore events, initiatives, foundation activities, monthly meets, and more." },
      { property: "og:title", content: "IASCA Portal - Community Home" },
      { property: "og:description", content: "Explore the IAS community privileges, initiatives, and foundation activities." },
  ...
  static {
    this.\u0275fac = function IasHomepageComponent_Factory(t) {
      return new (t || _IasHomepageComponent)(\u0275\u0275directiveInject(Meta), \u0275\u0275directiveInject(Title), \u0275\u0275directiveInject(Router));
    };
  }
  static {
...
//# sourceMappingURL=chunk-WJH62BRN.mjs.map
