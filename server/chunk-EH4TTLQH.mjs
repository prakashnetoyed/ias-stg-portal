...
function UserMembersComponent_tr_23_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", user_r1.mobileNumber ? user_r1.mobileNumber.slice(0, 4) + "****" + user_r1.mobileNumber.slice(-2) : "N/A", " ");
    \u0275\u0275advance(2);
...
var UserMembersComponent = class _UserMembersComponent {
  ...
  loadUsers(page = this.currentPage, limit = this.pageSize) {
    ...
    this.http.get(`${environment.apiUrl}/admin/users?isActive=true&page=${page}&limit=${limit}`, { headers }).subscribe({
      next: (res) => {
        console.log(res);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserMembersComponent, selectors: [["app-user-members"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 42, vars: 10, consts: [[1, "tableheading"], [1, "d-flex", "justify-content-between", "align-items-center", "flex-wrap", "mb-3"], [1, "mb-1"], [1, "table-responsive", "custom-table"], [1, "table", "align-middle", "mb-0"], [4, "ngFor", "ngForOf"], [1, "d-flex", "justify-content-end", "align-items-center", "gap-2", "mt-3"], [1, "pagination", "modern-pagination", "mb-0"], [1, "page-item"], [1, "page-link", 3, "click"], ["class", "page-item", 4, "ngFor", "ngForOf"], [1, "d-flex", "align-items-center"], [1, "form-select", "form-select-sm", "w-auto", 3, "change"], ["value", "5", 3, "selected"], ["value", "10", 3, "selected"], ["value", "20", 3, "selected"], ["alt", "profile pic", 1, "tableprofile", 3, "src"]], template: function UserMembersComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(3);
        \u0275\u0275property("ngForOf", \u0275\u0275pureFunction0(9, _c0).constructor(ctx.totalPages));
        \u0275\u0275advance();
...
//# sourceMappingURL=chunk-EH4TTLQH.mjs.map
