...
var UserNotApprovedLayoutComponent = class _UserNotApprovedLayoutComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserNotApprovedLayoutComponent, selectors: [["app-user-not-approved-layout"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 13, vars: 1, consts: [[1, "not-found-container"], [1, "not-found-content"], [1, "error-code"], [1, "error-title"], [1, "error-message"], [1, "actions"], [1, "btn-donate", 3, "routerLink"]], template: function UserNotApprovedLayoutComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=chunk-5Y7XKS36.mjs.map
