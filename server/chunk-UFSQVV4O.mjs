...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "community",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-7RJDZVAY.mjs").then((m) => m.IasCommunityComponent)
      },
      {
        path: "post",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-HRMHVGQE.mjs").then((m) => m.PostComponent)
      },
      {
        path: "caruna",
      ...
      },
      {
        path: "membership",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-UIX3OTDW.mjs").then((m) => m.CombinedMemberPageComponent)
      },
      {
  ...
  },
  {
    ...
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-P6WUWHPC.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-6I5PWL2I.mjs").then((m) => m.UserDashboardComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-M6T62HHL.mjs").then((m) => m.UserHomeComponent)
      },
      {
        path: "user-profile",
        loadComponent: () => import("./chunk-LCYDM3GV.mjs").then((m) => m.UserProfileComponent)
      },
      {
        path: "user-events",
        loadComponent: () => import("./chunk-652CXNST.mjs").then((m) => m.UserEventsComponent)
      },
      {
        path: "user-membership",
        loadComponent: () => import("./chunk-ZKGLYLIL.mjs").then((m) => m.UserMembershipComponent)
      },
      {
        path: "user-members",
        loadComponent: () => import("./chunk-OLSZQQU6.mjs").then((m) => m.UserMembersComponent)
      },
      {
        path: "user-transactions",
        loadComponent: () => import("./chunk-B3GPJ6Z2.mjs").then((m) => m.MyTransactionsComponent)
      },
      {
        path: "payment-status",
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-UFSQVV4O.mjs.map
