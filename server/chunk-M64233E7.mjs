...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "contact-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-PTHX7KSA.mjs").then((m) => m.IasContactusComponent)
      },
      {
        path: "community",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "all-members",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-TL7GWURW.mjs").then((m) => m.AllMembersComponent)
      },
      {
        path: "news-blogs",
        // component:IasHomepageComponent,
  ...
  },
  {
    ...
    canActivate: [authGuard],
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-SILYXKAX.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-YNLF5M7P.mjs").then((m) => m.UserMembershipComponent)
      },
      {
        path: "user-members",
        loadComponent: () => import("./chunk-6OAZ734N.mjs").then((m) => m.UserMembersComponent)
      },
      {
