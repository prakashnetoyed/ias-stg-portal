...
var _c0 = ["errorToast"];
var _c1 = () => [];
function UserDonationsComponent_tr_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(14, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "td")(16, "div", 24)(17, "button", 25);
    \u0275\u0275listener("click", function UserDonationsComponent_tr_31_Template_button_click_17_listener() {
      const user_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.downloadReceipt(user_r3));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(18, "svg", 26)(19, "mask", 27);
    \u0275\u0275element(20, "rect", 28);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "g", 29);
    \u0275\u0275element(22, "path", 30);
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(user_r3.createdBy == null ? null : user_r3.createdBy.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(user_r3.orderNumber);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", user_r3.status === "success" ? "success" : "Undefined");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", user_r3.status, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(user_r3.amount);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(14, 7, user_r3.createdAt, "dd MMM yyyy, h:mm a"));
  }
}
function UserDonationsComponent_li_38_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 15)(1, "a", 16);
    \u0275\u0275listener("click", function UserDonationsComponent_li_38_Template_a_click_1_listener() {
...
var UserDonationsComponent = class _UserDonationsComponent {
  constructor(fb, http) {
    this.fb = fb;
    this.http = http;
    this.users = [];
  ...
  fetchtransactions(page = 1, limit = this.pageSize) {
    this.http.get(`${environment.apiUrl}/donations?page=${page}&limit=${limit}`).subscribe({
      next: (res) => {
      ...
      error: (err) => {
        this.showErrorToast("Failed to fetch Transactions");
      }
    });
  }
  // ✅ Pagination controls
  ...
  downloadReceipt(tx) {
    ...
    doc.text(`${user?.name || "N/A"}`, 14, 45);
    doc.text(`${user?.email || "N/A"}`, 14, 51);
    doc.text(`${user?.mobileNumber || "N/A"}`, 14, 57);
    const rightX = 120;
    doc.text(`Member ID: ${user?.memberShipId || "N/A"}`, rightX, 38);
    doc.text(`Designation: ${user?.designation || "N/A"}`, rightX, 45);
    doc.text(`Status: ${tx?.status || "N/A"}`, rightX, 52);
    doc.text(`Payment Date: ${tx?.createdAt ? new Date(tx.createdAt).toLocaleString() : "N/A"}`, rightX, 59);
    doc.setFontSize(10);
    doc.text(`Order Number: ${tx?.orderNumber || "N/A"}`, 14, 72);
    let posY = 90;
    ...
    doc.text("This is a system-generated receipt. For any queries, please contact IASCA.", 105, 285, { align: "center" });
    doc.save(`Receipt_${tx?.orderNumber}.pdf`);
  }
  // ✅ Toast methods
  ...
  static {
    this.\u0275fac = function UserDonationsComponent_Factory(t) {
      return new (t || _UserDonationsComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(HttpClient));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserDonationsComponent, selectors: [["app-user-donations"]], viewQuery: function UserDonationsComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c0, 5);
      }
      if (rf & 2) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275template(31, UserDonationsComponent_tr_31_Template, 23, 10, "tr", 12);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(32, "div", 13)(33, "nav")(34, "ul", 14)(35, "li", 15)(36, "a", 16);
        \u0275\u0275listener("click", function UserDonationsComponent_Template_a_click_36_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goPrevious());
        });
        \u0275\u0275text(37, "\u2039");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(38, UserDonationsComponent_li_38_Template, 3, 3, "li", 17);
        \u0275\u0275elementStart(39, "li", 15)(40, "a", 16);
        \u0275\u0275listener("click", function UserDonationsComponent_Template_a_click_40_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goNext());
        });
        \u0275\u0275text(41, "\u203A");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(42, "div", 18)(43, "select", 19);
        \u0275\u0275listener("change", function UserDonationsComponent_Template_select_change_43_listener($event) {
          \u0275\u0275restoreView(_r1);
