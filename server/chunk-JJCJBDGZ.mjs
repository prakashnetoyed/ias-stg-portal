...
var CaseStudiesComponent = class _CaseStudiesComponent {
  ...
  fetchNews(page = 1, limit = this.pageSize) {
    this.http.get(`${environment.apiUrl}/case-study?page=${page}&limit=${limit}`).subscribe({
      next: (res) => {
      ...
      error: (err) => {
        ...
        this.showErrorToast("Failed to fetch Case Study");
      }
    });
  }
  // ✅ Pagination controls
  ...
  onSubmit() {
    ...
    const payload = {
      ...
      caseStudyLink: formValue.newsLink,
      description: formValue.description,
      bannerImage: formValue.bannerImage
    };
    this.http.post(`${environment.apiUrl}/case-study`, payload).subscribe({
      next: (res) => {
        this.showSuccessToast("Case Study submitted successfully!");
        this.newsForm.reset();
        this.previewUrl = null;
        this.base64Image = null;
        this.fetchNews(this.currentPage, this.pageSize);
      ...
      error: (err) => {
        this.showErrorToast("Failed to submit Case Study. Please try again.");
  ...
  deleteNews(id) {
    if (!confirm("Are you sure you want to delete this Case Study?"))
      return;
    this.http.delete(`${environment.apiUrl}/case-study/${id}`).subscribe({
      next: () => {
        this.showSuccessToast("Case Study deleted successfully!");
        this.users = this.users.filter((user) => user.id !== id);
      },
      error: (err) => {
        console.error("Delete failed:", err);
        this.showErrorToast("Failed to delete Case Study. Please try again.");
      }
    });
  }
  static {
    this.\u0275fac = function CaseStudiesComponent_Factory(t) {
      return new (t || _CaseStudiesComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(HttpClient));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CaseStudiesComponent, selectors: [["app-case-studies"]], viewQuery: function CaseStudiesComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c0, 5);
      }
      if (rf & 2) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275text(17, "Case Study");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(18, "div", 17)(19, "button", 18);
        \u0275\u0275text(20, " Add Case Study ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(21, "div", 19)(22, "div", 20)(23, "h5", 21);
        \u0275\u0275text(24, "Add Case Study");
        \u0275\u0275elementEnd();
        \u0275\u0275element(25, "button", 22);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(26, "div", 23)(27, "form", 24);
        \u0275\u0275listener("ngSubmit", function CaseStudiesComponent_Template_form_ngSubmit_27_listener() {
          \u0275\u0275restoreView(_r1);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CaseStudiesComponent, { className: "CaseStudiesComponent", filePath: "src/app/IAS-portal/pages/case-studies/case-studies.component.ts", lineNumber: 14 });
})();
export {
  CaseStudiesComponent
};
//# sourceMappingURL=chunk-JJCJBDGZ.mjs.map
