...
var routes = [
    ...
    children: [
      {
        ...
        loadComponent: () => import("./chunk-7DWCDKSL.mjs").then((m) => m.IasHomepageComponent)
      },
      {
        path: "about-us",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "contact-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-BZ3FQNQI.mjs").then((m) => m.IasContactusComponent)
      },
      {
        path: "community",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "post",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-54HHS3O3.mjs").then((m) => m.PostComponent)
      },
      {
        path: "caruna",
      ...
      },
      {
        path: "readmoreblogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-5HBHRY5B.mjs").then((m) => m.ReadmoreBlogsComponent)
      },
      {
        path: "membership",
        // component:IasHomepageComponent,
  ...
  },
  {
    ...
    canActivate: [authGuard],
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-IQ2E4XN7.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-P4UBCN4Z.mjs").then((m) => m.DashboardComponent)
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-7UFEG4XI.mjs").then((m) => m.ProfileInfoComponent)
      },
      {
        path: "publications",
        loadComponent: () => import("./chunk-RZZYEDS5.mjs").then((m) => m.PublicationsComponent)
      },
      {
        path: "blogs",
        loadComponent: () => import("./chunk-7KNXDR7X.mjs").then((m) => m.BlogsComponent)
      },
      {
        path: "news",
        loadComponent: () => import("./chunk-UBP4OKXU.mjs").then((m) => m.NewsComponent)
      },
      {
        path: "case-study",
      ...
      {
        path: "mom",
        loadComponent: () => import("./chunk-76E343MT.mjs").then((m) => m.MoMComponent)
      },
      {
        path: "feedbacks",
        loadComponent: () => import("./chunk-E4IJGF5A.mjs").then((m) => m.FeedbacksComponent)
      },
      {
        path: "my-transaction",
        loadComponent: () => import("./chunk-7XQFY2UP.mjs").then((m) => m.MyTransactionComponent)
      },
      {
        path: "approved-user",
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-IAVCHIQZ.mjs").then((m) => m.NotApprovedUserComponent)
      },
      {
        path: "rejected-user",
      ...
      {
        path: "donation",
        loadComponent: () => import("./chunk-SPVXUXTW.mjs").then((m) => m.DonationsComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-B25TS4QI.mjs").then((m) => m.UserDashboardComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-Q3M5BAUG.mjs").then((m) => m.UserHomeComponent)
      },
      {
        path: "user-profile",
        loadComponent: () => import("./chunk-ZNBWRBUK.mjs").then((m) => m.UserProfileComponent)
      },
      {
        path: "user-events",
      ...
      {
        path: "user-members",
        loadComponent: () => import("./chunk-MJE2ZQYY.mjs").then((m) => m.UserMembersComponent)
      },
      {
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-IISB6N7I.mjs").then((m) => m.StateDashboardLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-AB6ER233.mjs").then((m) => m.StateAboutUsComponent)
      },
      {
        path: "state-news",
        loadComponent: () => import("./chunk-CML4756F.mjs").then((m) => m.StateNewsComponent)
      },
      {
        path: "state-events",
        loadComponent: () => import("./chunk-ZJ2S6IE4.mjs").then((m) => m.StateEventsComponent)
      },
      {
        path: "state-office-bearers",
        loadComponent: () => import("./chunk-THCOKMV5.mjs").then((m) => m.StateOfficeBearersComponent)
      },
      {
        path: "state-gallery",
        loadComponent: () => import("./chunk-N6RJG3UP.mjs").then((m) => m.StateGalleryComponent)
      }
    ]
  },
  {
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-KK6C6Q7S.mjs.map
