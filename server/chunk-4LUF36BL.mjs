...
var _c1 = ["errorToast"];
function ProfileInfoComponent_div_14__svg_svg_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 43)(1, "g", 44);
    \u0275\u0275element(2, "path", 45);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "defs")(4, "clipPath", 46);
    \u0275\u0275element(5, "rect", 47);
    \u0275\u0275elementEnd()()();
  }
}
function ProfileInfoComponent_div_14__svg_svg_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 43)(1, "g", 48);
    \u0275\u0275element(2, "path", 49);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "defs")(4, "clipPath", 50);
    \u0275\u0275element(5, "rect", 47);
    \u0275\u0275elementEnd()()();
  }
}
function ProfileInfoComponent_div_14_div_23_span_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ProfileInfoComponent_div_14_div_23_span_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function ProfileInfoComponent_div_14_div_23_span_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function ProfileInfoComponent_div_14_div_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 51);
    \u0275\u0275template(1, ProfileInfoComponent_div_14_div_23_span_1_Template, 2, 0, "span", 52)(2, ProfileInfoComponent_div_14_div_23_span_2_Template, 2, 0, "span", 52)(3, ProfileInfoComponent_div_14_div_23_span_3_Template, 2, 0, "span", 52);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
...
function ProfileInfoComponent_div_14__svg_svg_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 43)(1, "g", 44);
    \u0275\u0275element(2, "path", 45);
...
function ProfileInfoComponent_div_14__svg_svg_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 43)(1, "g", 48);
    \u0275\u0275element(2, "path", 49);
...
function ProfileInfoComponent_div_14_div_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 51);
...
function ProfileInfoComponent_div_14_div_84_Template(rf, ctx) {
  if (rf & 1) {
...
function ProfileInfoComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(7, "div", 13)(8, "div", 14)(9, "h5", 15);
    \u0275\u0275text(10, "Change Password");
    \u0275\u0275elementEnd();
    \u0275\u0275element(11, "button", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 17)(13, "form", 18);
    \u0275\u0275listener("ngSubmit", function ProfileInfoComponent_div_14_Template_form_ngSubmit_13_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function ProfileInfoComponent_div_14_Template_button_click_20_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleNewPassword());
    });
    \u0275\u0275template(21, ProfileInfoComponent_div_14__svg_svg_21_Template, 6, 0, "svg", 25)(22, ProfileInfoComponent_div_14__svg_svg_22_Template, 6, 0, "svg", 25);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(23, ProfileInfoComponent_div_14_div_23_Template, 4, 3, "div", 26);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ProfileInfoComponent_div_14_Template_button_click_29_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleConfirmPassword());
    });
    \u0275\u0275template(30, ProfileInfoComponent_div_14__svg_svg_30_Template, 6, 0, "svg", 25)(31, ProfileInfoComponent_div_14__svg_svg_31_Template, 6, 0, "svg", 25);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(32, ProfileInfoComponent_div_14_div_32_Template, 2, 0, "div", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "div", 28);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(34, "svg", 29);
    \u0275\u0275element(35, "path", 30);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(36, "p");
    ...
    \u0275\u0275text(42, " Submit ");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(43, "div", 34)(44, "div", 35);
    \u0275\u0275element(45, "img", 36);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "div", 37)(47, "div", 38)(48, "h2");
    \u0275\u0275text(49, "Personal Information");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "div", 39)(51, "div", 40)(52, "span");
    \u0275\u0275text(53, "Name: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "h5");
    \u0275\u0275text(55);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(56, "div", 40)(57, "span");
    \u0275\u0275text(58, "Gender: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(59, "h5");
    \u0275\u0275text(60);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(61, "div", 40)(62, "span");
    \u0275\u0275text(63, "DOB: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "h5");
    \u0275\u0275text(65);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(66, "div", 38)(67, "h2");
    \u0275\u0275text(68, "Contact Details");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(69, "div", 39)(70, "div", 41)(71, "span");
    \u0275\u0275text(72, "E- Mail: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(73, "h5");
    \u0275\u0275text(74);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(79);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(80, "div", 38)(81, "h2");
    \u0275\u0275text(82, "Place Of Domicile");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(83, "div", 39);
    \u0275\u0275template(84, ProfileInfoComponent_div_14_div_84_Template, 5, 1, "div", 42);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    let tmp_7_0;
    ...
    \u0275\u0275property("ngIf", ctx_r1.showNewPassword);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ((tmp_7_0 = ctx_r1.changepassword.get("newPassword")) == null ? null : tmp_7_0.touched) && ((tmp_7_0 = ctx_r1.changepassword.get("newPassword")) == null ? null : tmp_7_0.invalid));
    \u0275\u0275advance(5);
    ...
    \u0275\u0275property("ngIf", ctx_r1.showConfirmPassword);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.changepassword.hasError("passwordMismatch") && ((tmp_11_0 = ctx_r1.changepassword.get("confirmPassword")) == null ? null : tmp_11_0.touched));
    \u0275\u0275advance(9);
    \u0275\u0275property("disabled", ctx_r1.changepassword.invalid);
    \u0275\u0275advance(4);
...
var ProfileInfoComponent = class _ProfileInfoComponent {
  ...
  static {
    this.\u0275fac = function ProfileInfoComponent_Factory(t) {
      return new (t || _ProfileInfoComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(UserService), \u0275\u0275directiveInject(HttpClient));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProfileInfoComponent, selectors: [["app-profile-info"]], viewQuery: function ProfileInfoComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(14, ProfileInfoComponent_div_14_Template, 85, 17, "div", 8);
      }
      if (rf & 2) {
        \u0275\u0275advance(14);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProfileInfoComponent, { className: "ProfileInfoComponent", filePath: "src/app/IAS-portal/pages/profile-info/profile-info.component.ts", lineNumber: 18 });
})();
export {
  ProfileInfoComponent
};
//# sourceMappingURL=chunk-4LUF36BL.mjs.map
