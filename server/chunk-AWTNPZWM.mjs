...
function MyTransactionsComponent_tbody_20_tr_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "td", 5)(13, "p", 12);
    \u0275\u0275listener("click", function MyTransactionsComponent_tbody_20_tr_1_Template_p_click_13_listener() {
      const tx_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.downloadReceipt(tx_r2));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(14, "svg", 13)(15, "mask", 14);
    \u0275\u0275element(16, "rect", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "g", 16);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(6, _c0, tx_r2.transaction_status == "200", tx_r2.transaction_status != "200"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", tx_r2 == null ? null : tx_r2.message, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Rs ", tx_r2 == null ? null : tx_r2.amount, "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((tx_r2 == null ? null : tx_r2.transaction_time) || "N/A");
  }
}
function MyTransactionsComponent_tbody_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tbody", 8);
    \u0275\u0275template(1, MyTransactionsComponent_tbody_20_tr_1_Template, 19, 9, "tr", 9);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var MyTransactionsComponent = class _MyTransactionsComponent {
  ...
  mytransactions() {
    this.http.get(`${environment.apiUrl}/airpay/transactions?populate=createdBy&populate=userOrderDetails&limit=0`).subscribe({
      next: (res) => {
...
//# sourceMappingURL=chunk-AWTNPZWM.mjs.map
