...
function UserMembershipComponent_ng_container_0_p_24_ng_template_2_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275text(1, " Till your tenure ");
    \u0275\u0275elementContainerEnd();
  }
}
function UserMembershipComponent_ng_container_0_p_24_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, UserMembershipComponent_ng_container_0_p_24_ng_template_2_ng_container_0_Template, 2, 0, "ng-container", 20);
  }
  if (rf & 2) {
    \u0275\u0275nextContext();
    const expiryDate_r1 = \u0275\u0275reference(5);
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("ngIf", ctx_r1.validTill === "tenure")("ngIfElse", expiryDate_r1);
  }
}
function UserMembershipComponent_ng_container_0_p_24_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "date");
  }
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(1, 1, ctx_r1.validTill, "dd MMM yyyy"), " ");
  }
}
function UserMembershipComponent_ng_container_0_p_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275template(1, UserMembershipComponent_ng_container_0_p_24_ng_container_1_Template, 2, 0, "ng-container", 20)(2, UserMembershipComponent_ng_container_0_p_24_ng_template_2_Template, 1, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(4, UserMembershipComponent_ng_container_0_p_24_ng_template_4_Template, 2, 4, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const notLifetime_r3 = \u0275\u0275reference(3);
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.validTill === "lifetime")("ngIfElse", notLifetime_r3);
  }
}
function UserMembershipComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0, 3);
    \u0275\u0275elementStart(1, "div", 4)(2, "h5");
    \u0275\u0275text(3, "Membership");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 5)(5, "div", 6)(6, "h4")(7, "span", 7);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275text(9, " Membership");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275element(12, "hr");
    \u0275\u0275elementStart(13, "div", 9)(14, "div", 10)(15, "div", 11)(16, "p");
    ...
    \u0275\u0275pipe(20, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 11)(22, "p");
    \u0275\u0275text(23, "Valid Till:");
    \u0275\u0275elementEnd();
    \u0275\u0275template(24, UserMembershipComponent_ng_container_0_p_24_Template, 6, 2, "p", 12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div", 13)(26, "div", 11)(27, "p");
    \u0275\u0275text(28, " Fee Paid : ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(29, "svg", 14)(30, "title", 15);
    \u0275\u0275text(31, "Success");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "desc", 16);
    \u0275\u0275text(33, "Green circle with small white tick");
    \u0275\u0275elementEnd();
    \u0275\u0275element(34, "circle", 17)(35, "path", 18);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(36, "div", 11)(37, "p");
    \u0275\u0275text(38, " Membership ID: ");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(20, 4, ctx_r1.user == null ? null : ctx_r1.user.memberShipStartedAt, "dd MMM yyyy"));
    \u0275\u0275advance(5);
    \u0275\u0275property("ngIf", ctx_r1.validTill);
    \u0275\u0275advance(16);
    \u0275\u0275textInterpolate(ctx_r1.user == null ? null : ctx_r1.user.memberShipId);
  }
}
function UserMembershipComponent_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementContainerStart(0, 3);
    \u0275\u0275elementStart(1, "div", 21)(2, "h5");
    \u0275\u0275text(3, "Choose Membership");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 22)(5, "div", 23)(6, "div", 24)(7, "div", 25)(8, "h5", 26);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(9, "svg", 27)(10, "mask", 28);
    \u0275\u0275element(11, "rect", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "g", 30);
    ...
    \u0275\u0275listener("click", function UserMembershipComponent_ng_container_1_Template_button_click_22_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.paymentAirpay("lifetime"));
    });
    \u0275\u0275text(23, "Pay Now");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(24, "div", 23)(25, "div", 24)(26, "div", 25)(27, "h5", 26);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(28, "svg", 35)(29, "mask", 36);
    \u0275\u0275element(30, "rect", 37);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "g", 38);
    \u0275\u0275element(32, "path", 39);
    \u0275\u0275elementEnd();
    \u0275\u0275element(33, "path", 40);
    \u0275\u0275elementEnd();
    \u0275\u0275text(34, " Tenure Membership ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(35, "p", 32);
    \u0275\u0275text(36, "\u20B91,000 per Tenure");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "ul", 33)(38, "li");
    \u0275\u0275text(39, "\u2714 For NCT Delhi-posted members only");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "li");
    \u0275\u0275text(41, "\u2714 Valid for tenure");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(42, "button", 34);
    \u0275\u0275listener("click", function UserMembershipComponent_ng_container_1_Template_button_click_42_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.paymentAirpay("tenure"));
    });
    \u0275\u0275text(43, "Pay Now");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(44, "div", 23)(45, "div", 24)(46, "div", 25)(47, "h5", 26);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(48, "svg", 27)(49, "mask", 41);
    \u0275\u0275element(50, "rect", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "g", 43);
    \u0275\u0275element(52, "path", 44);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(53, " Annual Membership ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(54, "p", 32);
    \u0275\u0275text(55, "\u20B9200 Annually");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "ul", 33)(57, "li");
    \u0275\u0275text(58, "\u2714 For members posted in NCT Delhi");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(59, "li");
    \u0275\u0275text(60, "\u2714 Renewable every year");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(61, "button", 34);
    \u0275\u0275listener("click", function UserMembershipComponent_ng_container_1_Template_button_click_61_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.paymentAirpay("annual"));
    });
    \u0275\u0275text(62, "Pay Now");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementContainerEnd();
...
var UserMembershipComponent = class _UserMembershipComponent {
  ...
  ngOnInit() {
    this.userService.getUser().subscribe((user) => {
      ...
      } else if (this.user?.subscriptionType === "tenure") {
        this.validTill = "tenure";
      } else {
        this.validTill = null;
      }
    });
  }
  // paymentbtn(value: string) {
  //   const url = `${window.location.origin}/user-home/payment-status`;
  //   const payload = {
  //     memberShip: value,
  //     clientUrl: url
  //   }
  //   this.http.post<any>(`${environment.apiUrl}/orders/initiate`, payload)
  //     .subscribe({
  //       next: (res) => {
  ...
  paymentAirpay(value) {
    ...
    this.http.post(`${environment.apiUrl}/airpay/transaction`, payload).subscribe({
      next: (res) => {
        if (res?.success && res.data?.URL) {
          ...
          addField("merchant_id", res.data.merchant_id);
          addField("privatekey", res.data.privatekey);
          addField("checksum", res.data.checksum);
          addField("encdata", res.data.encdata);
          addField("chmod", "");
...
//# sourceMappingURL=chunk-PEIO2PI3.mjs.map
