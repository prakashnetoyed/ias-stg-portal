...
var routes = [
    ...
    children: [
      {
        ...
        loadComponent: () => import("./chunk-WFIF5OWU.mjs").then((m) => m.IasHomepageComponent)
      },
      {
        path: "about-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-6P4XT3GB.mjs").then((m) => m.IasAboutusComponent)
      },
      {
        path: "contact-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-O6OA5A4L.mjs").then((m) => m.IasContactusComponent)
      },
      {
        path: "community",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-YXIEC3U4.mjs").then((m) => m.IasCommunityComponent)
      },
      {
        path: "my-posts",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-PU6P3365.mjs").then((m) => m.MyPostsComponent)
      },
      {
        path: "post",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-TKBVJTPX.mjs").then((m) => m.PostComponent)
      },
      {
        path: "caruna",
        loadComponent: () => import("./chunk-4QDBK244.mjs").then((m) => m.IasCarunaComponent)
      },
      {
        path: "all-members",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-5NYTMUQ5.mjs").then((m) => m.AllMembersComponent)
      },
      {
        path: "news-blogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-LEITTVR5.mjs").then((m) => m.NewsBlogsComponent)
      },
      {
        path: "caruna",
        // component:IasHomepageComponent,
      ...
      },
      {
        ...
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-5W4FCVBR.mjs").then((m) => m.WelfareMembershipComponent)
      },
      {
        path: "lifetime-membership",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-IM4AR75J.mjs").then((m) => m.LifetimeMembershipComponent)
      },
      {
        path: "readmorenews",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-4PLQUHPH.mjs").then((m) => m.ReadmoreNewsComponent)
      },
      {
        path: "readmoreblogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-NEDIMQOQ.mjs").then((m) => m.ReadmoreBlogsComponent)
      },
      {
        path: "membership",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-QYQGFYKA.mjs").then((m) => m.CombinedMemberPageComponent)
      },
      {
        path: "Terms-Conditions",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-47BHB2IA.mjs").then((m) => m.TermsConditionsComponent)
      },
      {
        path: "Refund-Cancellation-Policy",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-E5PK3YWK.mjs").then((m) => m.RefundCancellationPolicyComponent)
      },
      {
        path: "Privacy-Policy",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-FBVCNFJ6.mjs").then((m) => m.PrivacyPolicyComponent)
      }
    ]
  },
  {
  ...
  },
  {
    ...
    canActivate: [authGuard],
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-2B673VR7.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-QMVSKHNC.mjs").then((m) => m.DashboardComponent)
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-D7QXGI3M.mjs").then((m) => m.ProfileInfoComponent)
      },
      {
        path: "publications",
        loadComponent: () => import("./chunk-N7PWOA7L.mjs").then((m) => m.PublicationsComponent)
      },
      {
        path: "blogs",
        loadComponent: () => import("./chunk-ESVW5O6S.mjs").then((m) => m.BlogsComponent)
      },
      {
        path: "news",
        loadComponent: () => import("./chunk-AVS4HROZ.mjs").then((m) => m.NewsComponent)
      },
      {
        path: "mom",
        loadComponent: () => import("./chunk-3DOKII5Q.mjs").then((m) => m.MoMComponent)
      },
      {
        path: "feedbacks",
        loadComponent: () => import("./chunk-6PK2ZFHG.mjs").then((m) => m.FeedbacksComponent)
      },
      {
        path: "my-transaction",
        loadComponent: () => import("./chunk-QLGMDWYS.mjs").then((m) => m.MyTransactionComponent)
      },
      {
        path: "approved-user",
        loadComponent: () => import("./chunk-5GMWB4QL.mjs").then((m) => m.ApprovedUserComponent)
      },
      {
        path: "pending-approval-user",
        loadComponent: () => import("./chunk-IE4D2UH2.mjs").then((m) => m.NotApprovedUserComponent)
      },
      {
        path: "rejected-user",
        loadComponent: () => import("./chunk-LCXZDEL2.mjs").then((m) => m.RejectedUsersComponent)
      },
      {
        path: "user-info",
        loadComponent: () => import("./chunk-FIPCQABH.mjs").then((m) => m.DetailedUserInfoComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-74SGZUIM.mjs").then((m) => m.UserDashboardComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-6GU3B3HZ.mjs").then((m) => m.UserHomeComponent)
      },
      {
        path: "user-profile",
        loadComponent: () => import("./chunk-V5R5JJ7X.mjs").then((m) => m.UserProfileComponent)
      },
      {
        path: "user-events",
        loadComponent: () => import("./chunk-W7B6KW3H.mjs").then((m) => m.UserEventsComponent)
      },
      {
        path: "user-membership",
        loadComponent: () => import("./chunk-F6BAQTY6.mjs").then((m) => m.UserMembershipComponent)
      },
      {
        path: "user-members",
        loadComponent: () => import("./chunk-X2L6URZB.mjs").then((m) => m.UserMembersComponent)
      },
      {
        path: "user-transactions",
        loadComponent: () => import("./chunk-UKWSTYVT.mjs").then((m) => m.MyTransactionsComponent)
      },
      {
        path: "payment-status",
        loadComponent: () => import("./chunk-FKEQZ7ED.mjs").then((m) => m.PaymentStatusComponent)
      }
    ]
  },
  {
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const moduleImpl = this.moduleImpl ?? import("./chunk-CW6ERJCP.mjs");
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-DAT6YX52.mjs.map
