...
import {
  UserService
} from "./chunk-MKEY7MC4.mjs";
import {
  provideServerRendering
} from "./chunk-GGWDBKIU.mjs";
import {
  AuthService
...
var routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "about-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-74DTG4EF.mjs").then((m) => m.IasAboutusComponent)
      },
      {
        path: "contact-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-G7LVGZIF.mjs").then((m) => m.IasContactusComponent)
      },
      {
        path: "community",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-I3M7WBAV.mjs").then((m) => m.IasCommunityComponent)
      },
      {
        path: "post",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-U3HQD2XU.mjs").then((m) => m.PostComponent)
      },
      {
        path: "caruna",
        loadComponent: () => import("./chunk-QMULXVNI.mjs").then((m) => m.IasCarunaComponent)
      },
      {
        path: "all-members",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-N6NIPTA4.mjs").then((m) => m.AllMembersComponent)
      },
      {
        path: "news-blogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-TNVOCX53.mjs").then((m) => m.NewsBlogsComponent)
      },
      {
        path: "caruna",
        // component:IasHomepageComponent,
      ...
      },
      {
        ...
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-2PAXKEW2.mjs").then((m) => m.WelfareMembershipComponent)
      },
      {
        path: "lifetime-membership",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-LAA3MUJL.mjs").then((m) => m.LifetimeMembershipComponent)
      },
      {
        path: "readmorenews",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-CXCL3VEA.mjs").then((m) => m.ReadmoreNewsComponent)
      },
      {
        path: "readmoreblogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-TR35OV6D.mjs").then((m) => m.ReadmoreBlogsComponent)
      },
      {
        path: "membership",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-CTUEDUI2.mjs").then((m) => m.CombinedMemberPageComponent)
      },
      {
        path: "Terms-Conditions",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-LZMLMMNL.mjs").then((m) => m.TermsConditionsComponent)
      },
      {
        path: "Refund-Cancellation-Policy",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-45IFDS5J.mjs").then((m) => m.RefundCancellationPolicyComponent)
      },
      {
        path: "Privacy-Policy",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-UOXTTTMO.mjs").then((m) => m.PrivacyPolicyComponent)
      }
    ]
  },
  {
  ...
  },
  {
    ...
    canActivate: [authGuard],
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-OC67GJC7.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-RBDBXWL4.mjs").then((m) => m.DashboardComponent)
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-4LUF36BL.mjs").then((m) => m.ProfileInfoComponent)
      },
      {
        path: "publications",
        loadComponent: () => import("./chunk-GR5OARBU.mjs").then((m) => m.PublicationsComponent)
      },
      {
        path: "blogs",
        loadComponent: () => import("./chunk-S53NNDBM.mjs").then((m) => m.BlogsComponent)
      },
      {
        path: "news",
        loadComponent: () => import("./chunk-4XCHCSTK.mjs").then((m) => m.NewsComponent)
      },
      {
        path: "mom",
        loadComponent: () => import("./chunk-67LSUGSR.mjs").then((m) => m.MoMComponent)
      },
      {
        path: "feedbacks",
        loadComponent: () => import("./chunk-S4YYGRI2.mjs").then((m) => m.FeedbacksComponent)
      },
      {
        path: "my-transaction",
        loadComponent: () => import("./chunk-JEANN6C3.mjs").then((m) => m.MyTransactionComponent)
      },
      {
        path: "approved-user",
        loadComponent: () => import("./chunk-R3WRPYHI.mjs").then((m) => m.ApprovedUserComponent)
      },
      {
        path: "pending-approval-user",
        loadComponent: () => import("./chunk-7OOPWI4X.mjs").then((m) => m.NotApprovedUserComponent)
      },
      {
        path: "rejected-user",
        loadComponent: () => import("./chunk-RMEXS7ZZ.mjs").then((m) => m.RejectedUsersComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-6SJ7ES3W.mjs").then((m) => m.UserDashboardComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-FKVJXF2N.mjs").then((m) => m.UserHomeComponent)
      },
      {
        path: "user-profile",
        loadComponent: () => import("./chunk-JD3CUQH6.mjs").then((m) => m.UserProfileComponent)
      },
      {
        path: "user-events",
        loadComponent: () => import("./chunk-PCBK6TRS.mjs").then((m) => m.UserEventsComponent)
      },
      {
        path: "user-membership",
        loadComponent: () => import("./chunk-GRWNLUFV.mjs").then((m) => m.UserMembershipComponent)
      },
      {
        path: "user-members",
        loadComponent: () => import("./chunk-SOEX5XNB.mjs").then((m) => m.UserMembersComponent)
      },
      {
        path: "user-transactions",
        loadComponent: () => import("./chunk-XGT2YIU7.mjs").then((m) => m.MyTransactionsComponent)
      },
      {
        path: "payment-status",
        loadComponent: () => import("./chunk-LJYDLANX.mjs").then((m) => m.PaymentStatusComponent)
      }
    ]
  },
  {
    ...
    loadComponent: () => import("./chunk-A62SS7SS.mjs").then((m) => m.UserNotApprovedLayoutComponent)
  },
  {
    path: "**",
    // wildcard → catch all unknown routes
    loadComponent: () => import("./chunk-UDIZ3LGY.mjs").then((m) => m.RouteErrorComponent)
  }
];
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const moduleImpl = this.moduleImpl ?? import("./chunk-QZROJWT3.mjs");
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-E2UZOEUO.mjs.map
