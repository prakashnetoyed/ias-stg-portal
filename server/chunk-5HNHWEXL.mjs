...
var routes = [
    ...
    children: [
      {
        ...
        loadComponent: () => import("./chunk-QGHEAKLC.mjs").then((m) => m.IasHomepageComponent)
      },
      {
        path: "about-us",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "all-members",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-BSED6BIQ.mjs").then((m) => m.AllMembersComponent)
      },
      {
        path: "news-blogs",
        // component:IasHomepageComponent,
  ...
  },
  {
    ...
    canActivate: [authGuard],
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-DJTUGVFB.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-5HNHWEXL.mjs.map
