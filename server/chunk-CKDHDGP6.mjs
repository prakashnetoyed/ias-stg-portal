...
var routes = [
  ...
  },
  {
    ...
    canActivate: [authGuard],
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-4MWRWXAA.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "user-profile",
        loadComponent: () => import("./chunk-OWEOBQ3Q.mjs").then((m) => m.UserProfileComponent)
      },
      {
        path: "user-events",
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-RDAE2NDC.mjs").then((m) => m.StateDashboardLayoutComponent),
    children: [
      {
        path: "",
...
@angular/service-worker/fesm2022/service-worker.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-CKDHDGP6.mjs.map
