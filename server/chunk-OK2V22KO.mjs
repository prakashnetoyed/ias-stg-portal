...
function UserEventsComponent_div_4_div_1_button_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 18);
    \u0275\u0275listener("click", function UserEventsComponent_div_4_div_1_button_18_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const event_r2 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(event_r2.url && ctx_r2.openEvent(event_r2.url));
    });
    \u0275\u0275text(1, "Join Event Online");
    \u0275\u0275elementEnd();
  }
}
function UserEventsComponent_div_4_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(7, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 9)(9, "h6", 10);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "p", 11);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(12, "svg", 12)(13, "mask", 13);
    \u0275\u0275element(14, "rect", 14);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(18, UserEventsComponent_div_4_div_1_button_18_Template, 2, 0, "button", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", i_r4 % 2 === 0 ? "bg-purple" : "bg-teal");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(4, 6, event_r2.date, "MMM"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(7, 9, event_r2.date, "dd"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(event_r2.title);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", event_r2.location, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", event_r2.url);
  }
}
function UserEventsComponent_div_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275template(1, UserEventsComponent_div_4_div_1_Template, 19, 12, "div", 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function UserEventsComponent_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=chunk-OK2V22KO.mjs.map
