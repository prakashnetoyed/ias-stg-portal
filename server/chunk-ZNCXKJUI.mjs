...
} from "./chunk-IDMYKTPG.mjs";
import {
  UserService
} from "./chunk-UNA2NUFT.mjs";
...
function UserProfileComponent_div_34_div_88_Template(rf, ctx) {
  if (rf & 1) {
...
function UserProfileComponent_div_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(83);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(84, "div", 62)(85, "h2");
    \u0275\u0275text(86, "Place Of Domicile");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(87, "div", 63);
    \u0275\u0275template(88, UserProfileComponent_div_34_div_88_Template, 5, 1, "div", 66);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    let tmp_7_0;
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r2.user.doptOfficer == null ? null : ctx_r2.user.doptOfficer.gender);
    \u0275\u0275advance(5);
...
var UserProfileComponent = class _UserProfileComponent {
  constructor(fb, userService, http, toastService) {
    this.fb = fb;
  ...
  static {
    this.\u0275fac = function UserProfileComponent_Factory(t) {
      return new (t || _UserProfileComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(UserService), \u0275\u0275directiveInject(HttpClient), \u0275\u0275directiveInject(ToastService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserProfileComponent, selectors: [["app-user-profile"]], viewQuery: function UserProfileComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275text(33, "Save");
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275template(34, UserProfileComponent_div_34_Template, 89, 17, "div", 23);
      }
      if (rf & 2) {
        \u0275\u0275advance(23);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UserProfileComponent, { className: "UserProfileComponent", filePath: "src/app/user-portal/pages/user-profile/user-profile.component.ts", lineNumber: 19 });
})();
export {
  UserProfileComponent
};
//# sourceMappingURL=chunk-ZNCXKJUI.mjs.map
