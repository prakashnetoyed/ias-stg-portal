...
var StateLandingPageComponent = class _StateLandingPageComponent {
  ...
  loadData() {
    this.loading = true;
    this.http.get(`${environment.apiUrl}/state-associations/18`).subscribe((data) => {
      this.loading = false;
  ...
  loadNews() {
    this.loading1 = true;
    this.http.get(`${environment.apiUrl}/state-associations/18/news`).subscribe((data) => {
      this.loading1 = false;
  ...
  loadGallery() {
    this.loading2 = true;
    this.http.get(`${environment.apiUrl}/state-associations/18/gallery`).subscribe((data) => {
      this.loading2 = false;
  ...
  static {
    this.\u0275fac = function StateLandingPageComponent_Factory(t) {
      return new (t || _StateLandingPageComponent)(\u0275\u0275directiveInject(HttpClient), \u0275\u0275directiveInject(Router));
    };
  }
  static {
...
var routes = [
    ...
    children: [
      {
        ...
        loadComponent: () => import("./chunk-L5SWFMPD.mjs").then((m) => m.IasHomepageComponent)
      },
      {
        path: "about-us",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "contact-us",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-2BRR6D5S.mjs").then((m) => m.IasContactusComponent)
      },
      {
        path: "community",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "post",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-OWRBFR4X.mjs").then((m) => m.PostComponent)
      },
      {
        path: "caruna",
      ...
      },
      {
        path: "readmoreblogs",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-RATPFYNH.mjs").then((m) => m.ReadmoreBlogsComponent)
      },
      {
        path: "membership",
        // component:IasHomepageComponent,
      ...
      },
      {
        ...
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-CMRRDJ3Q.mjs").then((m) => m.TermsConditionsComponent)
      },
      {
        path: "Refund-Cancellation-Policy",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-DC3PGHVB.mjs").then((m) => m.RefundCancellationPolicyComponent)
      },
      {
        path: "Privacy-Policy",
        // component:IasHomepageComponent,
  ...
  },
  {
    ...
    canActivate: [authGuard],
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-GKMACXF3.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-TKQO3YWH.mjs").then((m) => m.DashboardComponent)
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-5J76OWPK.mjs").then((m) => m.ProfileInfoComponent)
      },
      {
        path: "publications",
        loadComponent: () => import("./chunk-2QMV7HG2.mjs").then((m) => m.PublicationsComponent)
      },
      {
        path: "blogs",
        loadComponent: () => import("./chunk-UOTXGTL4.mjs").then((m) => m.BlogsComponent)
      },
      {
        path: "news",
        loadComponent: () => import("./chunk-5XTRX4FX.mjs").then((m) => m.NewsComponent)
      },
      {
        path: "mom",
        loadComponent: () => import("./chunk-JFOSZKWH.mjs").then((m) => m.MoMComponent)
      },
      {
        path: "feedbacks",
        loadComponent: () => import("./chunk-XMK6UPJV.mjs").then((m) => m.FeedbacksComponent)
      },
      {
        path: "my-transaction",
        loadComponent: () => import("./chunk-OMOGUVZ6.mjs").then((m) => m.MyTransactionComponent)
      },
      {
        path: "approved-user",
        loadComponent: () => import("./chunk-7EHWW7MO.mjs").then((m) => m.ApprovedUserComponent)
      },
      {
        path: "pending-approval-user",
        loadComponent: () => import("./chunk-R3WLFV6I.mjs").then((m) => m.NotApprovedUserComponent)
      },
      {
        path: "rejected-user",
        loadComponent: () => import("./chunk-E6BEFBUE.mjs").then((m) => m.RejectedUsersComponent)
      },
      {
        path: "user-info",
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-IPAYUFCA.mjs").then((m) => m.UserDashboardComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-ZL2ICU2U.mjs").then((m) => m.UserHomeComponent)
      },
      {
        path: "user-profile",
        loadComponent: () => import("./chunk-7244JQJC.mjs").then((m) => m.UserProfileComponent)
      },
      {
        path: "user-events",
      ...
      {
        path: "user-members",
        loadComponent: () => import("./chunk-IBRFSOCF.mjs").then((m) => m.UserMembersComponent)
      },
      {
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-M44L6OS4.mjs").then((m) => m.StateDashboardLayoutComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-KXSGUA4K.mjs").then((m) => m.StateAboutUsComponent)
      },
      {
        path: "state-news",
        loadComponent: () => import("./chunk-TOUK7AX7.mjs").then((m) => m.StateNewsComponent)
      },
      {
        path: "state-events",
        loadComponent: () => import("./chunk-67PBRKJQ.mjs").then((m) => m.StateEventsComponent)
      },
      {
        path: "state-office-bearers",
        loadComponent: () => import("./chunk-BK2FV4KT.mjs").then((m) => m.StateOfficeBearersComponent)
      },
      {
        path: "state-gallery",
        loadComponent: () => import("./chunk-O6WLFR47.mjs").then((m) => m.StateGalleryComponent)
      }
    ]
  },
  {
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-XMZPDDEY.mjs.map
