...
var IasContactusComponent = class _IasContactusComponent {
  ...
  static {
    this.\u0275fac = function IasContactusComponent_Factory(t) {
      return new (t || _IasContactusComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(HttpClient), \u0275\u0275directiveInject(ToastService));
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(IasContactusComponent, { className: "IasContactusComponent", filePath: "src/app/website/pages/ias-contactus/ias-contactus.component.ts", lineNumber: 16 });
})();
export {
  IasContactusComponent
};
//# sourceMappingURL=chunk-H5UUVDQW.mjs.map
