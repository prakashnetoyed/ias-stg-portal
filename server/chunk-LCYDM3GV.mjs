...
var _c1 = ["errorToast"];
function UserProfileComponent_div_14_div_19_span_1_Template(rf, ctx) {
  if (rf & 1) {
...
function UserProfileComponent_div_14_div_19_span_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function UserProfileComponent_div_14_div_19_span_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function UserProfileComponent_div_14_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 38);
    \u0275\u0275template(1, UserProfileComponent_div_14_div_19_span_1_Template, 2, 0, "span", 39)(2, UserProfileComponent_div_14_div_19_span_2_Template, 2, 0, "span", 39)(3, UserProfileComponent_div_14_div_19_span_3_Template, 2, 0, "span", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
...
function UserProfileComponent_div_14_div_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 38);
...
function UserProfileComponent_div_14_div_74_Template(rf, ctx) {
  if (rf & 1) {
...
function UserProfileComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(18, "input", 22);
    \u0275\u0275template(19, UserProfileComponent_div_14_div_19_Template, 4, 3, "div", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 20)(21, "label", 21);
    \u0275\u0275text(22, "Confirm Password");
    \u0275\u0275elementEnd();
    \u0275\u0275element(23, "input", 24);
    \u0275\u0275template(24, UserProfileComponent_div_14_div_24_Template, 2, 0, "div", 23);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(28, "p");
    \u0275\u0275text(29, " Once your password is changed, you will need to log in again with the new password. ");
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275text(34, "Submit");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(35, "div", 31)(36, "div", 32)(37, "div", 33)(38, "h2");
    \u0275\u0275text(39, "Personal Information");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "div", 34)(41, "div", 35)(42, "span");
    \u0275\u0275text(43, "Name: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "h5");
    \u0275\u0275text(45);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "div", 35)(47, "span");
    \u0275\u0275text(48, "Gender: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "h5");
    \u0275\u0275text(50);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(51, "div", 35)(52, "span");
    \u0275\u0275text(53, "DOB: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "h5");
    \u0275\u0275text(55);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(56, "div", 33)(57, "h2");
    \u0275\u0275text(58, "Contact Details");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(59, "div", 34)(60, "div", 36)(61, "span");
    \u0275\u0275text(62, "E- Mail: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(63, "h5");
    \u0275\u0275text(64);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(65, "div", 35)(66, "span");
    \u0275\u0275text(67, "Mobile No: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "h5");
    \u0275\u0275text(69);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(70, "div", 33)(71, "h2");
    \u0275\u0275text(72, "Place Of Domicile");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(73, "div", 34);
    \u0275\u0275template(74, UserProfileComponent_div_14_div_74_Template, 5, 1, "div", 37);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    let tmp_4_0;
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserProfileComponent, selectors: [["app-user-profile"]], viewQuery: function UserProfileComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(14, UserProfileComponent_div_14_Template, 75, 9, "div", 8);
      }
      if (rf & 2) {
        \u0275\u0275advance(14);
...
//# sourceMappingURL=chunk-LCYDM3GV.mjs.map
