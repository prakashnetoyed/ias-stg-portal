...
function PostComponent_div_12_div_36_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function PostComponent_div_12_div_36_ng_template_12_Template_input_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275listener("click", function PostComponent_div_12_div_36_ng_template_12_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r6);
      const c_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function PostComponent_div_12_div_36_ng_template_12_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function PostComponent_div_12_div_36_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "img", 52);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 53)(4, "div", 54)(5, "div", 53)(6, "span");
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(10, "timeAgo");
    \u0275\u0275elementEnd();
    \u0275\u0275template(11, PostComponent_div_12_div_36_div_11_Template, 3, 1, "div", 56)(12, PostComponent_div_12_div_36_ng_template_12_Template, 5, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div");
    \u0275\u0275template(15, PostComponent_div_12_div_36_ng_container_15_Template, 5, 0, "ng-container", 57);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275property("src", c_r5 == null ? null : c_r5.createdBy == null ? null : c_r5.createdBy.profilePic, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(c_r5 == null ? null : c_r5.createdBy == null ? null : c_r5.createdBy.name);
    \u0275\u0275advance(2);
...
function PostComponent_div_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(35, PostComponent_div_12_div_35_Template, 4, 1, "div", 37)(36, PostComponent_div_12_div_36_Template, 16, 8, "div", 38);
    \u0275\u0275elementEnd();
    \u0275\u0275element(37, "div", 39);
    \u0275\u0275elementEnd()();
  }
...
function PostComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 64)(1, "p", 64);
  ...
  singleposts(id) {
    ...
    this.http.get(URL).subscribe({
      next: (res) => {
        ...
        this.comments = this.postData?.communityComments;
...
//# sourceMappingURL=chunk-XDVQZSTU.mjs.map
