...
function ApprovedUserComponent_table_31_tr_20_a_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 51);
    \u0275\u0275listener("click", function ApprovedUserComponent_table_31_tr_20_a_22_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function ApprovedUserComponent_table_31_tr_20_a_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 45);
    \u0275\u0275listener("click", function ApprovedUserComponent_table_31_tr_20_a_24_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const user_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 46)(2, "mask", 47);
    \u0275\u0275element(3, "rect", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "g", 49);
    \u0275\u0275element(5, "path", 50);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(6, "Reject");
    \u0275\u0275elementEnd();
...
function ApprovedUserComponent_table_31_tr_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "td")(17, "div", 40)(18, "button", 41);
    \u0275\u0275text(19, " \u22EE ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "ul", 42)(21, "li");
    \u0275\u0275template(22, ApprovedUserComponent_table_31_tr_20_a_22_Template, 4, 0, "a", 43);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "li");
    \u0275\u0275template(24, ApprovedUserComponent_table_31_tr_20_a_24_Template, 7, 0, "a", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "li")(26, "a", 45);
    \u0275\u0275listener("click", function ApprovedUserComponent_table_31_tr_20_Template_a_click_26_listener() {
      const user_r4 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.openDeleteModal(user_r4.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(27, "svg", 46)(28, "mask", 47);
    \u0275\u0275element(29, "rect", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "g", 49);
    \u0275\u0275element(31, "path", 50);
    \u0275\u0275elementEnd()();
...
function ApprovedUserComponent_table_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "table", 37)(1, "thead")(2, "tr")(3, "th");
    \u0275\u0275text(4, "S.no");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "th");
    \u0275\u0275text(6, "Name");
    ...
    \u0275\u0275template(20, ApprovedUserComponent_table_31_tr_20_Template, 33, 10, "tr", 38);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ApprovedUserComponent_ng_template_32_Template(rf, ctx) {
  if (rf & 1) {
...
function ApprovedUserComponent_li_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 29)(1, "a", 30);
    \u0275\u0275listener("click", function ApprovedUserComponent_li_40_Template_a_click_1_listener() {
      const page_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.changePage(page_r9));
    });
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classProp("active", page_r9 === ctx_r4.currentPage);
    \u0275\u0275advance();
...
var ApprovedUserComponent = class _ApprovedUserComponent {
  ...
  loadUsers(page = 1, limit = this.pageSize) {
    ...
    this.http.get(url, { headers }).subscribe({
      next: (res) => {
        this.users = res.data.data.filter((user) => user.status === this.AccountActivityStatus.APPROVED);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ApprovedUserComponent, selectors: [["app-approved-user"]], viewQuery: function ApprovedUserComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275twoWayListener("ngModelChange", function ApprovedUserComponent_Template_input_ngModelChange_29_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.searchText, $event) || (ctx.searchText = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275listener("keyup", function ApprovedUserComponent_Template_input_keyup_29_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onSearchKeyup());
        });
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(30, "div", 25);
        \u0275\u0275template(31, ApprovedUserComponent_table_31_Template, 21, 1, "table", 26);
        \u0275\u0275elementEnd();
        \u0275\u0275template(32, ApprovedUserComponent_ng_template_32_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementStart(34, "div", 27)(35, "nav")(36, "ul", 28)(37, "li", 29)(38, "a", 30);
        \u0275\u0275listener("click", function ApprovedUserComponent_Template_a_click_38_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goPrevious());
        });
        \u0275\u0275text(39, "\u2039");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(40, ApprovedUserComponent_li_40_Template, 3, 3, "li", 31);
        \u0275\u0275elementStart(41, "li", 29)(42, "a", 30);
        \u0275\u0275listener("click", function ApprovedUserComponent_Template_a_click_42_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goNext());
        });
        \u0275\u0275text(43, "\u203A");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(44, "div", 32)(45, "select", 33);
        \u0275\u0275listener("change", function ApprovedUserComponent_Template_select_change_45_listener($event) {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275text(49, "30 /Page");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(50, "option", 36);
        \u0275\u0275text(51, "50 /Page");
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        const noUsers_r10 = \u0275\u0275reference(33);
        \u0275\u0275advance();
        ...
        \u0275\u0275advance(3);
        \u0275\u0275property("ngForOf", ctx.paginationArray);
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ApprovedUserComponent, { className: "ApprovedUserComponent", filePath: "src/app/IAS-portal/pages/approved-user/approved-user.component.ts", lineNumber: 16 });
})();
export {
  ApprovedUserComponent
};
//# sourceMappingURL=chunk-KMSQE5KI.mjs.map
