...
function UserHomeComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, UserHomeComponent_div_7_ng_container_3_Template, 2, 1, "ng-container", 24)(4, UserHomeComponent_div_7_ng_template_4_Template, 1, 1, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementEnd();
...
function UserHomeComponent_div_21_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(12, "svg", 94)(13, "mask", 95);
    \u0275\u0275element(14, "rect", 96);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "g", 97);
    \u0275\u0275element(16, "path", 98);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(17, " Comment ");
    \u0275\u0275elementEnd()();
  }
...
function UserHomeComponent_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(5, "timeAgo");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(6, UserHomeComponent_div_21_div_6_Template, 2, 1, "div", 75);
    \u0275\u0275elementStart(7, "p", 73);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275element(9, "hr", 76);
    \u0275\u0275template(10, UserHomeComponent_div_21_div_10_Template, 18, 10, "div", 77);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserHomeComponent_div_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 73)(1, "p", 73);
...
function UserHomeComponent_div_29_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 100)(1, "div", 101)(2, "div", 102);
    \u0275\u0275text(3);
    \u0275\u0275pipe(4, "date");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(7, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 104)(9, "h6", 105);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "p", 106);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(12, "svg", 107)(13, "mask", 108);
    \u0275\u0275element(14, "rect", 109);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "g", 110);
    \u0275\u0275element(16, "path", 111);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(18, UserHomeComponent_div_29_div_1_button_18_Template, 2, 0, "button", 112);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function UserHomeComponent_div_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, UserHomeComponent_div_29_div_1_Template, 19, 12, "div", 99);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserHomeComponent_div_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 115)(1, "h1");
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "hr");
    \u0275\u0275elementStart(5, "div", 116)(6, "div", 117)(7, "div", 118);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(8, "svg", 119);
    \u0275\u0275element(9, "path", 120);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(15, "div", 122)(16, "div", 118);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(17, "svg", 107)(18, "mask", 123);
    \u0275\u0275element(19, "rect", 109);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "g", 124);
    \u0275\u0275element(21, "path", 125);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(25, "svg", 126)(26, "title", 127);
    \u0275\u0275text(27, "Success");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "desc", 128);
    \u0275\u0275text(29, "Green circle with small white tick");
    \u0275\u0275elementEnd();
    \u0275\u0275element(30, "circle", 129)(31, "path", 130);
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserHomeComponent_ng_container_41_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 132)(1, "div", 74);
    \u0275\u0275template(2, UserHomeComponent_ng_container_41_div_1_img_2_Template, 1, 1, "img", 133);
    ...
    \u0275\u0275pipe(8, "timeAgo");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(9, UserHomeComponent_ng_container_41_div_1_div_9_Template, 2, 1, "div", 135);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(24, "svg", 94)(25, "mask", 95);
    \u0275\u0275element(26, "rect", 96);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "g", 97);
    \u0275\u0275element(28, "path", 98);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(29, " Comment ");
    \u0275\u0275elementEnd()()();
  }
...
function UserHomeComponent_ng_container_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, UserHomeComponent_ng_container_41_div_1_Template, 30, 17, "div", 131);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UserHomeComponent_div_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 73)(1, "p", 73);
    \u0275\u0275text(2, "No recent posts available.");
    \u0275\u0275elementEnd()();
...
function UserHomeComponent_small_58_Template(rf, ctx) {
  if (rf & 1) {
...
function UserHomeComponent_div_96_ng_container_1_div_4_Template(rf, ctx) {
  if (rf & 1) {
...
function UserHomeComponent_div_96_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "div", 141);
    \u0275\u0275template(2, UserHomeComponent_div_96_ng_container_1_img_2_Template, 1, 1, "img", 142)(3, UserHomeComponent_div_96_ng_container_1_video_3_Template, 1, 1, "video", 143)(4, UserHomeComponent_div_96_ng_container_1_div_4_Template, 3, 1, "div", 30);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserHomeComponent, selectors: [["app-user-home"]], viewQuery: function UserHomeComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275template(29, UserHomeComponent_div_29_Template, 2, 1, "div", 24)(30, UserHomeComponent_ng_template_30_Template, 3, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd();
        \u0275\u0275template(32, UserHomeComponent_div_32_Template, 32, 5, "div", 25);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(33, "div", 26)(34, "div", 27)(35, "div", 13)(36, "h1");
        \u0275\u0275text(37, "Community Highlights");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(38, "h4", 28);
        \u0275\u0275text(39, "View All Posts");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(40, "div", 29);
        \u0275\u0275template(41, UserHomeComponent_ng_container_41_Template, 2, 1, "ng-container", 30)(42, UserHomeComponent_div_42_Template, 3, 0, "div", 20);
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(43, "div", 31, 1)(45, "div", 32)(46, "h5", 33);
        \u0275\u0275text(47, "Add Post");
        \u0275\u0275elementEnd();
        \u0275\u0275element(48, "button", 34);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(49, "div", 35)(50, "form", 36);
        \u0275\u0275listener("ngSubmit", function UserHomeComponent_Template_form_ngSubmit_50_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onSubmit());
        });
        \u0275\u0275elementStart(51, "div", 37)(52, "div", 38)(53, "label", 39);
        \u0275\u0275text(54, "Caption");
        \u0275\u0275elementStart(55, "span", 40);
        \u0275\u0275text(56, "*");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(57, "input", 41);
        \u0275\u0275template(58, UserHomeComponent_small_58_Template, 2, 0, "small", 42);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(59, "div", 38)(60, "label", 39);
        \u0275\u0275text(61, "Description");
        \u0275\u0275elementEnd();
        \u0275\u0275element(62, "textarea", 43);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(63, "div", 38)(64, "label", 39);
        \u0275\u0275text(65, "Post Tag");
        \u0275\u0275elementStart(66, "span", 40);
        \u0275\u0275text(67, "*");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(68, "select", 44)(69, "option", 45);
        \u0275\u0275text(70, "Select tag");
        \u0275\u0275elementEnd();
        \u0275\u0275template(71, UserHomeComponent_option_71_Template, 2, 2, "option", 46);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(72, "div", 47)(73, "label", 39);
        \u0275\u0275text(74, "Upload Media");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(75, "label", 48)(76, "div", 49);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(77, "svg", 50);
        \u0275\u0275element(78, "circle", 51);
        \u0275\u0275elementStart(79, "mask", 52);
        \u0275\u0275element(80, "rect", 53);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(81, "g", 54);
        \u0275\u0275element(82, "path", 55);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(83, "defs")(84, "linearGradient", 56);
        \u0275\u0275element(85, "stop", 57)(86, "stop", 58);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(87, "linearGradient", 59);
        \u0275\u0275element(88, "stop", 57)(89, "stop", 58);
        \u0275\u0275elementEnd()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(90, "div", 60)(91, "p", 61);
        \u0275\u0275text(92, "Click to upload");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(93, "small", 62);
        \u0275\u0275text(94, "Max size: 256MB each");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(95, "input", 63);
        \u0275\u0275listener("change", function UserHomeComponent_Template_input_change_95_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.onFileSelected($event));
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275template(96, UserHomeComponent_div_96_Template, 2, 1, "div", 64)(97, UserHomeComponent_div_97_Template, 5, 0, "div", 65);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(98, "div", 66)(99, "button", 67);
        \u0275\u0275text(100, "Back");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(101, "button", 68);
        \u0275\u0275text(102, "Submit");
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        let tmp_13_0;
        const noevent_r16 = \u0275\u0275reference(31);
        \u0275\u0275advance();
...
//# sourceMappingURL=chunk-GATHXY3G.mjs.map
