...
var routes = [
    ...
    children: [
      {
        ...
        loadComponent: () => import("./chunk-RC3MW2OY.mjs").then((m) => m.IasHomepageComponent)
      },
      {
        path: "about-us",
        // component:IasHomepageComponent,
      ...
      },
      {
        path: "community",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-EUH7ZKQV.mjs").then((m) => m.IasCommunityComponent)
      },
      {
        path: "post",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-G55QIMOD.mjs").then((m) => m.PostComponent)
      },
      {
        path: "caruna",
      ...
      },
      {
        path: "membership",
        // component:IasHomepageComponent,
        loadComponent: () => import("./chunk-U42RYZQZ.mjs").then((m) => m.CombinedMemberPageComponent)
      },
      {
  ...
  },
  {
    ...
    canActivate: [authGuard],
    data: { roles: ["admin"] },
    loadComponent: () => import("./chunk-5KUDDFMN.mjs").then((m) => m.DashboardLayoutComponent),
    children: [
      {
        path: "",
      ...
      {
        path: "profile",
        loadComponent: () => import("./chunk-IYO5CQJP.mjs").then((m) => m.ProfileInfoComponent)
      },
      {
        path: "publications",
      ...
      {
        path: "my-transaction",
        loadComponent: () => import("./chunk-QCEBNTSX.mjs").then((m) => m.MyTransactionComponent)
      },
      {
        path: "approved-user",
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-QWPHUGYK.mjs").then((m) => m.UserDashboardComponent),
    children: [
      {
        path: "",
      ...
      {
        path: "user-profile",
        loadComponent: () => import("./chunk-T3DAMNQU.mjs").then((m) => m.UserProfileComponent)
      },
      {
        path: "user-events",
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-XXH2DDE4.mjs").then((m) => m.MyTransactionsComponent)
      },
      {
        path: "payment-status",
        loadComponent: () => import("./chunk-AFZZ5XN7.mjs").then((m) => m.PaymentStatusComponent)
      }
    ]
  },
  {
