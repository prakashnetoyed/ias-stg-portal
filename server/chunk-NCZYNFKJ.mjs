...
function DashboardComponent_table_88_tr_20_a_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 68);
    \u0275\u0275listener("click", function DashboardComponent_table_88_tr_20_a_22_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function DashboardComponent_table_88_tr_20_a_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 63);
    \u0275\u0275listener("click", function DashboardComponent_table_88_tr_20_a_24_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const user_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 24)(2, "mask", 64);
    \u0275\u0275element(3, "rect", 65);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "g", 66);
    \u0275\u0275element(5, "path", 67);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(6, "Reject");
    \u0275\u0275elementEnd();
...
function DashboardComponent_table_88_tr_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "td")(17, "div", 58)(18, "button", 59);
    \u0275\u0275text(19, " \u22EE ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "ul", 60)(21, "li");
    \u0275\u0275template(22, DashboardComponent_table_88_tr_20_a_22_Template, 4, 0, "a", 61);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "li");
    \u0275\u0275template(24, DashboardComponent_table_88_tr_20_a_24_Template, 7, 0, "a", 62);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "li")(26, "a", 63);
    \u0275\u0275listener("click", function DashboardComponent_table_88_tr_20_Template_a_click_26_listener() {
      const user_r4 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.deleteUser(user_r4.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(27, "svg", 24)(28, "mask", 64);
    \u0275\u0275element(29, "rect", 65);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "g", 66);
    \u0275\u0275element(31, "path", 67);
    \u0275\u0275elementEnd()();
...
function DashboardComponent_table_88_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(20, DashboardComponent_table_88_tr_20_Template, 33, 10, "tr", 56);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function DashboardComponent_li_97_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 47)(1, "a", 48);
    \u0275\u0275listener("click", function DashboardComponent_li_97_Template_a_click_1_listener() {
...
var DashboardComponent = class _DashboardComponent {
  ...
  deleteUser(userId) {
    ...
    this.http.patch(`${environment.apiUrl}/admin/user`, body, { headers }).subscribe({
      next: () => {
        this.showToast(`User Account Deactivtaed successfully`, "success");
        this.loadUsers();
      },
      error: (err) => {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["app-dashboard"]], viewQuery: function DashboardComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275element(15, "rect", 14);
        \u0275\u0275elementStart(16, "mask", 15);
        \u0275\u0275element(17, "rect", 16);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(18, "g", 17);
        \u0275\u0275element(19, "path", 18);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(20, "defs")(21, "linearGradient", 19);
        \u0275\u0275element(22, "stop", 20)(23, "stop", 21);
        \u0275\u0275elementEnd()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(24, "h3");
        \u0275\u0275text(25, "Total Users");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(26, "div", 22)(27, "h1");
        \u0275\u0275text(28);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(29, "div", 23);
        \u0275\u0275text(30, "15% ");
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(31, "svg", 24)(32, "g", 25);
        \u0275\u0275element(33, "path", 26);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(34, "defs")(35, "clipPath", 27);
        \u0275\u0275element(36, "rect", 28);
        \u0275\u0275elementEnd()()()()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(37, "div", 11)(38, "div", 12);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(39, "svg", 13);
        \u0275\u0275element(40, "rect", 14);
        \u0275\u0275elementStart(41, "mask", 29);
        \u0275\u0275element(42, "rect", 16);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(43, "g", 30);
        \u0275\u0275element(44, "path", 31);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(45, "defs")(46, "linearGradient", 32);
        \u0275\u0275element(47, "stop", 20)(48, "stop", 21);
        \u0275\u0275elementEnd()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(49, "h3");
        \u0275\u0275text(50, "Approved Users");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(51, "div", 22)(52, "h1");
        \u0275\u0275text(53);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(54, "div", 23);
        \u0275\u0275text(55, "15% ");
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(56, "svg", 24)(57, "g", 25);
        \u0275\u0275element(58, "path", 26);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(59, "defs")(60, "clipPath", 27);
        \u0275\u0275element(61, "rect", 28);
        \u0275\u0275elementEnd()()()()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(62, "div", 11)(63, "div", 12);
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(64, "svg", 13);
        \u0275\u0275element(65, "rect", 14);
        \u0275\u0275elementStart(66, "mask", 33);
        \u0275\u0275element(67, "rect", 16);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(68, "g", 34);
        \u0275\u0275element(69, "path", 35);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(70, "defs")(71, "linearGradient", 36);
        \u0275\u0275element(72, "stop", 20)(73, "stop", 21);
        \u0275\u0275elementEnd()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(74, "h3");
        \u0275\u0275text(75, "Unapproved Users");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(76, "div", 22)(77, "h1");
        \u0275\u0275text(78);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(79, "div", 37);
        \u0275\u0275text(80, "15% ");
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(81, "svg", 38);
        \u0275\u0275element(82, "path", 39);
        \u0275\u0275elementEnd()()()()()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(83, "div", 40)(84, "div", 41)(85, "h5", 42);
        \u0275\u0275text(86, "User Management");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(87, "div", 43);
        \u0275\u0275template(88, DashboardComponent_table_88_Template, 21, 1, "table", 44);
        \u0275\u0275elementEnd();
        \u0275\u0275template(89, DashboardComponent_ng_template_89_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementStart(91, "div", 45)(92, "nav")(93, "ul", 46)(94, "li", 47)(95, "a", 48);
        \u0275\u0275listener("click", function DashboardComponent_Template_a_click_95_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goPrevious());
        });
        \u0275\u0275text(96, "\u2039");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(97, DashboardComponent_li_97_Template, 3, 3, "li", 49);
        \u0275\u0275elementStart(98, "li", 47)(99, "a", 48);
        \u0275\u0275listener("click", function DashboardComponent_Template_a_click_99_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goNext());
        });
        \u0275\u0275text(100, "\u203A");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(101, "div", 50)(102, "select", 51);
        \u0275\u0275listener("change", function DashboardComponent_Template_select_change_102_listener($event) {
          \u0275\u0275restoreView(_r1);
      ...
      if (rf & 2) {
        const noUsers_r10 = \u0275\u0275reference(90);
...
//# sourceMappingURL=chunk-NCZYNFKJ.mjs.map
