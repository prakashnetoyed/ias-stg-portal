...
function CaseStudiesComponent_div_21_div_20_Template(rf, ctx) {
  if (rf & 1) {
...
function CaseStudiesComponent_div_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(14, " Read more ");
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(15, "svg", 22);
    \u0275\u0275element(16, "path", 23);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(17, "div", 24)(18, "div", 25);
    \u0275\u0275template(19, CaseStudiesComponent_div_21_img_19_Template, 1, 1, "img", 26)(20, CaseStudiesComponent_div_21_div_20_Template, 4, 0, "div", 27);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ctx_r0.newsList[0].caseStudyLink, " ");
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(11, _c0))("queryParams", \u0275\u0275pureFunction1(12, _c1, ctx_r0.newsList[0] == null ? null : ctx_r0.newsList[0].id));
    \u0275\u0275advance(6);
...
function CaseStudiesComponent_div_22_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 43)(12, "a", 44);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(13, "svg", 45)(14, "mask", 46);
    \u0275\u0275element(15, "rect", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "g", 48);
    \u0275\u0275element(17, "path", 20);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275text(20, " Read more ");
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(21, "svg", 50);
    \u0275\u0275element(22, "path", 51);
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("href", news_r2.caseStudyLink, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(6);
...
function CaseStudiesComponent_div_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, CaseStudiesComponent_div_22_div_2_Template, 23, 14, "div", 35);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var CaseStudiesComponent = class _CaseStudiesComponent {
  ...
  ngOnInit() {
    this.fetchNews();
    this.titleService.setTitle("IASCA Portal - Case study");
  }
  fetchNews() {
