...
function MyTransactionComponent_tr_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "td")(17, "div", 24)(18, "button", 25);
    \u0275\u0275listener("click", function MyTransactionComponent_tr_33_Template_button_click_18_listener() {
      const user_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.downloadReceipt(user_r3));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(19, "svg", 26)(20, "mask", 27);
    \u0275\u0275element(21, "rect", 28);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "g", 29);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(user_r3.transaction_time || "N/A");
    \u0275\u0275advance(2);
...
var MyTransactionComponent = class _MyTransactionComponent {
  ...
  fetchtransactions(page = 1, limit = this.pageSize) {
    this.http.get(`${environment.apiUrl}/airpay/transactions?populate=createdBy&populate=userOrderDetails&page=${page}&limit=${limit}`).subscribe({
      next: (res) => {
  ...
  downloadReceipt(tx) {
    ...
    doc.text(`${tx?.userOrderDetails?.memberShip || "N/A"}`, 14, posY + 6);
    posY += 20;
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MyTransactionComponent, selectors: [["app-my-transaction"]], viewQuery: function MyTransactionComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275template(33, MyTransactionComponent_tr_33_Template, 24, 8, "tr", 12);
        \u0275\u0275elementEnd()()();
...
//# sourceMappingURL=chunk-TKGLAJJQ.js.map
