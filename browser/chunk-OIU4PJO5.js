  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _IasUserHeaderComponent, selectors: [["app-ias-user-header"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 29, vars: 4, consts: [["toastContainer", ""], ["initialsBlock", ""], [1, "position-fixed", "top-0", "end-0", "p-3", 2, "z-index", "1100"], ["tabindex", "-1", "id", "sidebar", "aria-labelledby", "sidebarLabel", 1, "offcanvas", "offcanvas-start"], [1, "offcanvas-header"], ["id", "sidebarLabel"], ["type", "button", "data-bs-dismiss", "offcanvas", "aria-label", "Close", 1, "btn-close", "text-reset"], [1, "offcanvas-body"], [1, "main-epfo-header"], [1, "right-side", "d-flex", "align-items-center", "gap-3"], ["data-bs-toggle", "offcanvas", "data-bs-target", "#sidebar", 1, "btn", "btn-donate"], [1, "dropdown"], ["type", "button", "id", "profileDropdown", "data-bs-toggle", "dropdown", "aria-expanded", "false", 1, "btn", "dropdown-toggle", "user-profile", "d-flex", "align-items-center"], ["class", "user-info text-end me-2", 4, "ngIf"], [1, "avatar"], [4, "ngIf"], ["aria-labelledby", "profileDropdown", 1, "dropdown-menu", "dropdown-menu-end"], [1, "dropdown-item", 3, "routerLink"], [1, "dropdown-divider"], [1, "dropdown-item", "text-danger", 2, "cursor", "pointer", 3, "click"], [1, "user-info", "text-end", "me-2"], [1, "name"], [1, "role"], [4, "ngIf", "ngIfElse"], ["alt", "Avatar", "draggable", "false", 3, "src"]], template: function IasUserHeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(25, "hr", 18);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(26, "li")(27, "a", 19);
        \u0275\u0275listener("click", function IasUserHeaderComponent_Template_a_click_27_listener() {
          \u0275\u0275restoreView(_r1);
...
//# sourceMappingURL=chunk-OIU4PJO5.js.map
