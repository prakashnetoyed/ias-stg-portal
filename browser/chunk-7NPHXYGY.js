...
var _c1 = () => [];
function ApprovedUserComponent_table_12_tr_20_a_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 36);
    \u0275\u0275listener("click", function ApprovedUserComponent_table_12_tr_20_a_22_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function ApprovedUserComponent_table_12_tr_20_a_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 30);
    \u0275\u0275listener("click", function ApprovedUserComponent_table_12_tr_20_a_24_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const user_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 31)(2, "mask", 32);
    \u0275\u0275element(3, "rect", 33);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "g", 34);
    \u0275\u0275element(5, "path", 35);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(6, "Reject");
    \u0275\u0275elementEnd();
...
function ApprovedUserComponent_table_12_tr_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "td")(17, "div", 25)(18, "button", 26);
    \u0275\u0275text(19, " \u22EE ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "ul", 27)(21, "li");
    \u0275\u0275template(22, ApprovedUserComponent_table_12_tr_20_a_22_Template, 4, 0, "a", 28);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "li");
    \u0275\u0275template(24, ApprovedUserComponent_table_12_tr_20_a_24_Template, 7, 0, "a", 29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "li")(26, "a", 30);
    \u0275\u0275listener("click", function ApprovedUserComponent_table_12_tr_20_Template_a_click_26_listener() {
      const user_r4 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.deleteUser(user_r4.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(27, "svg", 31)(28, "mask", 32);
    \u0275\u0275element(29, "rect", 33);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "g", 34);
...
function ApprovedUserComponent_table_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(20, ApprovedUserComponent_table_12_tr_20_Template, 33, 10, "tr", 23);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ApprovedUserComponent_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
...
function ApprovedUserComponent_li_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 14)(1, "a", 15);
    \u0275\u0275listener("click", function ApprovedUserComponent_li_21_Template_a_click_1_listener() {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ApprovedUserComponent, selectors: [["app-approved-user"]], viewQuery: function ApprovedUserComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275text(10, "Approved Users");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(11, "div", 10);
        \u0275\u0275template(12, ApprovedUserComponent_table_12_Template, 21, 1, "table", 11);
        \u0275\u0275elementEnd();
        \u0275\u0275template(13, ApprovedUserComponent_ng_template_13_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementStart(15, "div", 12)(16, "nav")(17, "ul", 13)(18, "li", 14)(19, "a", 15);
        \u0275\u0275listener("click", function ApprovedUserComponent_Template_a_click_19_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goPrevious());
        });
        \u0275\u0275text(20, "\u2039");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(21, ApprovedUserComponent_li_21_Template, 3, 3, "li", 16);
        \u0275\u0275elementStart(22, "li", 14)(23, "a", 15);
        \u0275\u0275listener("click", function ApprovedUserComponent_Template_a_click_23_listener() {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275listener("change", function ApprovedUserComponent_Template_select_change_26_listener($event) {
          \u0275\u0275restoreView(_r1);
      ...
      if (rf & 2) {
        const noUsers_r10 = \u0275\u0275reference(14);
        \u0275\u0275advance();
...
//# sourceMappingURL=chunk-7NPHXYGY.js.map
