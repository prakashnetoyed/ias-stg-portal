...
var _c1 = () => [];
function NotApprovedUserComponent_table_28_tr_22_a_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 49);
    \u0275\u0275listener("click", function NotApprovedUserComponent_table_28_tr_22_a_24_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r6);
...
function NotApprovedUserComponent_table_28_tr_22_a_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 43);
    \u0275\u0275listener("click", function NotApprovedUserComponent_table_28_tr_22_a_26_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const user_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 44)(2, "mask", 45);
    \u0275\u0275element(3, "rect", 46);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "g", 47);
    \u0275\u0275element(5, "path", 48);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(6, "Reject");
    \u0275\u0275elementEnd();
...
function NotApprovedUserComponent_table_28_tr_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td")(4, "input", 36);
    \u0275\u0275twoWayListener("ngModelChange", function NotApprovedUserComponent_table_28_tr_22_Template_input_ngModelChange_4_listener($event) {
      const user_r5 = \u0275\u0275restoreView(_r4).$implicit;
      \u0275\u0275twoWayBindingSet(user_r5.selected, $event) || (user_r5.selected = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("change", function NotApprovedUserComponent_table_28_tr_22_Template_input_change_4_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "td")(19, "div", 38)(20, "button", 39);
    \u0275\u0275text(21, " \u22EE ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "ul", 40)(23, "li");
    \u0275\u0275template(24, NotApprovedUserComponent_table_28_tr_22_a_24_Template, 4, 0, "a", 41);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "li");
    \u0275\u0275template(26, NotApprovedUserComponent_table_28_tr_22_a_26_Template, 7, 0, "a", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "li")(28, "a", 43);
    \u0275\u0275listener("click", function NotApprovedUserComponent_table_28_tr_22_Template_a_click_28_listener() {
      const user_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.openDeleteModal(user_r5.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(29, "svg", 44)(30, "mask", 45);
    \u0275\u0275element(31, "rect", 46);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "g", 47);
    \u0275\u0275element(33, "path", 48);
    \u0275\u0275elementEnd()();
...
function NotApprovedUserComponent_table_28_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "table", 33)(1, "thead")(2, "tr")(3, "th");
    \u0275\u0275text(4, "S.no");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "th")(6, "input", 34);
    \u0275\u0275listener("change", function NotApprovedUserComponent_table_28_Template_input_change_6_listener($event) {
      \u0275\u0275restoreView(_r2);
    ...
    \u0275\u0275template(22, NotApprovedUserComponent_table_28_tr_22_Template, 35, 11, "tr", 35);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function NotApprovedUserComponent_ng_template_29_Template(rf, ctx) {
  if (rf & 1) {
...
function NotApprovedUserComponent_li_37_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 25)(1, "a", 26);
    \u0275\u0275listener("click", function NotApprovedUserComponent_li_37_Template_a_click_1_listener() {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NotApprovedUserComponent, selectors: [["app-not-approved-user"]], viewQuery: function NotApprovedUserComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275listener("click", function NotApprovedUserComponent_Template_button_click_25_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.bulkApprove());
        });
        \u0275\u0275text(26, " Bulk Approve ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(27, "div", 21);
        \u0275\u0275template(28, NotApprovedUserComponent_table_28_Template, 23, 2, "table", 22);
        \u0275\u0275elementEnd();
        \u0275\u0275template(29, NotApprovedUserComponent_ng_template_29_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementStart(31, "div", 23)(32, "nav")(33, "ul", 24)(34, "li", 25)(35, "a", 26);
        \u0275\u0275listener("click", function NotApprovedUserComponent_Template_a_click_35_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goPrevious());
        });
        \u0275\u0275text(36, "\u2039");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(37, NotApprovedUserComponent_li_37_Template, 3, 3, "li", 27);
        \u0275\u0275elementStart(38, "li", 25)(39, "a", 26);
        \u0275\u0275listener("click", function NotApprovedUserComponent_Template_a_click_39_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goNext());
        });
        \u0275\u0275text(40, "\u203A");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(41, "div", 28)(42, "select", 29);
        \u0275\u0275listener("change", function NotApprovedUserComponent_Template_select_change_42_listener($event) {
          \u0275\u0275restoreView(_r1);
      ...
      if (rf & 2) {
        const noUsers_r11 = \u0275\u0275reference(30);
        \u0275\u0275advance();
...
//# sourceMappingURL=chunk-H5BVLC57.js.map
