...
} from "./chunk-S2CLJSEN.js";
import "./chunk-7YBSCFQJ.js";
import {
...
var _c1 = () => [];
function NotApprovedUserComponent_table_14_tr_22_a_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 39);
    \u0275\u0275listener("click", function NotApprovedUserComponent_table_14_tr_22_a_24_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r6);
...
function NotApprovedUserComponent_table_14_tr_22_a_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 33);
    \u0275\u0275listener("click", function NotApprovedUserComponent_table_14_tr_22_a_26_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const user_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 34)(2, "mask", 35);
    \u0275\u0275element(3, "rect", 36);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "g", 37);
    \u0275\u0275element(5, "path", 38);
    \u0275\u0275elementEnd()();
    \u0275\u0275text(6, "Reject");
    \u0275\u0275elementEnd();
...
function NotApprovedUserComponent_table_14_tr_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function NotApprovedUserComponent_table_14_tr_22_Template_input_ngModelChange_4_listener($event) {
      const user_r5 = \u0275\u0275restoreView(_r4).$implicit;
      \u0275\u0275twoWayBindingSet(user_r5.selected, $event) || (user_r5.selected = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("change", function NotApprovedUserComponent_table_14_tr_22_Template_input_change_4_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "td")(19, "div", 28)(20, "button", 29);
    \u0275\u0275text(21, " \u22EE ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "ul", 30)(23, "li");
    \u0275\u0275template(24, NotApprovedUserComponent_table_14_tr_22_a_24_Template, 4, 0, "a", 31);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "li");
    \u0275\u0275template(26, NotApprovedUserComponent_table_14_tr_22_a_26_Template, 7, 0, "a", 32);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "li")(28, "a", 33);
    \u0275\u0275listener("click", function NotApprovedUserComponent_table_14_tr_22_Template_a_click_28_listener() {
      const user_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.deleteUser(user_r5.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(29, "svg", 34)(30, "mask", 35);
    \u0275\u0275element(31, "rect", 36);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "g", 37);
    \u0275\u0275element(33, "path", 38);
    \u0275\u0275elementEnd()();
...
function NotApprovedUserComponent_table_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "table", 23)(1, "thead")(2, "tr")(3, "th");
    \u0275\u0275text(4, "S.no");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "th")(6, "input", 24);
    \u0275\u0275listener("change", function NotApprovedUserComponent_table_14_Template_input_change_6_listener($event) {
      \u0275\u0275restoreView(_r2);
    ...
    \u0275\u0275template(22, NotApprovedUserComponent_table_14_tr_22_Template, 35, 11, "tr", 25);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function NotApprovedUserComponent_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
...
function NotApprovedUserComponent_li_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 15)(1, "a", 16);
    \u0275\u0275listener("click", function NotApprovedUserComponent_li_23_Template_a_click_1_listener() {
...
var NotApprovedUserComponent = class _NotApprovedUserComponent {
  ...
  loadUsers() {
    ...
    this.http.get(`${environment.apiUrl}/admin/users?limit=10000`, { headers }).subscribe({
      next: (res) => {
  ...
  deleteUser(userId) {
    ...
    this.http.patch(`${environment.apiUrl}/admin/user`, body, { headers }).subscribe({
      next: () => {
        this.showToast(`User Account Dectivated successfully`, "danger");
        this.loadUsers();
      },
      error: (err) => {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NotApprovedUserComponent, selectors: [["app-not-approved-user"]], viewQuery: function NotApprovedUserComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275text(10, "Pending For Approval");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(11, "button", 10);
        \u0275\u0275listener("click", function NotApprovedUserComponent_Template_button_click_11_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.bulkApprove());
        });
        \u0275\u0275text(12, " Bulk Approve ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(13, "div", 11);
        \u0275\u0275template(14, NotApprovedUserComponent_table_14_Template, 23, 2, "table", 12);
        \u0275\u0275elementEnd();
        \u0275\u0275template(15, NotApprovedUserComponent_ng_template_15_Template, 2, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementStart(17, "div", 13)(18, "nav")(19, "ul", 14)(20, "li", 15)(21, "a", 16);
        \u0275\u0275listener("click", function NotApprovedUserComponent_Template_a_click_21_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goPrevious());
        });
        \u0275\u0275text(22, "\u2039");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(23, NotApprovedUserComponent_li_23_Template, 3, 3, "li", 17);
        \u0275\u0275elementStart(24, "li", 15)(25, "a", 16);
        \u0275\u0275listener("click", function NotApprovedUserComponent_Template_a_click_25_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.goNext());
        });
        \u0275\u0275text(26, "\u203A");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(27, "div", 18)(28, "select", 19);
        \u0275\u0275listener("change", function NotApprovedUserComponent_Template_select_change_28_listener($event) {
          \u0275\u0275restoreView(_r1);
      ...
      if (rf & 2) {
        const noUsers_r11 = \u0275\u0275reference(16);
        \u0275\u0275advance();
...
//# sourceMappingURL=chunk-ZHLESRGX.js.map
